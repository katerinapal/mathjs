...
describe('range', function() {
  ...
  describe('toString', function () {
    it('should stringify a range to format start:step:end', function () {
      assert.equal(new index.type.Range(0,10).toString(), '0:10');
      assert.equal(new index.type.Range(0,10,2).toString(), '0:2:10');
    });

    it('should stringify a range to format start:step:end with given precision', function () {
      assert.equal(new index.type.Range(1/3, 4/3, 2/3).format(3), '0.333:0.667:1.33');
      assert.equal(new index.type.Range(1/3, 4/3, 2/3).format(4), '0.3333:0.6667:1.333');
      assert.equal(new index.type.Range(1/3, 4/3, 2/3).format(), '0.3333333333333333:0.6666666666666666:1.3333333333333333');
    });
  });
  ...
  describe('type', function () {
    ...
    it('should have a property isRange', function () {
      var a = new index.type.Range(0, 10);

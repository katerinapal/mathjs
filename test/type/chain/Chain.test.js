...
describe('Chain', function () {
  ...
  it('should have a property isChain', function () {
    var a = new _index.indexjs.type.Chain(5);
  ...
  it('should not contain constants, only functions', function () {
    ...
    var chain = new Chain(_index.indexjs.bignumber(3));
  ...
  it('should chain operations with matrices', function () {
    _assert2.default.deepEqual(new Chain(_index.indexjs.matrix([[1, 2], [3, 4]])).subset(_index.indexjs.index(0, 0), 8).multiply(3).done(), _index.indexjs.matrix([[24, 6], [9, 12]]));
    _assert2.default.deepEqual(new Chain([[1, 2], [3, 4]]).subset(_index.indexjs.index(0, 0), 8).multiply(3).done(), [[24, 6], [9, 12]]);
  });
  ...
  it('should create a proxy for imported functions', function () {
    _index.indexjs.import({ hello: function hello(a) {
        return a + '!';
      } });

...
describe('fraction', function () {
  ...
  it('should create a fraction', function () {
    equalFraction(_index.indexjs.fraction(1, 3), new Fraction(1, 3));
    equalFraction(_index.indexjs.fraction(0.3), new Fraction(0.3));
    equalFraction(_index.indexjs.fraction('1/3'), new Fraction(1, 3));
    equalFraction(_index.indexjs.fraction({ n: 1, d: 3 }), new Fraction(1, 3));
  });

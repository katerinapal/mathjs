...
describe('physical constants', function() {
  ...
  it('should return the correct value and unit for physical constants', function () {
    ...
    toolsapprox_equaljs(math.fineStructure.toString(),           7.297352569824e-3);
    ...
    toolsapprox_equaljs(math.weakMixingAngle.toString(),         0.222321);
    toolsapprox_equaljs(math.efimovFactor.toString(),            22.7);
    ...
    toolsapprox_equaljs(math.sackurTetrode.toString(),       -1.164870823);

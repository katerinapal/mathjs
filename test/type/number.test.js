...
describe('number', function () {
  ...
  it('should convert a bignumber to a number', function () {
    (0, _approx.equal)(number(_index.indexjs.bignumber(0.1)), 0.1);
    (0, _approx.equal)(number(_index.indexjs.bignumber('1.3e500')), Infinity);
  });

  it('should convert a fraction to a number', function () {
    (0, _approx.equal)(number(_index.indexjs.fraction(2, 5)), 0.4);
  });
  ...
  it('should convert a unit to a number', function () {
    (0, _approx.equal)(number(_index.indexjs.unit('52cm'), 'm'), 0.52);
  });
  ...
  it('should convert the elements of a matrix to numbers', function () {
    _assert2.default.deepEqual(number(_index.indexjs.matrix(['123', true])), _index.indexjs.matrix([123, 1]));
  });
  ...
  it('should throw an error if called with a complex number', function () {
    _assert2.default.throws(function () {
      number(_index.indexjs.complex(2, 3));
    }, TypeError);
  });

  it('should throw an error with wrong type of arguments', function () {
    _assert2.default.throws(function () {
      number(_index.indexjs.unit('5cm'));
    ...
    _assert2.default.throws(function () {
      number(_index.indexjs.unit('5cm'), new Date());
    }, TypeError);
    _assert2.default.throws(function () {
      number('23', 2);
    }, TypeError);
  ...
  it('should LaTeX number', function () {
    var expr1 = _index.indexjs.parse('number()');
    var expr2 = _index.indexjs.parse('number(1)');
    var expr3 = _index.indexjs.parse('number(1,cm)');

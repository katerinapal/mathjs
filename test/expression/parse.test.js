...
var parse = _index.indexjs.expression.parse;
...
describe('parse', function () {
  ...
  it('should parse a matrix with expressions', function () {
    var scope = {};
    _assert2.default.deepEqual(parse(_index.indexjs.matrix(['a=3', 'b=4', 'a*b'])).map(function (node) {
      return node.compile().eval(scope);
    }), _index.indexjs.matrix([3, 4, 12]));
  });
  ...
  it('should parse an array with an empty expression', function () {
    _assert2.default.deepEqual(parse(_index.indexjs.matrix([''])).map(function (node) {
      return node.compile().eval();
    }), _index.indexjs.matrix([undefined]));
  });
  ...
  it('should parse unicode characters', function () {
    ...
    _index.indexjs.eval("\xE9 = 2", scope); // Latin Small Letter E with Acute
    _assert2.default.strictEqual(scope["\xE9"], 2);

    _index.indexjs.eval("\u03A6 = 3", scope); // Greek Capital Letter Phi
    _assert2.default.strictEqual(scope["\u03A6"], 3);

    _index.indexjs.eval("\u03A9 = 4", scope); // Greek Capital Letter Omega
    _assert2.default.strictEqual(scope["\u03A9"], 4);

    _index.indexjs.eval("k\xF6ln = 5", scope); // Combination of latin and unicode
    _assert2.default.strictEqual(scope["k\xF6ln"], 5);

    // test unicode characters in the astral plane (surrogate pairs
    _index.indexjs.eval("\uD835\uDD38 = 1", scope); // double struck capital A
    _assert2.default.strictEqual(scope["\uD835\uDD38"], 1);

    // should not allow the "holes"
    _assert2.default.throws(function () {
      _index.indexjs.eval("\uD835\uDCA3 = 1", scope);
    });
  });
  ...
  describe('multiline', function () {
    ...
    it('should spread a matrix over multiple lines', function () {
      _assert2.default.deepEqual(parse('[\n1\n,\n2\n]').compile().eval(), _index.indexjs.matrix([1, 2]));
    });

    it('should spread a range over multiple lines', function () {
      _assert2.default.deepEqual(parse('2:\n4').compile().eval(), _index.indexjs.matrix([2, 3, 4]));
      _assert2.default.deepEqual(parse('2:\n2:\n6').compile().eval(), _index.indexjs.matrix([2, 4, 6]));
    });
  ...
  describe('bignumber', function () {
    ...
    it('should parse bignumbers', function () {
      _assert2.default.deepEqual(parseAndEval('bignumber(0.1)'), _index.indexjs.bignumber(0.1));
      _assert2.default.deepEqual(parseAndEval('bignumber("1.2e500")'), _index.indexjs.bignumber('1.2e500'));
    });

    it('should output bignumbers if default number type is bignumber', function () {
      var bigmath = _index.indexjs.create({
        number: 'BigNumber'
      });
  ...
  describe('fraction', function () {
    ...
    it('should output fractions if default number type is fraction', function () {
      var fmath = _index.indexjs.create({
        number: 'Fraction'
      });

      (0, _assert2.default)(fmath.parse('0.1').compile().eval() instanceof _index.indexjs.type.Fraction);
  ...
  describe('unit', function () {
    ...
    it('should correctly parse negative temperatures', function () {
      ...
      approx.deepEqual(parseAndEval('--6 celsius'), new Unit(6, 'celsius'));
      approx.deepEqual(parseAndEval('-6 celsius to fahrenheit'), new Unit(21.2, 'fahrenheit').to('fahrenheit'));
    });

    it('should convert units', function () {
      var scope = {};
      approx.deepEqual(parseAndEval('(5.08 cm * 1000) to inch', scope), _index.indexjs.unit(2000, 'inch').to('inch'));
      approx.deepEqual(parseAndEval('a = (5.08 cm * 1000) to mm', scope), _index.indexjs.unit(50800, 'mm').to('mm'));
      approx.deepEqual(parseAndEval('a to inch', scope), _index.indexjs.unit(2000, 'inch').to('inch'));

      approx.deepEqual(parseAndEval('10 celsius to fahrenheit'), _index.indexjs.unit(50, 'fahrenheit').to('fahrenheit'));
      approx.deepEqual(parseAndEval('20 celsius to fahrenheit'), _index.indexjs.unit(68, 'fahrenheit').to('fahrenheit'));
      approx.deepEqual(parseAndEval('50 fahrenheit to celsius'), _index.indexjs.unit(10, 'celsius').to('celsius'));
    });

    it('should evaluate operator "to" with correct precedence ', function () {
      approx.deepEqual(parseAndEval('5.08 cm * 1000 to inch'), new Unit(2000, 'inch').to('inch'));
    });

    it('should evaluate operator "in" (alias of "to") ', function () {
      approx.deepEqual(parseAndEval('5.08 cm in inch'), new Unit(2, 'inch').to('inch'));
    });
  ...
  describe('matrix', function () {
    ...
    it('should parse a matrix', function () {
      ...
      _assert2.default.deepEqual(m, _index.indexjs.matrix([[1, 2, 3], [4, 5, 6]]));

      var b = parseAndEval('[5, 6; 1, 1]');
      _assert2.default.deepEqual(b.size(), [2, 2]);
      _assert2.default.deepEqual(b, _index.indexjs.matrix([[5, 6], [1, 1]]));

      // from 1 to n dimensions
      _assert2.default.deepEqual(parseAndEval('[ ]'), _index.indexjs.matrix([]));
      _assert2.default.deepEqual(parseAndEval('[1,2,3]'), _index.indexjs.matrix([1, 2, 3]));
      _assert2.default.deepEqual(parseAndEval('[1;2;3]'), _index.indexjs.matrix([[1], [2], [3]]));
      _assert2.default.deepEqual(parseAndEval('[[1,2],[3,4]]'), _index.indexjs.matrix([[1, 2], [3, 4]]));
      _assert2.default.deepEqual(parseAndEval('[[[1],[2]],[[3],[4]]]'), _index.indexjs.matrix([[[1], [2]], [[3], [4]]]));
    });
    ...
    it('should get a matrix subset', function () {
      var scope = {
        a: _index.indexjs.matrix([[1, 2, 3], [4, 5, 6], [7, 8, 9]])
      };
      _assert2.default.deepEqual(parseAndEval('a[2, :]', scope), _index.indexjs.matrix([[4, 5, 6]]));
      _assert2.default.deepEqual(parseAndEval('a[2, :2]', scope), _index.indexjs.matrix([[4, 5]]));
      _assert2.default.deepEqual(parseAndEval('a[2, :end-1]', scope), _index.indexjs.matrix([[4, 5]]));
      _assert2.default.deepEqual(parseAndEval('a[2, 2:]', scope), _index.indexjs.matrix([[5, 6]]));
      _assert2.default.deepEqual(parseAndEval('a[2, 2:3]', scope), _index.indexjs.matrix([[5, 6]]));
      _assert2.default.deepEqual(parseAndEval('a[2, 1:2:3]', scope), _index.indexjs.matrix([[4, 6]]));
      _assert2.default.deepEqual(parseAndEval('a[:, 2]', scope), _index.indexjs.matrix([[2], [5], [8]]));
      _assert2.default.deepEqual(parseAndEval('a[:2, 2]', scope), _index.indexjs.matrix([[2], [5]]));
      _assert2.default.deepEqual(parseAndEval('a[:end-1, 2]', scope), _index.indexjs.matrix([[2], [5]]));
      _assert2.default.deepEqual(parseAndEval('a[2:, 2]', scope), _index.indexjs.matrix([[5], [8]]));
      _assert2.default.deepEqual(parseAndEval('a[2:3, 2]', scope), _index.indexjs.matrix([[5], [8]]));
      _assert2.default.deepEqual(parseAndEval('a[1:2:3, 2]', scope), _index.indexjs.matrix([[2], [8]]));
    });
    ...
    it('should parse matrix resizings', function () {
      var scope = {};
      _assert2.default.deepEqual(parseAndEval('a = []', scope), _index.indexjs.matrix([]));
      _assert2.default.deepEqual(parseAndEval('a[1:3,1] = [1;2;3]', scope), _index.indexjs.matrix([[1], [2], [3]]));
      _assert2.default.deepEqual(parseAndEval('a[:,2] = [4;5;6]', scope), _index.indexjs.matrix([[4], [5], [6]]));
      _assert2.default.deepEqual(scope.a, _index.indexjs.matrix([[1, 4], [2, 5], [3, 6]]));

      _assert2.default.deepEqual(parseAndEval('a = []', scope), _index.indexjs.matrix([]));
      _assert2.default.strictEqual(parseAndEval('a[1,3] = 3', scope), 3);
      _assert2.default.deepEqual(scope.a, _index.indexjs.matrix([[0, 0, 3]]));
      _assert2.default.deepEqual(parseAndEval('a[2,:] = [[4,5,6]]', scope), _index.indexjs.matrix([[4, 5, 6]]));
      _assert2.default.deepEqual(scope.a, _index.indexjs.matrix([[0, 0, 3], [4, 5, 6]]));

      _assert2.default.deepEqual(parseAndEval('a = []', scope), _index.indexjs.matrix([]));
      _assert2.default.strictEqual(parseAndEval('a[3,1] = 3', scope), 3);
      _assert2.default.deepEqual(scope.a, _index.indexjs.matrix([[0], [0], [3]]));
      _assert2.default.deepEqual(parseAndEval('a[:,2] = [4;5;6]', scope), _index.indexjs.matrix([[4], [5], [6]]));
      _assert2.default.deepEqual(scope.a, _index.indexjs.matrix([[0, 4], [0, 5], [3, 6]]));

      _assert2.default.deepEqual(parseAndEval('a = []', scope), _index.indexjs.matrix([]));
      _assert2.default.deepEqual(parseAndEval('a[1,1:3] = [[1,2,3]]', scope), _index.indexjs.matrix([[1, 2, 3]]));
      _assert2.default.deepEqual(scope.a, _index.indexjs.matrix([[1, 2, 3]]));
      _assert2.default.deepEqual(parseAndEval('a[2,:] = [[4,5,6]]', scope), _index.indexjs.matrix([[4, 5, 6]]));
      _assert2.default.deepEqual(scope.a, _index.indexjs.matrix([[1, 2, 3], [4, 5, 6]]));
    });
    ...
    it('should get/set the matrix correctly', function () {
      ...
      _assert2.default.deepEqual(scope.a, _index.indexjs.matrix([[100, 2], [3, 4]]));
      parseAndEval('a[2:3,2:3] = [10,11;12,13]', scope);
      _assert2.default.deepEqual(scope.a.size(), [3, 3]);
      _assert2.default.deepEqual(scope.a, _index.indexjs.matrix([[100, 2, 0], [3, 10, 11], [0, 12, 13]]));
      var a = scope.a;
      // note: after getting subset, uninitialized elements are replaced by elements with an undefined value
      _assert2.default.deepEqual(a.subset(_index.indexjs.index(new Range(0, 3), new Range(0, 2))), _index.indexjs.matrix([[100, 2], [3, 10], [0, 12]]));
      _assert2.default.deepEqual(parseAndEval('a[1:3,1:2]', scope), _index.indexjs.matrix([[100, 2], [3, 10], [0, 12]]));
    ...
    it('should get/set the matrix correctly for 3d matrices', function () {
      var scope = {};
      _assert2.default.deepEqual(parseAndEval('f=[1,2;3,4]', scope), _index.indexjs.matrix([[1, 2], [3, 4]]));
      _assert2.default.deepEqual(parseAndEval('size(f)', scope), _index.indexjs.matrix([2, 2]));

      parseAndEval('f[:,:,2]=[5,6;7,8]', scope);
      _assert2.default.deepEqual(scope.f, _index.indexjs.matrix([[[1, 5], [2, 6]], [[3, 7], [4, 8]]]));

      _assert2.default.deepEqual(parseAndEval('size(f)', scope), _index.indexjs.matrix([2, 2, 2]));
      _assert2.default.deepEqual(parseAndEval('f[:,:,1]', scope), _index.indexjs.matrix([[[1], [2]], [[3], [4]]]));
      _assert2.default.deepEqual(parseAndEval('f[:,:,2]', scope), _index.indexjs.matrix([[[5], [6]], [[7], [8]]]));
      _assert2.default.deepEqual(parseAndEval('f[:,2,:]', scope), _index.indexjs.matrix([[[2, 6]], [[4, 8]]]));
      _assert2.default.deepEqual(parseAndEval('f[2,:,:]', scope), _index.indexjs.matrix([[[3, 7], [4, 8]]]));

      parseAndEval('a=diag([1,2,3,4])', scope);
      _assert2.default.deepEqual(parseAndEval('a[3:end, 3:end]', scope), _index.indexjs.matrix([[3, 0], [0, 4]]));
      parseAndEval('a[3:end, 2:end]=9*ones(2,3)', scope);
      _assert2.default.deepEqual(scope.a, _index.indexjs.matrix([[1, 0, 0, 0], [0, 2, 0, 0], [0, 9, 9, 9], [0, 9, 9, 9]]));
      _assert2.default.deepEqual(parseAndEval('a[2:end-1, 2:end-1]', scope), _index.indexjs.matrix([[2, 0], [9, 9]]));
    });
    ...
    it('should parse matrix concatenations', function () {
      ...
      _assert2.default.deepEqual(parseAndEval('c=concat(a,b)', scope), _index.indexjs.matrix([[1, 2, 5, 6], [3, 4, 7, 8]]));
      _assert2.default.deepEqual(parseAndEval('c=concat(a,b,1)', scope), _index.indexjs.matrix([[1, 2], [3, 4], [5, 6], [7, 8]]));
      _assert2.default.deepEqual(parseAndEval('c=concat(concat(a,b), concat(b,a), 1)', scope), _index.indexjs.matrix([[1, 2, 5, 6], [3, 4, 7, 8], [5, 6, 1, 2], [7, 8, 3, 4]]));
      _assert2.default.deepEqual(parseAndEval('c=concat([[1,2]], [[3,4]], 1)', scope), _index.indexjs.matrix([[1, 2], [3, 4]]));
      _assert2.default.deepEqual(parseAndEval('c=concat([[1,2]], [[3,4]], 2)', scope), _index.indexjs.matrix([[1, 2, 3, 4]]));
      _assert2.default.deepEqual(parseAndEval('c=concat([[1]], [2;3], 1)', scope), _index.indexjs.matrix([[1], [2], [3]]));
      _assert2.default.deepEqual(parseAndEval('d=1:3', scope), _index.indexjs.matrix([1, 2, 3]));
      _assert2.default.deepEqual(parseAndEval('concat(d,d)', scope), _index.indexjs.matrix([1, 2, 3, 1, 2, 3]));
      _assert2.default.deepEqual(parseAndEval('e=1+d', scope), _index.indexjs.matrix([2, 3, 4]));
      _assert2.default.deepEqual(parseAndEval('size(e)', scope), _index.indexjs.matrix([3]));
      _assert2.default.deepEqual(parseAndEval('concat(e,e)', scope), _index.indexjs.matrix([2, 3, 4, 2, 3, 4]));
      _assert2.default.deepEqual(parseAndEval('[[],[]]', scope), _index.indexjs.matrix([[], []]));
      _assert2.default.deepEqual(parseAndEval('[[],[]]', scope).size(), [2, 0]);
      _assert2.default.deepEqual(parseAndEval('size([[],[]])', scope), _index.indexjs.matrix([2, 0]));
    });
    ...
    it('should execute map on an array with one based indices', function () {
      ...
      var res = _index.indexjs.eval('map(A, callback)', scope);
    ...
    it('should execute map on a Matrix with one based indices', function () {
      ...
      var res = _index.indexjs.eval('map(A, callback)', scope);
      _assert2.default.deepEqual(res, _index.indexjs.matrix([2, 3, 4]));
    ...
    it('should execute forEach on an array with one based indices', function () {
      ...
      _index.indexjs.eval('forEach(A, callback)', scope);
  ...
  describe('objects', function () {
    ...
    it('should invoke a function on an object with the right context', function () {
      ...
      _assert2.default.deepEqual(parseAndEval('bignumber(2).plus(3)'), _index.indexjs.bignumber(5));
      _assert2.default.deepEqual(parseAndEval('bignumber(2)["plus"](3)'), _index.indexjs.bignumber(5));
    });
  ...
  describe('variables', function () {
    ...
    it('should parse nested assignments', function () {
      ...
      _assert2.default.deepEqual(parseAndEval('a = [1,2,f=3]', scope), _index.indexjs.matrix([1, 2, 3]));
  ...
  describe('operators', function () {
    ...
    it('should parse dotDivide ./', function () {
      _assert2.default.equal(parseAndEval('4./2'), 2);
      _assert2.default.deepEqual(parseAndEval('4./[2,4]'), _index.indexjs.matrix([2, 1]));
      _assert2.default.equal(parseAndEval('4 ./ 2'), 2);
      _assert2.default.equal(parseAndEval('8 ./ 2 / 2'), 2);

      _assert2.default.deepEqual(parseAndEval('[1,2,3] ./ [1,2,3]'), _index.indexjs.matrix([1, 1, 1]));
    });
    ...
    it('should parse dotMultiply .*', function () {
      ...
      _assert2.default.deepEqual(parseAndEval('[1,2,3] .* [1,2,3]'), _index.indexjs.matrix([1, 4, 9]));
    });
    ...
    it('should parse dotPower .^', function () {
      ...
      _assert2.default.deepEqual(parseAndEval('[2,3] .^ [2,3]'), _index.indexjs.matrix([4, 27]));
    });
    ...
    it('should parse equal ==', function () {
      ...
      _assert2.default.deepEqual(parseAndEval('[2,3] == [2,4]'), _index.indexjs.matrix([true, false]));
    });
    ...
    it('should parse implicit multiplication', function () {
      ...
      _assert2.default.deepEqual(parseAndEval('[2, 3] 2'), _index.indexjs.matrix([4, 6]));
      _assert2.default.deepEqual(parseAndEval('[2, 3] a', { a: 2 }), _index.indexjs.matrix([4, 6]));
    ...
    it('should throw an error when having an implicit multiplication between two numbers', function () {
      _assert2.default.throws(function () {
        _index.indexjs.parse('2 3');
      }, /Unexpected part "3"/);
      _assert2.default.throws(function () {
        _index.indexjs.parse('2 * 3 4');
      }, /Unexpected part "4"/);
      _assert2.default.throws(function () {
        _index.indexjs.parse('2 * 3 4 * 5');
      }, /Unexpected part "4"/);
      _assert2.default.throws(function () {
        _index.indexjs.parse('2 / 3 4 5');
      }, /Unexpected part "4"/);
    ...
    it('should parse unequal !=', function () {
      _assert2.default.strictEqual(parseAndEval('2 != 3'), true);
      _assert2.default.strictEqual(parseAndEval('2 != 2'), false);
      _assert2.default.deepEqual(parseAndEval('[2,3] != [2,4]'), _index.indexjs.matrix([false, true]));
    });
    ...
    it('should lazily evaluate conditional expression a ? b : c', function () {
      var scope = {};
      _index.indexjs.parse('true ? (a = 2) : (b = 2)').compile().eval(scope);
    ...
    it('should parse : (range)', function () {
      ...
      _assert2.default.deepEqual(parseAndEval('2:5'), _index.indexjs.matrix([2, 3, 4, 5]));
      _assert2.default.deepEqual(parseAndEval('10:-2:0'), _index.indexjs.matrix([10, 8, 6, 4, 2, 0]));
      _assert2.default.deepEqual(parseAndEval('2:4.0'), _index.indexjs.matrix([2, 3, 4]));
      _assert2.default.deepEqual(parseAndEval('2:4.5'), _index.indexjs.matrix([2, 3, 4]));
      _assert2.default.deepEqual(parseAndEval('2:4.1'), _index.indexjs.matrix([2, 3, 4]));
      _assert2.default.deepEqual(parseAndEval('2:3.9'), _index.indexjs.matrix([2, 3]));
      _assert2.default.deepEqual(parseAndEval('2:3.5'), _index.indexjs.matrix([2, 3]));
      _assert2.default.deepEqual(parseAndEval('3:-1:0.5'), _index.indexjs.matrix([3, 2, 1]));
      _assert2.default.deepEqual(parseAndEval('3:-1:0.5'), _index.indexjs.matrix([3, 2, 1]));
      _assert2.default.deepEqual(parseAndEval('3:-1:0.1'), _index.indexjs.matrix([3, 2, 1]));
      _assert2.default.deepEqual(parseAndEval('3:-1:-0.1'), _index.indexjs.matrix([3, 2, 1, 0]));
    });

    it('should parse to', function () {
      approx.deepEqual(parseAndEval('2.54 cm to inch'), _index.indexjs.unit(1, 'inch').to('inch'));
      approx.deepEqual(parseAndEval('2.54 cm + 2 inch to foot'), _index.indexjs.unit(0.25, 'foot').to('foot'));
    });

    it('should parse in', function () {
      approx.deepEqual(parseAndEval('2.54 cm in inch'), _index.indexjs.unit(1, 'inch').to('inch'));
    });

    it('should parse factorial !', function () {
      _assert2.default.deepEqual(parseAndEval('5!'), 120);
      _assert2.default.deepEqual(parseAndEval('[1,2,3,4]!'), _index.indexjs.matrix([1, 2, 6, 24]));
      ...
      _assert2.default.deepEqual(parseAndEval('[1,2;3,1]!\'!'), _index.indexjs.matrix([[1, 720], [2, 1]]));
    ...
    it('should parse transpose \'', function () {
      ...
      _assert2.default.deepEqual(parseAndEval('[1,2,3;4,5,6]\''), _index.indexjs.matrix([[1, 4], [2, 5], [3, 6]]));
      _assert2.default.ok(parseAndEval('[1,2,3;4,5,6]\'') instanceof Matrix);
      _assert2.default.deepEqual(parseAndEval('[1:5]'), _index.indexjs.matrix([[1, 2, 3, 4, 5]]));
      _assert2.default.deepEqual(parseAndEval('[1:5]\''), _index.indexjs.matrix([[1], [2], [3], [4], [5]]));
      _assert2.default.deepEqual(parseAndEval('size([1:5])'), _index.indexjs.matrix([1, 5]));
      _assert2.default.deepEqual(parseAndEval('[1,2;3,4]\''), _index.indexjs.matrix([[1, 3], [2, 4]]));
    });
    ...
    describe('operator precedence', function () {
      ...
      it('should respect precedence of transpose', function () {
        var node = _index.indexjs.parse('a + b\'');
      ...
      it('should respect precedence of conditional operator and other operators', function () {
        ...
        _assert2.default.deepEqual(parseAndEval('2 == 4-2 ? [1,2] : false'), _index.indexjs.matrix([1, 2]));
        _assert2.default.deepEqual(parseAndEval('false ? 1:2:6'), _index.indexjs.matrix([2, 3, 4, 5, 6]));
      });
      ...
      it('should respect precedence of conditional operator and logical or', function () {
        var node = _index.indexjs.parse('1 or 0 ? 2 or 3 : 0 or 0');
      ...
      it('should respect precedence of conditional operator and relational operators', function () {
        var node = _index.indexjs.parse('a == b ? a > b : a < b');
        (0, _assert2.default)(node instanceof ConditionalNode);
      ...
      it('should respect precedence of conditional operator and range operator', function () {
        var node = _index.indexjs.parse('a ? b : c : d');
        (0, _assert2.default)(node instanceof ConditionalNode);
      ...
      it('should respect precedence of conditional operator and range operator (2)', function () {
        var node = _index.indexjs.parse('a ? (b : c) : (d : e)');
        (0, _assert2.default)(node instanceof ConditionalNode);
        _assert2.default.equal(node.condition.toString(), 'a');
      ...
      it('should respect precedence of conditional operator and range operator (2)', function () {
        var node = _index.indexjs.parse('a ? (b ? c : d) : (e ? f : g)');
        (0, _assert2.default)(node instanceof ConditionalNode);
        _assert2.default.equal(node.condition.toString(), 'a');
      ...
      it('should respect precedence of "to" operator and relational operators', function () {
        var node = _index.indexjs.parse('a == b to c');
        (0, _assert2.default)(node instanceof OperatorNode);
        _assert2.default.equal(node.args[0].toString(), 'a');
      ...
      it('should respect precedence of "to" operator and relational operators (2)', function () {
        var node = _index.indexjs.parse('a to b == c');
        (0, _assert2.default)(node instanceof OperatorNode);
  ...
  describe('functions', function () {
    ...
    it('should evaluate function "to" ', function () {
      approx.deepEqual(parseAndEval('to(5.08 cm * 1000, inch)'), _index.indexjs.unit(2000, 'inch').to('inch'));
    });
    ...
    it('should evaluate function "sort" with a custom sort function', function () {
      ...
      _assert2.default.deepEqual(parseAndEval('sort(["Langdon", "Tom", "Sara"], sortByLength)', scope), _index.indexjs.matrix(["Tom", "Sara", "Langdon"]));
    });

    it('should evaluate function "filter" with a custom test function', function () {
      var scope = {};
      parseAndEval('isPositive(x) = x > 0', scope);
      _assert2.default.deepEqual(parseAndEval('filter([6, -2, -1, 4, 3], isPositive)', scope), _index.indexjs.matrix([6, 4, 3]));
    });

    it('should evaluate function "filter" with a custom test equation', function () {
      _assert2.default.deepEqual(parseAndEval('filter([6, -2, -1, 4, 3], x > 0)'), _index.indexjs.matrix([6, 4, 3]));
    });
  });
  ...
  describe('scope', function () {
    ...
    it('should parse undefined symbols, defining symbols, and removing symbols', function () {
      ...
      n.compile().eval(scope);
      _assert2.default.deepEqual(scope.qq, _index.indexjs.matrix([[33, 2], [3, 4]]));
      parse('qq=[4]').compile().eval(scope);
      n.compile().eval(scope);
      _assert2.default.deepEqual(scope.qq, _index.indexjs.matrix([[33]]));
      delete scope.qq;
      _assert2.default.throws(function () {
        n.compile().eval(scope);
      });
  ...
  describe('errors', function () {
    ...
    it('should return IndexErrors with one based indices', function () {
      ...
      _assert2.default.throws(function () {
        _index.indexjs.subset([1, 2, 3], _index.indexjs.index(4));
      }, /Index out of range \(4 > 2\)/);
      _assert2.default.throws(function () {
        _index.indexjs.subset([1, 2, 3], _index.indexjs.index(-2));
      }, /Index out of range \(-2 < 0\)/);

      // evaluation via parser throws one-based error
      _assert2.default.throws(function () {
        _index.indexjs.eval('A[4]', { A: [1, 2, 3] });
      }, /Index out of range \(4 > 3\)/);
      _assert2.default.throws(function () {
        _index.indexjs.eval('A[-2]', { A: [1, 2, 3] });
    ...
    it('should return DimensionErrors with one based indices (subset)', function () {
      ...
      // functions throw a zero-based error
      _assert2.default.throws(function () {
        _index.indexjs.subset([1, 2, 3], _index.indexjs.index(1, 1));
      }, /DimensionError: Dimension mismatch \(2 != 1\)/);

      // evaluation via parser throws one-based error
      _assert2.default.throws(function () {
        _index.indexjs.eval('A[1,1]', { A: [1, 2, 3] });
      }, /DimensionError: Dimension mismatch \(2 != 1\)/);
    });
    ...
    it('should return DimensionErrors with one based indices (concat)', function () {
      ...
      // functions throw a zero-based error
      _assert2.default.throws(function () {
        _index.indexjs.concat([1, 2], [[3, 4]]);
      }, /DimensionError: Dimension mismatch \(1 != 2\)/);
      _assert2.default.throws(function () {
        _index.indexjs.concat([[1, 2]], [[3, 4]], 2);
      }, /IndexError: Index out of range \(2 > 1\)/);
      _assert2.default.throws(function () {
      ...
      // evaluation via parser throws one-based error
      _assert2.default.throws(function () {
        _index.indexjs.eval('concat([1,2], [[3,4]])');
      }, /DimensionError: Dimension mismatch \(1 != 2\)/);
      _assert2.default.throws(function () {
        _index.indexjs.eval('concat([[1,2]], [[3,4]], 3)');
      }, /IndexError: Index out of range \(3 > 2\)/);
      _assert2.default.throws(function () {
        _index.indexjs.eval('concat([[1,2]], [[3,4]], 0)');
    ...
    it('should return DimensionErrors with one based indices (max)', function () {
      ...
      // evaluation via parser throws one-based error
      _assert2.default.deepEqual(_index.indexjs.eval('max([[1,2], [3,4]])'), 4);
      _assert2.default.deepEqual(_index.indexjs.eval('max([[1,2], [3,4]], 1)'), _index.indexjs.matrix([3, 4]));
      _assert2.default.deepEqual(_index.indexjs.eval('max([[1,2], [3,4]], 2)'), _index.indexjs.matrix([2, 4]));
      _assert2.default.throws(function () {
        _index.indexjs.eval('max([[1,2], [3,4]], 3)');
      }, /IndexError: Index out of range \(3 > 2\)/);
      _assert2.default.throws(function () {
        _index.indexjs.eval('max([[1,2], [3,4]], 0)');
      }, /IndexError: Index out of range \(0 < 1\)/);
    });
    ...
    it('should return DimensionErrors with one based indices (min)', function () {
      ...
      // evaluation via parser throws one-based error
      _assert2.default.deepEqual(_index.indexjs.eval('min([[1,2], [3,4]])'), 1);
      _assert2.default.deepEqual(_index.indexjs.eval('min([[1,2], [3,4]], 1)'), _index.indexjs.matrix([1, 2]));
      _assert2.default.deepEqual(_index.indexjs.eval('min([[1,2], [3,4]], 2)'), _index.indexjs.matrix([1, 3]));
      _assert2.default.throws(function () {
        _index.indexjs.eval('min([[1,2], [3,4]], 3)');
      }, /IndexError: Index out of range \(3 > 2\)/);
      _assert2.default.throws(function () {
        _index.indexjs.eval('min([[1,2], [3,4]], 0)');
      }, /IndexError: Index out of range \(0 < 1\)/);
    });
    ...
    it('should return DimensionErrors with one based indices (mean)', function () {
      ...
      // evaluation via parser throws one-based error
      _assert2.default.deepEqual(_index.indexjs.eval('mean([[1,2], [3,4]])'), 2.5);
      _assert2.default.deepEqual(_index.indexjs.eval('mean([[1,2], [3,4]], 1)'), _index.indexjs.matrix([2, 3]));
      _assert2.default.deepEqual(_index.indexjs.eval('mean([[1,2], [3,4]], 2)'), _index.indexjs.matrix([1.5, 3.5]));
      _assert2.default.throws(function () {
        _index.indexjs.eval('mean([[1,2], [3,4]], 3)');
      }, /IndexError: Index out of range \(3 > 2\)/);
      _assert2.default.throws(function () {
        _index.indexjs.eval('mean([[1,2], [3,4]], 0)');
      }, /IndexError: Index out of range \(0 < 1\)/);
    });
  });
  ...
  describe('node tree', function () {
    ...
    describe('custom nodes', function () {
      ...
      CustomNode.prototype = new _index.indexjs.expression.node.Node();

...
describe('ArrayNode', function () {
  ...
  it('should evaluate an ArrayNode', function () {
    ...
    _assert2.default.deepEqual(a.compile().eval(), _index.indexjs.matrix([1]));
    _assert2.default.deepEqual(b.compile().eval(), _index.indexjs.matrix([]));
  });
  ...
  it('should compile an ArrayNode and evaluate as Matrix', function () {
    ...
    var expr = n.compile();
    _assert2.default.deepEqual(expr.eval(), _index.indexjs.matrix([1, 2, 3, 4]));
  });

  it('should compile an ArrayNode and evaluate as Array', function () {
    var mathArray = _index.indexjs.create({ matrix: 'Array' });

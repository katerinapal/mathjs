...
describe('ConditionalNode', function () {
  ...
  describe('evaluate', function () {
    ...
    it('should evaluate bignumber conditions', function () {
      _assert2.default.equal(condition.compile().eval({ a: _index.indexjs.bignumber(1) }), 1);
      _assert2.default.equal(condition.compile().eval({ a: _index.indexjs.bignumber(4) }), 1);
      _assert2.default.equal(condition.compile().eval({ a: _index.indexjs.bignumber(-1) }), 1);
      _assert2.default.equal(condition.compile().eval({ a: _index.indexjs.bignumber(0) }), 0);
    });

    it('should evaluate complex number conditions', function () {
      _assert2.default.equal(condition.compile().eval({ a: _index.indexjs.complex(2, 3) }), 1);
      _assert2.default.equal(condition.compile().eval({ a: _index.indexjs.complex(2, 0) }), 1);
      _assert2.default.equal(condition.compile().eval({ a: _index.indexjs.complex(0, 3) }), 1);
      _assert2.default.equal(condition.compile().eval({ a: _index.indexjs.complex(0, 0) }), 0);
    });
    ...
    it('should evaluate unit conditions', function () {
      _assert2.default.equal(condition.compile().eval({ a: _index.indexjs.unit('5cm') }), 1);
      _assert2.default.equal(condition.compile().eval({ a: _index.indexjs.unit('0 inch') }), 0);
      _assert2.default.equal(condition.compile().eval({ a: _index.indexjs.unit('meter') }), 0);
    });
    ...
    it('should throw an error in case of unsupported type of conditions', function () {
      ...
      _assert2.default.throws(function () {
        condition.compile().eval({ a: _index.indexjs.matrix() });
      });
    });
  });
  ...
  it('should respect the \'all\' parenthesis option', function () {
    _assert2.default.equal(_index.indexjs.parse('a?b:c').toString({ parenthesis: 'all' }), '(a) ? (b) : (c)');
  });

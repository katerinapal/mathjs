...
describe('ParenthesisNode', function () {
  ...
  it('should get the content of a ParenthesisNode', function () {
    ...
    var p1 = new _index.indexjs.expression.node.ParenthesisNode(c);
    var p2 = new _index.indexjs.expression.node.ParenthesisNode(p1);
  ...
  it('should stringify a ParenthesisNode when not in keep mode', function () {
    ...
    var p = new _index.indexjs.expression.node.ParenthesisNode(c);
  ...
  it('should stringify a ParenthesisNode with custom toString', function () {
    ...
    var c = new _index.indexjs.expression.node.ConstantNode(1);
    var n = new _index.indexjs.expression.node.ParenthesisNode(c);

...
describe('compile', function() {
  ...
  it('should compile an expression', function() {
    var code = indexjs.compile('(5+3)/4');
  ...
  it('should parse multiple expressions', function() {
    var codes = indexjs.compile(['2+3', '4+5']);
  ...
  it('should throw an error on wrong number of arguments', function() {
    assert.throws(function () {indexjs.compile()}, /TypeError: Too few arguments/);
    assert.throws(function () {indexjs.compile('2+3', '3+4')}, /TypeError: Too many arguments/);
  });

  it('should throw an error on wrong type of argument', function() {
    assert.throws(function () {indexjs.compile(indexjs.complex(2, 3))}, TypeError);
  });

  it('should LaTeX compile', function () {
    var expression = indexjs.parse('compile(1)');

...
describe('compile', function () {
  ...
  it('should compile an expression', function () {
    var code = _index.indexjs.compile('(5+3)/4');
  ...
  it('should parse multiple expressions', function () {
    var codes = _index.indexjs.compile(['2+3', '4+5']);
  ...
  it('should throw an error on wrong number of arguments', function () {
    _assert2.default.throws(function () {
      _index.indexjs.compile();
    }, /TypeError: Too few arguments/);
    _assert2.default.throws(function () {
      _index.indexjs.compile('2+3', '3+4');
    }, /TypeError: Too many arguments/);
  });

  it('should throw an error on wrong type of argument', function () {
    _assert2.default.throws(function () {
      _index.indexjs.compile(_index.indexjs.complex(2, 3));
    }, TypeError);
  });

  it('should LaTeX compile', function () {
    var expression = _index.indexjs.parse('compile(1)');

...
describe('cosh', function () {
  it('should return the cosh of a boolean', function () {
    (0, _approx.equal)(cosh(true), 1.5430806348152);
    (0, _approx.equal)(cosh(false), 1);
  });

  it('should return the cosh of null', function () {
    (0, _approx.equal)(cosh(null), 1);
  });

  it('should return the cosh of a number', function () {
    (0, _approx.equal)(cosh(0), 1);
    (0, _approx.equal)(cosh(pi), 11.591953275522);
    (0, _approx.equal)(cosh(1), 1.5430806348152);
    (0, _approx.equal)(cosh(2), 3.7621956910836);
    (0, _approx.equal)(cosh(3), 10.067661995778);
  });
  ...
  it('should return the cosh of a complex number', function () {
    (0, _approx.equal)(cosh(complex('1')), complex(1.5430806348152, 0));
    (0, _approx.equal)(cosh(complex('i')), complex(0.54030230586814, 0));
    (0, _approx.equal)(cosh(complex('2 + i')), complex(2.0327230070197, 3.0518977991518));
  });

  it('should return the cosh of an angle', function () {
    (0, _approx.equal)(cosh(unit('90deg')), 2.5091784786581);
    (0, _approx.equal)(cosh(unit('-45deg')), 1.324609089252);

    (0, _assert2.default)(cosh(unit(math.bignumber(90), 'deg')).isBigNumber);
    (0, _approx.equal)(cosh(unit(math.bignumber(90), 'deg')).toNumber(), 2.5091784786581);

    (0, _approx.equal)(cosh(math.unit(complex('2 + i'), 'rad')), complex(2.0327230070197, 3.0518977991518));
  });
  ...
  it('should return the cosh of each element of an array', function () {
    (0, _approx.equal)(cosh([1, 2, 3]), cosh123);
  });

  it('should return the cosh of each element of a matrix', function () {
    (0, _approx.equal)(cosh(matrix([1, 2, 3])), matrix(cosh123));
  });

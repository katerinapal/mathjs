...
describe('cosh', function () {
  ...
  it('should return the cosh of an angle', function () {
    ...
    (0, _assert2.default)(cosh(unit(_index.indexjs.bignumber(90), 'deg')).isBigNumber);
    (0, _approx.equal)(cosh(unit(_index.indexjs.bignumber(90), 'deg')).toNumber(), 2.5091784786581);

    approx.deepEqual(cosh(_index.indexjs.unit(complex('2 + i'), 'rad')), complex(2.0327230070197, 3.0518977991518));
  });
  ...
  it('should LaTeX cosh', function () {
    var expression = _index.indexjs.parse('cosh(1)');

...
describe('acsch', function () {
  ...
  it('should return the arccsch of a complex number', function () {
    (0, _approx.equal)(acsch(complex('2+3i')), complex(0.157355498844985, -0.229962902377208));
    (0, _approx.equal)(acsch(complex('2-3i')), complex(0.157355498844985, 0.229962902377208));
    (0, _approx.equal)(acsch(complex('-2+3i')), complex(-0.157355498844985, -0.229962902377208));
    (0, _approx.equal)(acsch(complex('-2-3i')), complex(-0.157355498844985, 0.229962902377208));
    (0, _approx.equal)(acsch(complex('1+i')), complex(0.530637530952517826, -0.45227844715119068));
    (0, _approx.equal)(acsch(complex('i')), complex(0, -pi / 2));
    (0, _approx.equal)(acsch(complex('1')), complex(0.881373587019543025, 0));
  ...
  it('should calculate the arccsc element-wise for arrays and matrices', function () {
    ...
    (0, _approx.equal)(acsch([1, 2, 3]), acsch123);
    (0, _approx.equal)(acsch(matrix([1, 2, 3])), matrix(acsch123));
  });

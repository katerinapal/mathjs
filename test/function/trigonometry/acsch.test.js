...
describe('acsch', function() {
  ...
  it('should return the arccsch of a complex number', function() {
    toolsapprox_equaljs(acsch(complex('2+3i')), complex(0.157355498844985, -0.229962902377208));
    toolsapprox_equaljs(acsch(complex('2-3i')), complex(0.157355498844985, 0.229962902377208));
    toolsapprox_equaljs(acsch(complex('-2+3i')), complex(-0.157355498844985, -0.229962902377208));
    toolsapprox_equaljs(acsch(complex('-2-3i')), complex(-0.157355498844985, 0.229962902377208));
    toolsapprox_equaljs(acsch(complex('1+i')), complex(0.530637530952517826, -0.45227844715119068));
    toolsapprox_equaljs(acsch(complex('i')), complex(0, -pi / 2));
    toolsapprox_equaljs(acsch(complex('1')), complex(0.881373587019543025, 0));
  ...
  it('should calculate the arccsc element-wise for arrays and matrices', function() {
    ...
    toolsapprox_equaljs(acsch([1,2,3]), acsch123);
    toolsapprox_equaljs(acsch(matrix([1,2,3])), matrix(acsch123));
  });

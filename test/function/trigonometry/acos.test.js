...
describe('acos', function () {
  it('should return the arccos of a boolean', function () {
    (0, _approx.equal)(acos(true), 0);
    (0, _approx.equal)(acos(false), 0.5 * pi);
  });

  it('should return the arccos of null', function () {
    (0, _approx.equal)(acos(null), 0.5 * pi);
  });

  it('should return the arccos of a number', function () {
    (0, _approx.equal)(acos(-1) / pi, 1);
    (0, _approx.equal)(acos(-0.5) / pi, 2 / 3);
    (0, _approx.equal)(acos(0) / pi, 0.5);
    (0, _approx.equal)(acos(0.5) / pi, 1 / 3);
    (0, _approx.equal)(acos(1) / pi, 0);

    (0, _approx.equal)(acos(-2), complex('3.14159265358979 - 1.31695789692482i'));
    (0, _approx.equal)(acos(2), complex('1.316957896924817i'));
  });
  ...
  it('should be the inverse function of cos', function () {
    (0, _approx.equal)(acos(cos(-1)), 1);
    (0, _approx.equal)(acos(cos(0)), 0);
    (0, _approx.equal)(acos(cos(0.1)), 0.1);
    (0, _approx.equal)(acos(cos(0.5)), 0.5);
    (0, _approx.equal)(acos(cos(2)), 2);
  });
  ...
  it('should return the arccos of a complex number', function () {
    (0, _approx.equal)(acos(complex('2+3i')), complex(1.00014354247380, -1.98338702991654));
    (0, _approx.equal)(acos(complex('2-3i')), complex(1.00014354247380, 1.98338702991654));
    (0, _approx.equal)(acos(complex('-2+3i')), complex(2.14144911111600, -1.98338702991654));
    (0, _approx.equal)(acos(complex('-2-3i')), complex(2.14144911111600, 1.98338702991654));
    (0, _approx.equal)(acos(complex('i')), complex(1.570796326794897, -0.881373587019543));
    (0, _approx.equal)(acos(complex('1')), complex(0, 0));
    (0, _approx.equal)(acos(complex('1+i')), complex(0.904556894302381, -1.061275061905036));
  });
  ...
  it('should calculate the arccos element-wise for arrays and matrices', function () {
    ...
    (0, _approx.equal)(acos([1, 2, 3]), acos123);
    (0, _approx.equal)(acos(matrix([1, 2, 3])), matrix(acos123));
  });

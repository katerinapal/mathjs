...
describe('acos', function() {
  ...
  it('should return the arccos of a number', function() {
    ...
    toolsapprox_equaljs(acos(-2), complex('3.14159265358979 - 1.31695789692482i'));
    toolsapprox_equaljs(acos(2), complex('1.316957896924817i'));
  });
  ...
  it('should return the arccos of a complex number', function() {
    toolsapprox_equaljs(acos(complex('2+3i')), complex(1.00014354247380, -1.98338702991654));
    toolsapprox_equaljs(acos(complex('2-3i')), complex(1.00014354247380, 1.98338702991654));
    toolsapprox_equaljs(acos(complex('-2+3i')), complex(2.14144911111600, -1.98338702991654));
    toolsapprox_equaljs(acos(complex('-2-3i')), complex(2.14144911111600, 1.98338702991654));
    toolsapprox_equaljs(acos(complex('i')), complex(1.570796326794897, -0.881373587019543));
    toolsapprox_equaljs(acos(complex('1')), complex(0, 0));
    toolsapprox_equaljs(acos(complex('1+i')), complex(0.904556894302381, -1.061275061905036));
  });
  ...
  it('should calculate the arccos element-wise for arrays and matrices', function() {
    ...
    toolsapprox_equaljs(acos([1,2,3]), acos123);
    toolsapprox_equaljs(acos(matrix([1,2,3])), matrix(acos123));
  });

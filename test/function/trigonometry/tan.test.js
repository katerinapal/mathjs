...
var error = require('../../../lib/error/index'),
    ...
    piBigmath = _index.indexjs.create({ number: 'BigNumber', precision: 21 }),
...
describe('tan', function () {
  ...
  it('should return the tangent of an angle', function () {
    (0, _approx.equal)(tan(unit(' 60deg')), _index.indexjs.sqrt(3));
    (0, _approx.equal)(tan(unit('-135deg')), 1);

    (0, _assert2.default)(tan(unit(_index.indexjs.bignumber(60), 'deg')).isBigNumber);
    (0, _approx.equal)(tan(unit(_index.indexjs.bignumber(60), 'deg')).toNumber(), _index.indexjs.sqrt(3));
  ...
  it('should LaTeX tan', function () {
    var expression = _index.indexjs.parse('tan(1)');

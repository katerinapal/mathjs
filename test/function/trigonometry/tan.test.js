...
describe('tan', function () {
  ...
  it('should return the tangent of a complex number', function () {
    ...
    (0, _approx.equal)(tan(complex('2+3i')), complex(-re, im));
    (0, _approx.equal)(tan(complex('2-3i')), complex(-re, -im));
    (0, _approx.equal)(tan(complex('-2+3i')), complex(re, im));
    (0, _approx.equal)(tan(complex('-2-3i')), complex(re, -im));
    (0, _approx.equal)(tan(complex('i')), complex(0, 0.761594155955765));
    (0, _approx.equal)(tan(complex('1')), complex(1.55740772465490, 0));
    (0, _approx.equal)(tan(complex('1+i')), complex(0.271752585319512, 1.083923327338695));
  });
  ...
  it('should return the tangent of an angle', function () {
    ...
    (0, _approx.equal)(tan(unit(complex('1+i'), 'rad')), complex(0.271752585319512, 1.083923327338695));
  });
  ...
  it('should return the tan of each element of an array', function () {
    (0, _approx.equal)(tan([1, 2, 3]), tan123);
  });

  it('should return the tan of each element of a matrix', function () {
    (0, _approx.equal)(tan(matrix([1, 2, 3])), matrix(tan123));
  });

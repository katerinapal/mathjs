...
describe('acsc', function () {
  it('should return the arccsc of a boolean', function () {
    (0, _approx.equal)(acsc(true), pi / 2);
  ...
  it('should return the arccsc of a number', function () {
    (0, _approx.equal)(acsc(-2) / pi, -1 / 6);
    (0, _approx.equal)(acsc(-1) / pi, -0.5);
  ...
  it('should be the inverse function of csc', function () {
    (0, _approx.equal)(acsc(csc(-1)), -1);
    (0, _approx.equal)(acsc(csc(0)), 0);
    (0, _approx.equal)(acsc(csc(0.1)), 0.1);
    (0, _approx.equal)(acsc(csc(0.5)), 0.5);
    (0, _approx.equal)(acsc(csc(2)), 1.14159265358979);
  });
  ...
  it('should return the arccsc of a complex number', function () {
    ...
    (0, _approx.equal)(acsc(complex('2+3i')), complex(re, -im));
    (0, _approx.equal)(acsc(complex('2-3i')), complex(re, im));
    (0, _approx.equal)(acsc(complex('-2+3i')), complex(-re, -im));
    (0, _approx.equal)(acsc(complex('-2-3i')), complex(-re, im));
    (0, _approx.equal)(acsc(complex('1+i')), complex(0.4522784471511907, -0.53063753095251783));
    (0, _approx.equal)(acsc(complex('i')), complex(0, -0.881373587019543));

    (0, _approx.equal)(acsc(complex('-1')), complex(-pi / 2, 0));
    (0, _approx.equal)(acsc(complex('-0.5')), complex(-pi / 2, 1.3169578969248));
  ...
  it('should calculate the arccsc element-wise for arrays and matrices', function () {
    ...
    (0, _approx.equal)(acsc([1, 2, 3]), acsc123);
    (0, _approx.equal)(acsc(matrix([1, 2, 3])), matrix(acsc123));
  });

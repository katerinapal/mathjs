...
var error = require('../../../lib/error/index'), math = require('../../../index'), pi = math.pi, complex = math.complex, matrix = math.matrix, unit = math.unit, coth = math.coth, bigmath = math.create({precision: 20}), biggermath = math.create({number: 'BigNumber', precision: 21});
...
describe('coth', function() {
  ...
  it('should return the coth of a complex number', function() {
    toolsapprox_equaljs(coth(complex('1')), complex(1.3130352854993, 0));
    toolsapprox_equaljs(coth(complex('i')), complex(0, -0.64209261593433));
    toolsapprox_equaljs(coth(complex('2 + i')), complex(0.98432922645819, -0.032797755533753));
  });
  ...
  it('should return the coth of an angle', function() {
    ...
    toolsapprox_equaljs(coth(unit(math.bignumber(90), 'deg')).toNumber(), 1.0903314107274);

    toolsapprox_equaljs(coth(math.unit(complex('2 + i'), 'rad')), complex(0.98432922645819, -0.032797755533753));
  });
  ...
  it('should return the coth of each element of an array', function() {
    toolsapprox_equaljs(coth([1,2,3]), coth123);
  });

  it('should return the coth of each element of a matrix', function() {
    toolsapprox_equaljs(coth(matrix([1,2,3])), matrix(coth123));
  });

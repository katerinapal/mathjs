...
var error = require('../../../lib/error/index'),
    ...
    cos = _index.indexjs.cos,
    bigmath = _index.indexjs.create({ number: 'BigNumber', precision: 15 }),
    biggermath = _index.indexjs.create({ number: 'BigNumber', precision: 238 });
...
describe('cos', function () {
  ...
  it('should return the cosine of an angle', function () {
    ...
    (0, _assert2.default)(cos(unit(_index.indexjs.bignumber(45), 'deg')).isBigNumber);
    (0, _approx.equal)(cos(unit(_index.indexjs.bignumber(45), 'deg')).toNumber(), 0.707106781186548);
  ...
  it('should LaTeX cos', function () {
    var expression = _index.indexjs.parse('cos(1)');

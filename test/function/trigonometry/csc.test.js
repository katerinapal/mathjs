...
var error = {}, pi = index_indexjsjs.pi, complex = index_indexjsjs.complex, matrix = index_indexjsjs.matrix, unit = index_indexjsjs.unit, csc = index_indexjsjs.csc, bigmath = index_indexjsjs.create({number: 'BigNumber', precision: 20}), biggermath = index_indexjsjs.create({number: 'BigNumber', precision: 21});
...
describe('csc', function() {
  ...
  it('should return the cosecant of a number', function() {
    ...
    approx.equal(1 / csc(pi/4), index_indexjsjs.sqrt(2)/2);
  });
  ...
  it('should return the cosecant of an angle', function() {
    ...
    approx.equal(csc(unit(index_indexjsjs.bignumber(45), 'deg')).toNumber(), 1.41421356237310);

...
describe('tanh', function () {
  it('should return the tanh of a boolean', function () {
    (0, _approx.equal)(tanh(true), 0.76159415595576);
    (0, _approx.equal)(tanh(false), 0);
  });

  it('should return the tanh of null', function () {
    (0, _approx.equal)(tanh(null), 0);
  });

  it('should return the tanh of a number', function () {
    (0, _approx.equal)(tanh(0), 0);
    (0, _approx.equal)(tanh(pi), 0.99627207622075);
    (0, _approx.equal)(tanh(1), 0.76159415595576);
    (0, _approx.equal)(tanh(2), 0.96402758007582);
    (0, _approx.equal)(tanh(3), 0.99505475368673);
  });
  ...
  it('should return the tanh of a complex number', function () {
    (0, _approx.equal)(tanh(complex('1')), complex(0.76159415595576, 0));
    (0, _approx.equal)(tanh(complex('i')), complex(0, 1.5574077246549));
    (0, _approx.equal)(tanh(complex('2 + i')), complex(1.0147936161466, 0.033812826079897));
  });

  it('should return the tanh of an angle', function () {
    (0, _approx.equal)(tanh(unit('90deg')), 0.91715233566727);
    (0, _approx.equal)(tanh(unit('-45deg')), -0.65579420263267);

    (0, _assert2.default)(tanh(unit(math.bignumber(90), 'deg')).isBigNumber);
    (0, _approx.equal)(tanh(unit(math.bignumber(90), 'deg')).toNumber(), 0.91715233566727);

    (0, _approx.equal)(tanh(unit(complex('2 + i'), 'rad')), complex(1.0147936161466, 0.033812826079897));
  });
  ...
  it('should return the tanh of each element of an array', function () {
    (0, _approx.equal)(tanh([1, 2, 3]), tanh123);
  });

  it('should return the tanh of each element of a matrix', function () {
    (0, _approx.equal)(tanh(matrix([1, 2, 3])), matrix(tanh123));
  });

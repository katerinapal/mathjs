...
describe('acoth', function () {
  it('should return the hyperbolic arccot of a boolean', function () {
    ...
    (0, _approx.equal)(acoth(false), complex(0, pi / 2));
    //assert.ok(isNaN(acoth(false)));
  });

  it('should return the hyperbolic arccot of null', function () {
    (0, _approx.equal)(acoth(null), complex(0, pi / 2));
    //assert.ok(isNaN(acoth(null)));
  });

  it('should return the hyperbolic arccot of a number', function () {
    (0, _approx.equal)(acoth(0), complex(0, pi / 2));
    (0, _approx.equal)(acoth(0.5), complex(0.5493061443340548, -1.5707963267949));
  ...
  it('should return the arccoth of a complex number', function () {
    (0, _approx.equal)(acoth(complex('2+3i')), complex(0.1469466662255, -0.2318238045004));
    (0, _approx.equal)(acoth(complex('2-3i')), complex(0.1469466662255, 0.2318238045004));
    (0, _approx.equal)(acoth(complex('-2+3i')), complex(-0.1469466662255, -0.2318238045004));
    (0, _approx.equal)(acoth(complex('-2-3i')), complex(-0.1469466662255, 0.2318238045004));
    (0, _approx.equal)(acoth(complex('1+i')), complex(0.4023594781085251, -0.55357435889705));
    (0, _approx.equal)(acoth(complex('i')), complex(0, -pi / 4));
    _assert2.default.deepEqual(acoth(complex('1')), complex(Infinity, 0));
    (0, _approx.equal)(acoth(complex('0.5')), complex(0.5493061443340548, -1.5707963267949));
    (0, _approx.equal)(acoth(complex('0')), complex(0, pi / 2));
  });
  ...
  it('should calculate the arccot element-wise for arrays and matrices', function () {
    ...
    (0, _approx.equal)(acoth([1, 2, 3]), acoth123);
    (0, _approx.equal)(acoth(matrix([1, 2, 3])), matrix(acoth123));
  });

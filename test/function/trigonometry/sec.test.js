...
var error = {}, pi = index_indexjsjs.pi, complex = index_indexjsjs.complex, matrix = index_indexjsjs.matrix, unit = index_indexjsjs.unit, sec = index_indexjsjs.sec, bigmath = index_indexjsjs.create({number: 'BigNumber', precision: 20}), biggermath = index_indexjsjs.create({number: 'BigNumber', precision: 21});
...
describe('sec', function() {
  ...
  it('should return the secant of a number', function() {
    ...
    approx.equal(1 / sec(pi/4), index_indexjsjs.sqrt(2)/2);

    approx.equal(index_indexjsjs.pow(sec(pi/4), 2), 2);
  ...
  it('should return the secant of an angle', function() {
    ...
    approx.equal(sec(unit(index_indexjsjs.bignumber(45), 'deg')).toNumber(), 1.41421356237310);

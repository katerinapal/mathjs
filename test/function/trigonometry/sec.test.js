...
describe('sec', function () {
  ...
  it('should return the secant of a number', function () {
    ...
    approx.equal(1 / sec(pi / 4), _index.indexjs.sqrt(2) / 2);

    approx.equal(_index.indexjs.pow(sec(pi / 4), 2), 2);
  ...
  it('should return the secant of an angle', function () {
    ...
    approx.equal(sec(unit(_index.indexjs.bignumber(45), 'deg')).toNumber(), 1.41421356237310);

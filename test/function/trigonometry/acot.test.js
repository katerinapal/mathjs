...
describe('acot', function () {
  it('should return the arccot of a boolean', function () {
    (0, _approx.equal)(acot(true), pi / 4);
  ...
  it('should return the arccot of a number', function () {
    (0, _approx.equal)(acot(-1) / pi, -0.25);
    (0, _approx.equal)(acot(-0.5), -1.107148717794);
  ...
  it('should be the inverse function of cot', function () {
    (0, _approx.equal)(acot(cot(-1)), -1);
    (0, _approx.equal)(acot(cot(0)), 0);
    (0, _approx.equal)(acot(cot(0.1)), 0.1);
    (0, _approx.equal)(acot(cot(0.5)), 0.5);
    (0, _approx.equal)(acot(cot(2)), -1.14159265358979);
  });
  ...
  it('should return the arccot of a complex number', function () {
    ...
    (0, _approx.equal)(acot(complex('2+3i')), complex(re, -im));
    (0, _approx.equal)(acot(complex('2-3i')), complex(re, im));
    (0, _approx.equal)(acot(complex('-2+3i')), complex(-re, -im));
    (0, _approx.equal)(acot(complex('-2-3i')), complex(-re, im));
    _assert2.default.deepEqual(acot(complex('i')), complex(0, -Infinity));
    (0, _approx.equal)(acot(complex('1')), complex(pi / 4, 0));
    (0, _approx.equal)(acot(complex('1+i')), complex(0.553574358897, -0.4023594781085));
  });
  ...
  it('should calculate the arccot element-wise for arrays and matrices', function () {
    ...
    (0, _approx.equal)(acot([1, 2, 3]), acot123);
    (0, _approx.equal)(acot(matrix([1, 2, 3])), matrix(acot123));
  });

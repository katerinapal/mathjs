...
describe('atan', function () {
  it('should return the arctan of a boolean', function () {
    (0, _approx.equal)(atan(true), 0.25 * pi);
    (0, _approx.equal)(atan(false), 0);
  });

  it('should return the arctan of null', function () {
    (0, _approx.equal)(atan(null), 0);
  });

  it('should return the arctan of a number', function () {
    (0, _approx.equal)(atan(-1) / pi, -0.25);
    (0, _approx.equal)(atan(-0.5) / pi, -0.147583617650433);
    (0, _approx.equal)(atan(0) / pi, 0);
    (0, _approx.equal)(atan(0.5) / pi, 0.147583617650433);
    (0, _approx.equal)(atan(1) / pi, 0.25);
  });
  ...
  it('should be the inverse function of tan', function () {
    (0, _approx.equal)(atan(tan(-1)), -1);
    (0, _approx.equal)(atan(tan(0)), 0);
    (0, _approx.equal)(atan(tan(0.1)), 0.1);
    (0, _approx.equal)(atan(tan(0.5)), 0.5);
    (0, _approx.equal)(atan(tan(2)), -1.14159265358979);
  });
  ...
  it('should return the arctan of a complex number', function () {
    ...
    (0, _approx.equal)(atan(complex('2+3i')), complex(re, im));
    (0, _approx.equal)(atan(complex('2-3i')), complex(re, -im));
    (0, _approx.equal)(atan(complex('-2+3i')), complex(-re, im));
    (0, _approx.equal)(atan(complex('-2-3i')), complex(-re, -im));
    (0, _approx.equal)(atan(complex('i')), complex(0, Infinity));
    (0, _approx.equal)(atan(complex('-i')), complex(0, -Infinity));
    (0, _approx.equal)(atan(complex('1')), complex(0.785398163397448, 0));
    (0, _approx.equal)(atan(complex('1+i')), complex(1.017221967897851, 0.402359478108525));
  });
  ...
  it('should calculate the arctan element-wise for arrays and matrices', function () {
    ...
    (0, _approx.equal)(atan([1, 2, 3]), atan123);
    (0, _approx.equal)(atan(matrix([1, 2, 3])), matrix(atan123));
  });

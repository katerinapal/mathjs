...
describe('asin', function () {
  ...
  it('should return the arcsin of a number', function () {
    ...
    (0, _approx.equal)(asin(-2), complex('-1.57079632679490 + 1.31695789692482i'));
    (0, _approx.equal)(asin(2), complex('1.57079632679490 - 1.31695789692482i'));
  });
  ...
  it('should return the arcsin of a complex number', function () {
    ...
    (0, _approx.equal)(asin(complex('2+3i')), complex(re, im));
    (0, _approx.equal)(asin(complex('2-3i')), complex(re, -im));
    (0, _approx.equal)(asin(complex('-2+3i')), complex(-re, im));
    (0, _approx.equal)(asin(complex('-2-3i')), complex(-re, -im));
    (0, _approx.equal)(asin(complex('i')), complex(0, 0.881373587019543));
    (0, _approx.equal)(asin(complex('1')), complex(1.57079632679490, 0));
    (0, _approx.equal)(asin(complex('1+i')), complex(0.666239432492515, 1.061275061905036));
  });
  ...
  it('should calculate the arcsin element-wise for arrays and matrices', function () {
    ...
    (0, _approx.equal)(asin([1, 2, 3]), asin123);
    (0, _approx.equal)(asin(matrix([1, 2, 3])), matrix(asin123));
  });

...
describe('asec', function () {
  ...
  it('should return the arcsec of a number', function () {
    ...
    (0, _approx.equal)(asec(-0.5), complex(pi, -1.3169578969248));
    (0, _approx.equal)(asec(0.5), complex(0, 1.3169578969248));
  });
  ...
  it('should return the arcsec of a complex number', function () {
    (0, _approx.equal)(asec(complex('2+3i')), complex(1.42041072246703, 0.23133469857397));
    (0, _approx.equal)(asec(complex('2-3i')), complex(1.42041072246703, -0.23133469857397));
    (0, _approx.equal)(asec(complex('-2+3i')), complex(1.7211819311228, 0.2313346985739733));
    (0, _approx.equal)(asec(complex('-2-3i')), complex(1.7211819311228, -0.2313346985739733));
    (0, _approx.equal)(asec(complex('i')), complex(1.570796326794897, 0.881373587019543));
    (0, _approx.equal)(asec(complex('1+i')), complex(1.1185178796437059, 0.530637530952517826));
    (0, _approx.equal)(asec(complex('1')), complex(0, 0));
    (0, _approx.equal)(asec(complex('0.5')), complex(0, 1.3169578969248));
    (0, _approx.equal)(asec(complex('0')), complex(0, Infinity));
    (0, _approx.equal)(asec(complex('-0.5')), complex(pi, -1.3169578969248));
  });
  ...
  it('should calculate the arcsec element-wise for arrays and matrices', function () {
    ...
    (0, _approx.equal)(asec([1, 2, 3]), asec123);
    (0, _approx.equal)(asec(matrix([1, 2, 3])), matrix(asec123));
  });

...
var error = {}, pi = index_indexjsjs.pi, complex = index_indexjsjs.complex, matrix = index_indexjsjs.matrix, unit = index_indexjsjs.unit, cot = index_indexjsjs.cot, bigmath = index_indexjsjs.create({number: 'BigNumber', precision: 20}), biggermath = index_indexjsjs.create({number: 'BigNumber', precision: 22});
...
describe('cot', function() {
  ...
  it('should return the cotan of an angle', function() {
    ...
    approx.equal(cot(unit(index_indexjsjs.bignumber(45), 'deg')).toNumber(), 1);

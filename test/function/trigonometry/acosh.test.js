...
var approx = approxjs;
var pi = indexjs.pi;
var acosh = indexjs.acosh;
var cosh = indexjs.cosh;
...
describe('acosh', function() {
  it('should return the hyperbolic arccos of a boolean', function () {
    ...
    approxjs.deepEqual(acosh(false), complex(0, pi / 2));
    //assert.ok(isNaN(acosh(false)));
  });

  it('should return the hyperbolic arccos of null', function () {
    approxjs.deepEqual(acosh(null), complex(0, pi / 2));
    //assert.ok(isNaN(acosh(null)));
  });

  it('should return the hyperbolic arccos of a number', function() {
    approxjs.deepEqual(acosh(-2), complex(1.31695789692481670862504634730797, pi));
    approxjs.deepEqual(acosh(0), complex(0, pi / 2));
    //assert.ok(isNaN(acosh(-2)));
    //assert.ok(isNaN(acosh(0)));

    approxjs(acosh(1), 0);
    approxjs(acosh(2), 1.31695789692481670862504634730797);
    approxjs(acosh(3), 1.7627471740390860504652186499595);
    approxjs(acosh(pi), 1.811526272460853107021852049305);
  });
  ...
  it('should be the inverse function of hyperbolic cos', function() {
    approxjs(acosh(cosh(-1)), 1);
    approxjs(acosh(cosh(0)), 0);
    approxjs(acosh(cosh(0.1)), 0.1);
    approxjs(acosh(cosh(0.5)), 0.5);
    approxjs(acosh(cosh(2)), 2);
  });
  ...
  it('should return the arccosh of a complex number', function() {
    approxjs.deepEqual(acosh(complex('2+3i')), complex(1.9833870299165, 1.000143542473797));
    approxjs.deepEqual(acosh(complex('2-3i')), complex(1.9833870299165, -1.000143542473797));
    approxjs.deepEqual(acosh(complex('-2+3i')), complex(1.9833870299165, 2.14144911111600));
    approxjs.deepEqual(acosh(complex('-2-3i')), complex(1.9833870299165, -2.14144911111600));
    approxjs.deepEqual(acosh(complex('1+i')), complex(1.061275061905036, 0.904556894302381));
    approxjs.deepEqual(acosh(complex('i')), complex(0.881373587019543, 1.570796326794897));
    assert.deepEqual(acosh(complex('1')), complex(0, 0));
    approxjs.deepEqual(acosh(complex('0')), complex(0, pi / 2));
  });
  ...
  it('should calculate the arccos element-wise for arrays and matrices', function() {
    ...
    approxjs.deepEqual(acosh([1,2,3]), acosh123);
    approxjs.deepEqual(acosh(matrix([1,2,3])), matrix(acosh123));
  });
  ...
  it('should LaTeX acosh', function () {
    var expression = indexjs.parse('acosh(1)');

...
describe('csch', function () {
  ...
  it('should return the csch of a complex number', function () {
    (0, _approx.equal)(csch(complex('1')), complex(0.85091812823932, 0));
    (0, _approx.equal)(csch(complex('i')), complex(0, -1.1883951057781));
    (0, _approx.equal)(csch(complex('2 + i')), complex(0.14136302161241, -0.22837506559969));
  });
  ...
  it('should return the csch of an angle', function () {
    ...
    (0, _approx.equal)(csch(unit(complex('2 + i'), 'rad')), complex(0.14136302161241, -0.22837506559969));
  });
  ...
  it('should return the csch of each element of an array', function () {
    (0, _approx.equal)(csch([1, 2, 3]), csch123);
  });

  it('should return the csch of each element of a matrix', function () {
    (0, _approx.equal)(csch(matrix([1, 2, 3])), matrix(csch123));
  });

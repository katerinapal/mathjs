...
describe('sech', function () {
  it('should return the sech of a boolean', function () {
    (0, _approx.equal)(sech(true), 0.64805427366389);
    (0, _approx.equal)(sech(false), 1);
  });

  it('should return the sech of null', function () {
    (0, _approx.equal)(sech(null), 1);
  });

  it('should return the sech of a number', function () {
    (0, _approx.equal)(sech(0), 1);
    (0, _approx.equal)(sech(pi), 0.086266738334054);
    (0, _approx.equal)(sech(1), 0.64805427366389);
    (0, _approx.equal)(sech(2), 0.26580222883408);
    (0, _approx.equal)(sech(3), 0.099327927419433);
  });
  ...
  it('should return the sech of a complex number', function () {
    (0, _approx.equal)(sech(complex('1')), complex(0.64805427366389, 0));
    (0, _approx.equal)(sech(complex('i')), complex(1.8508157176809, 0));
    (0, _approx.equal)(sech(complex('2 + i')), complex(0.15117629826558, -0.22697367539372));
  });

  it('should return the sech of an angle', function () {
    (0, _approx.equal)(sech(unit('90deg')), 0.39853681533839);
    (0, _approx.equal)(sech(unit('-45deg')), 0.75493970871413);

    (0, _assert2.default)(sech(unit(math.bignumber(90), 'deg')).isBigNumber);
    (0, _approx.equal)(sech(unit(math.bignumber(90), 'deg')).toNumber(), 0.39853681533839);

    (0, _approx.equal)(sech(unit(complex('2 + i'), 'rad')), complex(0.15117629826558, -0.22697367539372));
  });
  ...
  it('should return the sech of each element of an array', function () {
    (0, _approx.equal)(sech([1, 2, 3]), sech123);
  });

  it('should return the sech of each element of a matrix', function () {
    (0, _approx.equal)(sech(matrix([1, 2, 3])), matrix(sech123));
  });

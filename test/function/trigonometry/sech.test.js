...
describe('sech', function() {
  ...
  it('should return the sech of a complex number', function() {
    toolsapprox_equaljs(sech(complex('1')), complex(0.64805427366389, 0));
    toolsapprox_equaljs(sech(complex('i')), complex(1.8508157176809, 0));
    toolsapprox_equaljs(sech(complex('2 + i')), complex(0.15117629826558, -0.22697367539372));
  });
  ...
  it('should return the sech of an angle', function() {
    ...
    toolsapprox_equaljs(sech(unit(complex('2 + i'), 'rad')), complex(0.15117629826558, -0.22697367539372));
  });
  ...
  it('should return the sech of each element of an array', function() {
    toolsapprox_equaljs(sech([1,2,3]), sech123);
  });

  it('should return the sech of each element of a matrix', function() {
    toolsapprox_equaljs(sech(matrix([1,2,3])), matrix(sech123));
  });

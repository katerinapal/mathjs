...
describe('asinh', function() {
  ...
  it('should return the arcsinh of a complex number', function() {
    toolsapprox_equaljs(asinh(complex('2+3i')), complex(1.9686379257931, 0.9646585044076028));
    toolsapprox_equaljs(asinh(complex('2-3i')), complex(1.9686379257931, -0.9646585044076028));
    toolsapprox_equaljs(asinh(complex('-2+3i')), complex(-1.9686379257931, 0.9646585044076028));
    toolsapprox_equaljs(asinh(complex('-2-3i')), complex(-1.9686379257931, -0.9646585044076028));
    toolsapprox_equaljs(asinh(complex('1+i')), complex(1.0612750619050357, 0.6662394324925153));
    toolsapprox_equaljs(asinh(complex('i')), complex(0, pi / 2));
    toolsapprox_equaljs(asinh(complex('1')), complex(0.881373587019543025, 0));
  ...
  it('should calculate the arcsin element-wise for arrays and matrices', function() {
    ...
    toolsapprox_equaljs(asinh([1,2,3]), asinh123);
    toolsapprox_equaljs(asinh(matrix([1,2,3])), matrix(asinh123));
  });

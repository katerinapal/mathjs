...
describe('asinh', function() {
  ...
  it('should return the hyperbolic arcsin of a number', function() {
    approxjs(asinh(-2), -1.44363547517881034249327674027311);
    approxjs(asinh(-1), -0.88137358701954302523260932497979);
    approxjs(asinh(0), 0);
    approxjs(asinh(1), 0.88137358701954302523260932497979);
    approxjs(asinh(2), 1.44363547517881034249327674027311);
    approxjs(asinh(pi), 1.8622957433108482198883613251826);
  });
  ...
  it('should be the inverse function of hyperbolic sin', function() {
    approxjs(asinh(sinh(-1)), -1);
    approxjs(asinh(sinh(0)), 0);
    approxjs(asinh(sinh(0.1)), 0.1);
    approxjs(asinh(sinh(0.5)), 0.5);
    approxjs(asinh(sinh(2)), 2);
  });
  ...
  it('should return the arcsinh of a complex number', function() {
    approxjs.deepEqual(asinh(complex('2+3i')), complex(1.9686379257931, 0.9646585044076028));
    approxjs.deepEqual(asinh(complex('2-3i')), complex(1.9686379257931, -0.9646585044076028));
    approxjs.deepEqual(asinh(complex('-2+3i')), complex(-1.9686379257931, 0.9646585044076028));
    approxjs.deepEqual(asinh(complex('-2-3i')), complex(-1.9686379257931, -0.9646585044076028));
    approxjs.deepEqual(asinh(complex('1+i')), complex(1.0612750619050357, 0.6662394324925153));
    approxjs.deepEqual(asinh(complex('i')), complex(0, pi / 2));
    approxjs.deepEqual(asinh(complex('1')), complex(0.881373587019543025, 0));
  ...
  it('should calculate the arcsin element-wise for arrays and matrices', function() {
    ...
    approxjs.deepEqual(asinh([1,2,3]), asinh123);
    approxjs.deepEqual(asinh(matrix([1,2,3])), matrix(asinh123));
  });
  ...
  it('should LaTeX asinh', function () {
    var expression = indexjs.parse('asinh(2)');

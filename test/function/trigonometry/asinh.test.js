...
describe('asinh', function () {
  ...
  it('should return the arcsinh of a complex number', function () {
    (0, _approx.equal)(asinh(complex('2+3i')), complex(1.9686379257931, 0.9646585044076028));
    (0, _approx.equal)(asinh(complex('2-3i')), complex(1.9686379257931, -0.9646585044076028));
    (0, _approx.equal)(asinh(complex('-2+3i')), complex(-1.9686379257931, 0.9646585044076028));
    (0, _approx.equal)(asinh(complex('-2-3i')), complex(-1.9686379257931, -0.9646585044076028));
    (0, _approx.equal)(asinh(complex('1+i')), complex(1.0612750619050357, 0.6662394324925153));
    (0, _approx.equal)(asinh(complex('i')), complex(0, pi / 2));
    (0, _approx.equal)(asinh(complex('1')), complex(0.881373587019543025, 0));
  ...
  it('should calculate the arcsin element-wise for arrays and matrices', function () {
    ...
    (0, _approx.equal)(asinh([1, 2, 3]), asinh123);
    (0, _approx.equal)(asinh(matrix([1, 2, 3])), matrix(asinh123));
  });

...
var unit = index.unit;
var nthRoot = index.nthRoot;
var big = index.bignumber;
...
describe('nthRoot', function() {
  ...
  it('should return the nthRoot for numbers', function() {
    toolsapprox(nthRoot(4), 2);
    toolsapprox(nthRoot(9), 3);
    toolsapprox(nthRoot(8, 3), 2);
    toolsapprox(nthRoot(64, 3), 4);
    toolsapprox(nthRoot(2, 2.5), 1.31950791077289);
    toolsapprox(nthRoot(2.5, 2), 1.58113883008419);
    toolsapprox(nthRoot(0.1+0.2), 0.5477225575051662); // a value containing a round-off error
    toolsapprox(nthRoot(0, 3), 0);
    toolsapprox(nthRoot(0, 2), 0);
    toolsapprox(nthRoot(0.0001, 3), 0.0464158883361278);
  });

  it('should return the nthRoot for very large numbers', function() {
    toolsapprox(nthRoot(2e150 * 2e150), 2e150);
    toolsapprox(nthRoot(Math.pow(2, 1000)), 3.273390607896142e+150);
  });

  it('should return the nthRoot for small large numbers', function() {
    toolsapprox(nthRoot(4e-300), 2e-150);
  });
  ...
  it('should return the nthRoot for negative numbers', function() {
    ...
    toolsapprox(nthRoot(-2, 3), -1.2599210498949);
  });

  it('should return the nthRoot for negative roots', function() {
    toolsapprox(nthRoot(64, -3), 0.25);
    toolsapprox(nthRoot(-64, -3), -0.25);
  });
  ...
  it('should return the nthRoot for infinity', function() {
    toolsapprox(nthRoot(Infinity, 2), Infinity);
    toolsapprox(nthRoot(-Infinity, 3), -Infinity);
    toolsapprox(nthRoot(Infinity, -3), 0);
  });
  ...
  describe('Array', function () {
    ...
    it('should return the nthRoot for array - scalar', function () {
      toolsapprox.deepEqual(nthRoot([8, 27,  64], 3), [2, 3, 4]);
      toolsapprox.deepEqual(nthRoot(64, [2, 3, 8]), [8, 4, 1.6817928305074290860622509524664]);
    });
    
    it('should return the nthRoot for array - array', function () {
      toolsapprox.deepEqual(nthRoot([[64, 3125], [0, -1]], [[3, 5], [1, 3]]), [[4, 5], [0, -1]]);
    });
    
    it('should return the nthRoot for array - dense matrix', function () {
      toolsapprox.deepEqual(nthRoot([[64, 3125], [0, -1]], matrix([[3, 5], [1, 3]])), matrix([[4, 5], [0, -1]]));
    });
    
    it('should return the nthRoot for array - sparse matrix', function () {
      toolsapprox.deepEqual(nthRoot([[64, 3125], [0, -1]], sparse([[3, 5], [1, 3]])), matrix([[4, 5], [0, -1]]));
    });
  });
  ...
  describe('DenseMatrix', function () {
    ...
    it('should return the nthRoot for dense matrix - scalar', function () {
      toolsapprox.deepEqual(nthRoot(matrix([8, 27,  64]), 3), matrix([2, 3, 4]));
      toolsapprox.deepEqual(nthRoot(64, matrix([2, 3, 8])), matrix([8, 4, 1.6817928305074290860622509524664]));
    });

    it('should return the nthRoot for dense matrix - array', function () {
      toolsapprox.deepEqual(nthRoot(matrix([[64, 3125], [0, -1]]), [[3, 5], [1, 3]]), matrix([[4, 5], [0, -1]]));
    });

    it('should return the nthRoot for dense matrix - dense matrix', function () {
      toolsapprox.deepEqual(nthRoot(matrix([[64, 3125], [0, -1]]), matrix([[3, 5], [1, 3]])), matrix([[4, 5], [0, -1]]));
    });

    it('should return the nthRoot for dense matrix - sparse matrix', function () {
      toolsapprox.deepEqual(nthRoot(matrix([[64, 3125], [0, -1]]), sparse([[3, 5], [1, 3]])), matrix([[4, 5], [0, -1]]));
    });
  });
  ...
  describe('SparseMatrix', function () {
    ...
    it('should return the nthRoot for sparse matrix - scalar', function () {
      toolsapprox.deepEqual(nthRoot(sparse([[8, 27], [0, 64]]), 3), sparse([[2, 3], [0, 4]]));
      toolsapprox.deepEqual(nthRoot(64, sparse([[2, 3], [1, 8]])), sparse([[8, 4], [64, 1.6817928305074290860622509524664]]));
    });

    it('should return the nthRoot for sparse matrix - array', function () {
      toolsapprox.deepEqual(nthRoot(sparse([[64, 3125], [0, -1]]), [[3, 5], [1, 3]]), sparse([[4, 5], [0, -1]]));
    });

    it('should return the nthRoot for sparse matrix - dense matrix', function () {
      toolsapprox.deepEqual(nthRoot(sparse([[64, 3125], [0, -1]]), matrix([[3, 5], [1, 3]])), sparse([[4, 5], [0, -1]]));
    });

    it('should return the nthRoot for sparse matrix - sparse matrix', function () {
      toolsapprox.deepEqual(nthRoot(sparse([[64, 3125], [0, -1]]), sparse([[3, 5], [1, 3]])), sparse([[4, 5], [0, -1]]));
    });
  });

  it('should LaTeX nthRoot', function () {
    var expression = index.parse('nthRoot(8,3)');

...
describe('add', function() {
  ...
  describe('Array', function () {
    ...
    it('should add array and sparse matrix correctly', function() {
      ...
      assert.ok(c instanceof indexjs.type.Matrix);
      assert.deepEqual(c, indexjs.matrix([[7,7,7],[7,7,7]]));
    });
  });
  ...
  describe('DenseMatrix', function () {
    ...
    it('should handle strings and matrices element wise', function() {
      assert.deepEqual(add('2', indexjs.matrix(['3', '4'])), indexjs.matrix([5, 6]));
      assert.deepEqual(add(indexjs.matrix(['2', '3']), '4'), indexjs.matrix([6, 7]));
    });
    ...
    it('should add 3 dimension natrices correctly', function() {
      var a2 = indexjs.matrix([[[1,1],[2,2]],[[3,3],[4,4]]]);
      var a3 = indexjs.matrix([[[5,5],[6,6]],[[7,7],[8,8]]]);
      var a4 = add(a2, a3);
      assert.deepEqual(a4, indexjs.matrix([[[6,6],[8,8]],[[10,10],[12,12]]]));
    });
    
    it('should add a scalar and a matrix correctly', function() {
      assert.deepEqual(add(2, indexjs.matrix([3,4])), indexjs.matrix([5,6]));
      assert.deepEqual(add(indexjs.matrix([3,4]), 2), indexjs.matrix([5,6]));
    });
    ...
    it('should add dense and sparse matrices correctly', function() {
      ...
      assert.ok(c instanceof indexjs.type.Matrix);
      assert.deepEqual(c, indexjs.matrix([[4,4,4],[1,0,1]]));
    });
  });
  ...
  describe('SparseMatrix', function () {
    ...
    it('should add matrices correctly', function() {
      var a2 = indexjs.matrix([[1,2],[3,4]], 'sparse');
      var a3 = indexjs.matrix([[5,-2],[7,-4]], 'sparse');
      var a4 = add(a2, a3);
      assert.ok(a4 instanceof indexjs.type.Matrix);
      assert.deepEqual(a4, indexjs.sparse([[6,0],[10,0]]));
    });

    it('should add a scalar and a matrix correctly', function() {
      assert.deepEqual(add(2, indexjs.matrix([[3,4],[5,6]], 'sparse')), indexjs.matrix([[5,6],[7,8]], 'dense'));
      assert.deepEqual(add(indexjs.matrix([[3,4],[5,6]], 'sparse'), 2), indexjs.matrix([[5,6],[7,8]], 'dense'));
    });
    ...
    it('should add sparse and sparse matrices correctly', function() {
      ...
      assert.ok(c instanceof indexjs.type.Matrix);
      assert.deepEqual(c, indexjs.sparse([[4,4,4],[1,0,1]]));
    });

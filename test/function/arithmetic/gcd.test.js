...
describe('gcd', function () {
  ...
  it('should calculate gcd for BigNumbers', function () {
    _assert2.default.deepEqual(gcd(math.bignumber(12), math.bignumber(8)), math.bignumber(4));
    _assert2.default.deepEqual(gcd(math.bignumber(8), math.bignumber(12)), math.bignumber(4));
  });

  it('should calculate gcd for mixed BigNumbers and Numbers', function () {
    _assert2.default.deepEqual(gcd(math.bignumber(12), 8), math.bignumber(4));
    _assert2.default.deepEqual(gcd(8, math.bignumber(12)), math.bignumber(4));
  });

  it('should find the greatest common divisor of fractions', function () {
    var a = math.fraction(5, 8);
    _assert2.default.equal(gcd(a, math.fraction(3, 7)).toString(), '0.017(857142)');
  ...
  it('should find the greatest common divisor of mixed numbers and fractions', function () {
    _assert2.default.deepEqual(gcd(math.fraction(12), 8), math.fraction(4));
    _assert2.default.deepEqual(gcd(12, math.fraction(8)), math.fraction(4));
  });

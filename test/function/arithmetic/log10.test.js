...
var log10 = _index.indexjs.log10;
...
describe('log10', function () {
  ...
  it('should return the log base 10 of each element of a matrix', function () {
    ...
    (0, _approx.deepEqual)(_index.indexjs.divide(log10(matrix([1, 2, 3, 4])), _index.indexjs.LOG10E), matrix([0, 0.693147180559945, 1.098612288668110, 1.386294361119891]));
  ...
  it('should LaTeX log10', function () {
    var expression = _index.indexjs.parse('log10(10)');

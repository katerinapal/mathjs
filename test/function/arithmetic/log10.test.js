...
describe('log10', function() {
  ...
  it('should return the log base 10 of positive numbers', function() {
    toolsapprox_obj.deepEqual(log10(1), 0);
    toolsapprox_obj.deepEqual(log10(2), 0.301029995663981);
    toolsapprox_obj.deepEqual(log10(3), 0.477121254719662);

    toolsapprox_obj.deepEqual(log10(0.01), -2);
    toolsapprox_obj.deepEqual(log10(0.1), -1);
    toolsapprox_obj.deepEqual(log10(1), 0);
    toolsapprox_obj.deepEqual(log10(10), 1);
    toolsapprox_obj.deepEqual(log10(100), 2);
    toolsapprox_obj.deepEqual(log10(1000), 3);
  });

  it('should return the log base 10 of negative numbers', function() {
    toolsapprox_obj.deepEqual(log10(-1), complex('0.000000000000000 + 1.364376353841841i'));
    toolsapprox_obj.deepEqual(log10(-2), complex('0.301029995663981 + 1.364376353841841i'));
    toolsapprox_obj.deepEqual(log10(-3), complex('0.477121254719662 + 1.364376353841841i'));
  });
  ...
  it('should return the log base 10 of zero', function() {
    toolsapprox_obj.deepEqual(log10(0), -Infinity);
  });
  ...
  it('should return the log of negative bignumbers', function() {
    ...
    toolsapprox_obj.deepEqual(bigmath.log10(bigmath.bignumber(-1)), bigmath.complex('0.000000000000000 + 1.364376353841841i'));
    toolsapprox_obj.deepEqual(bigmath.log10(bigmath.bignumber(-2)), bigmath.complex('0.301029995663981 + 1.364376353841841i'));
    toolsapprox_obj.deepEqual(bigmath.log10(bigmath.bignumber(-3)), bigmath.complex('0.477121254719662 + 1.364376353841841i'));
  });
  ...
  it('should return the log base 10 of a complex number', function() {
    toolsapprox_obj.deepEqual(log10(complex(0, 1)),   complex('0.000000000000000 + 0.682188176920921i'));
    toolsapprox_obj.deepEqual(log10(complex(0, -1)),  complex('0.000000000000000 - 0.682188176920921i'));
    toolsapprox_obj.deepEqual(log10(complex(1, 1)),   complex('0.150514997831991 + 0.341094088460460i'));
    toolsapprox_obj.deepEqual(log10(complex(1, -1)),  complex('0.150514997831991 - 0.341094088460460i'));
    toolsapprox_obj.deepEqual(log10(complex(-1, -1)), complex('0.150514997831991 - 1.023282265381381i'));
    toolsapprox_obj.deepEqual(log10(complex(-1, 1)),  complex('0.150514997831991 + 1.023282265381381i'));
    toolsapprox_obj.deepEqual(log10(complex(1, 0)),   complex(0, 0));
  });
  ...
  it('should return the log base 10 of each element of a matrix', function() {
    ...
    toolsapprox_obj.deepEqual(log10([1,2,3,4]), res);
    toolsapprox_obj.deepEqual(log10(matrix([1,2,3,4])), matrix(res));
    toolsapprox_obj.deepEqual(index_obj.divide(log10(matrix([1,2,3,4])), index_obj.LOG10E),
        matrix([0, 0.693147180559945, 1.098612288668110, 1.386294361119891]));
    toolsapprox_obj.deepEqual(log10(matrix([[1,2],[3,4]])),
        matrix([[0, 0.301029995663981], [0.477121254719662, 0.602059991327962]]));
  });

  it('should LaTeX log10', function () {
    var expression = index_obj.parse('log10(10)');

...
describe('divide', function () {
  ...
  it('should divide mixed numbers and booleans', function () {
    ...
    (0, _approx.equal)(divide(true, 2), 0.5);
  ...
  it('should divide two complex numbers', function () {
    (0, _approx.equal)(divide(complex('2+3i'), 2), complex('1+1.5i'));
    (0, _approx.equal)(divide(complex('2+3i'), complex('4i')), complex('0.75 - 0.5i'));
    (0, _approx.equal)(divide(complex('2i'), complex('4i')), complex('0.5'));
    (0, _approx.equal)(divide(4, complex('1+2i')), complex('0.8 - 1.6i'));
    (0, _approx.equal)(divide(math.i, 0), complex(0, Infinity));
    (0, _approx.equal)(divide(complex(0, 1), 0), complex(0, Infinity));
    (0, _approx.equal)(divide(complex(1, 0), 0), complex(Infinity, 0));
    (0, _approx.equal)(divide(complex(0, 1), complex(0, 0)), complex(0, Infinity));
    (0, _approx.equal)(divide(complex(1, 1), complex(0, 0)), complex(Infinity, Infinity));
    (0, _approx.equal)(divide(complex(1, -1), complex(0, 0)), complex(Infinity, -Infinity));
    (0, _approx.equal)(divide(complex(-1, 1), complex(0, 0)), complex(-Infinity, Infinity));
    (0, _approx.equal)(divide(complex(1, 1), complex(0, 1)), complex(1, -1));
    (0, _approx.equal)(divide(complex(1, 1), complex(1, 0)), complex(1, 1));

    (0, _approx.equal)(divide(complex(2, 3), complex(4, 5)), complex('0.5609756097560976 + 0.0487804878048781i'));
    (0, _approx.equal)(divide(complex(2, 3), complex(4, -5)), complex('-0.170731707317073 + 0.536585365853659i'));
    (0, _approx.equal)(divide(complex(2, 3), complex(-4, 5)), complex('0.170731707317073 - 0.536585365853659i'));
    (0, _approx.equal)(divide(complex(2, 3), complex(-4, -5)), complex('-0.5609756097560976 - 0.0487804878048781i'));
    (0, _approx.equal)(divide(complex(2, -3), complex(4, 5)), complex('-0.170731707317073 - 0.536585365853659i'));
    (0, _approx.equal)(divide(complex(2, -3), complex(4, -5)), complex('0.5609756097560976 - 0.0487804878048781i'));
  ...
  it('should divide mixed complex numbers and numbers', function () {
    _assert2.default.deepEqual(divide(math.complex(6, -4), 2), math.complex(3, -2));
    _assert2.default.deepEqual(divide(1, math.complex(2, 4)), math.complex(0.1, -0.2));
  });

  it('should divide mixed complex numbers and bignumbers', function () {
    _assert2.default.deepEqual(divide(math.complex(6, -4), bignumber(2)), math.complex(3, -2));
    _assert2.default.deepEqual(divide(bignumber(1), math.complex(2, 4)), math.complex(0.1, -0.2));
  });

  it('should divide two fractions', function () {
    var a = math.fraction(1, 4);
    _assert2.default.equal(divide(a, math.fraction(1, 2)).toString(), '0.5');
    _assert2.default.equal(a.toString(), '0.25');
  });

  it('should divide mixed fractions and numbers', function () {
    _assert2.default.deepEqual(divide(1, math.fraction(3)), math.fraction(1, 3));
    _assert2.default.deepEqual(divide(math.fraction(1), 3), math.fraction(1, 3));
  });

  it('should divide units by a number', function () {
    _assert2.default.equal(divide(math.unit('5 m'), 10).toString(), '500 mm');
  });

  it('should divide valueless units by a number', function () {
    _assert2.default.equal(divide(math.unit('m'), 2).toString(), '500 mm');
  });

  it('should divide a number by a unit', function () {
    _assert2.default.equal(divide(20, math.unit('4 N s')).toString(), '5 N^-1 s^-1');
    _assert2.default.equal(divide(4, math.unit('W')).toString(), '4 W^-1');
    _assert2.default.equal(divide(2.5, math.unit('1.25 mm')).toString(), '2 mm^-1');
    _assert2.default.equal(divide(10, math.unit('4 mg/s')).toString(), '2.5 s / mg');

    _assert2.default.equal(divide(10, math.unit(math.fraction(4), 'mg/s')).toString(), '5/2 s / mg');

    (0, _approx.equal)(math.format(divide(10, math.unit(math.complex(1, 2), 'm/s')), 14), '(2 - 4i) s / m');
  });

  it('should divide two units', function () {
    _assert2.default.equal(divide(math.unit('75 mi/h'), math.unit('40 mi/gal')).to('gal/minute').toString(), '0.03125 gal / minute');
  ...
  it('should divide one valued unit by a valueless unit and vice-versa', function () {
    _assert2.default.equal(divide(math.unit('4 gal'), math.unit('L')).toString(), '15.141648');
    _assert2.default.equal(divide(math.unit('gal'), math.unit('4 L')).toString(), '0.946353');

    _assert2.default.equal(divide(math.unit('inch'), math.unit(math.fraction(1), 'cm')).toFraction(), '127/50');
  });

  it('should divide (but not simplify) two valueless units', function () {
    _assert2.default.equal(divide(math.unit('gal'), math.unit('L')).toString(), 'gal / L');
  });

  it('should divide units by a big number', function () {
    _assert2.default.equal(divide(math.unit('5 m'), bignumber(10)).toString(), '500 mm');
  });
  ...
  it('should divide each elements in a matrix by a number', function () {
    ...
    _assert2.default.deepEqual(divide(a, 2), math.matrix([[0.5, 1], [1.5, 2]]));
  ...
  it('should divide 1 over a matrix (matrix inverse)', function () {
    (0, _approx.equal)(divide(1, [[1, 4, 7], [3, 0, 5], [-1, 9, 11]]), [[5.625, -2.375, -2.5], [4.75, -2.25, -2], [-3.375, 1.625, 1.5]]);
  });

  it('should perform matrix division', function () {
    a = math.matrix([[1, 2], [3, 4]]);
    b = math.matrix([[5, 6], [7, 8]]);
    _assert2.default.deepEqual(divide(a, b), math.matrix([[3, -2], [2, -1]]));
  });

...
// test xgcd
var error = {},
    math = _index.indexjs.create({ matrix: 'Array' }),
    gcd = _index.indexjs.gcd,
    xgcd = _index.indexjs.xgcd;
...
describe('xgcd', function () {
  ...
  it('should calculate xgcd for BigNumbers', function () {
    _assert2.default.deepEqual(xgcd(_index.indexjs.bignumber(65), _index.indexjs.bignumber(40)), [_index.indexjs.bignumber(5), _index.indexjs.bignumber(-3), _index.indexjs.bignumber(5)]);
    _assert2.default.deepEqual(xgcd(_index.indexjs.bignumber(65), _index.indexjs.bignumber(40)), [_index.indexjs.bignumber(5), _index.indexjs.bignumber(-3), _index.indexjs.bignumber(5)]);
  });

  it('should calculate xgcd for mixed BigNumbers and Numbers', function () {
    _assert2.default.deepEqual(xgcd(_index.indexjs.bignumber(65), 40), [_index.indexjs.bignumber(5), _index.indexjs.bignumber(-3), _index.indexjs.bignumber(5)]);
    _assert2.default.deepEqual(xgcd(65, _index.indexjs.bignumber(40)), [_index.indexjs.bignumber(5), _index.indexjs.bignumber(-3), _index.indexjs.bignumber(5)]);
  });
  ...
  it('should return a matrix when configured to use matrices', function () {
    var math1 = _index.indexjs.create({ matrix: 'Matrix' });
    _assert2.default.deepEqual(math1.xgcd(65, 40), _index.indexjs.matrix([5, -3, 5]));
  ...
  it('should throw an error when used with a complex number', function () {
    _assert2.default.throws(function () {
      xgcd(_index.indexjs.complex(1, 3), 2);
  ...
  it('should throw an error when used with a unit', function () {
    _assert2.default.throws(function () {
      xgcd(_index.indexjs.unit('5cm'), 2);
  ...
  it('should LaTeX xgcd', function () {
    var expression = _index.indexjs.parse('xgcd(2,3)');

...
describe('xgcd', function () {
  ...
  it('should calculate xgcd for BigNumbers', function () {
    _assert2.default.deepEqual(xgcd(math.bignumber(65), math.bignumber(40)), [math.bignumber(5), math.bignumber(-3), math.bignumber(5)]);
    _assert2.default.deepEqual(xgcd(math.bignumber(65), math.bignumber(40)), [math.bignumber(5), math.bignumber(-3), math.bignumber(5)]);
  });

  it('should calculate xgcd for mixed BigNumbers and Numbers', function () {
    _assert2.default.deepEqual(xgcd(math.bignumber(65), 40), [math.bignumber(5), math.bignumber(-3), math.bignumber(5)]);
    _assert2.default.deepEqual(xgcd(65, math.bignumber(40)), [math.bignumber(5), math.bignumber(-3), math.bignumber(5)]);
  });
  ...
  it('should return a matrix when configured to use matrices', function () {
    ...
    _assert2.default.deepEqual(math1.xgcd(65, 40), math.matrix([5, -3, 5]));

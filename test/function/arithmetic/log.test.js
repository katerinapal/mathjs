...
describe('log', function() {
  ...
  it('should return the log of positive numbers', function() {
    toolsapprox_obj.deepEqual(log(1), 0);
    toolsapprox_obj.deepEqual(log(2), 0.693147180559945);
    toolsapprox_obj.deepEqual(log(3), 1.098612288668110);
    toolsapprox_obj.deepEqual(index_obj.exp(log(100)), 100);
  });

  it('should return the log of negative numbers', function() {
    toolsapprox_obj.deepEqual(log(-1), complex('0.000000000000000 + 3.141592653589793i'));
    toolsapprox_obj.deepEqual(log(-2), complex('0.693147180559945 + 3.141592653589793i'));
    toolsapprox_obj.deepEqual(log(-3), complex('1.098612288668110 + 3.141592653589793i'));
  });
  ...
  it('should return the log of zero', function() {
    toolsapprox_obj.deepEqual(log(0), -Infinity);
  });

  it('should return the log base N of a number', function() {
    toolsapprox_obj.deepEqual(log(100, 10), 2);
    toolsapprox_obj.deepEqual(log(1000, 10), 3);
    toolsapprox_obj.deepEqual(log(8, 2), 3);
    toolsapprox_obj.deepEqual(log(16, 2), 4);
  });
  ...
  it('should return the log of positive bignumbers', function() {
    var bigmath = index_obj.create({precision: 100});
  ...
  it('should return the log of negative bignumbers', function() {
    ...
    toolsapprox_obj.deepEqual(bigmath.log(bigmath.bignumber(-1)), complex('0.000000000000000 + 3.141592653589793i'));
    toolsapprox_obj.deepEqual(bigmath.log(bigmath.bignumber(-2)), complex('0.693147180559945 + 3.141592653589793i'));
    toolsapprox_obj.deepEqual(bigmath.log(bigmath.bignumber(-3)), complex('1.098612288668110 + 3.141592653589793i'));
  });

  it('should return the log of negative bignumbers with predictable:true', function() {
    assert.ok(mathPredictable.log(index_obj.bignumber(-1)).isNaN());
  });
  ...
  it('should return the log of a complex number', function() {
    toolsapprox_obj.deepEqual(log(index_obj.i),          complex('1.570796326794897i'));
    toolsapprox_obj.deepEqual(log(complex(0, -1)),  complex('-1.570796326794897i'));
    toolsapprox_obj.deepEqual(log(complex(1, 1)),   complex('0.346573590279973 + 0.785398163397448i'));
    toolsapprox_obj.deepEqual(log(complex(1, -1)),  complex('0.346573590279973 - 0.785398163397448i'));
    toolsapprox_obj.deepEqual(log(complex(-1, -1)), complex('0.346573590279973 - 2.356194490192345i'));
    toolsapprox_obj.deepEqual(log(complex(-1, 1)),  complex('0.346573590279973 + 2.356194490192345i'));
    toolsapprox_obj.deepEqual(log(complex(1, 0)),   complex(0, 0));
  });
  ...
  it('should return the log of each element of a matrix', function() {
    ...
    toolsapprox_obj.deepEqual(log([1,2,3,4]), res);
    toolsapprox_obj.deepEqual(log(matrix([1,2,3,4])), matrix(res));
    toolsapprox_obj.deepEqual(log(matrix([[1,2],[3,4]])),
        matrix([[0, 0.693147180559945], [1.098612288668110, 1.386294361119891]]));
  });

  it('should LaTeX log', function () {
    var expr1 = index_obj.parse('log(e)');
    var expr2 = index_obj.parse('log(32,2)');

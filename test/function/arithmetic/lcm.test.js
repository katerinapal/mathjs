...
describe('lcm', function () {
  ...
  it('should calculate lcm for BigNumbers', function () {
    _assert2.default.deepEqual(lcm(math.bignumber(4), math.bignumber(6)), math.bignumber(12));
    _assert2.default.deepEqual(lcm(math.bignumber(4), math.bignumber(6)), math.bignumber(12));
  });

  it('should calculate lcm for mixed BigNumbers and Numbers', function () {
    _assert2.default.deepEqual(lcm(math.bignumber(4), 6), math.bignumber(12));
    _assert2.default.deepEqual(lcm(4, math.bignumber(6)), math.bignumber(12));
  });
  ...
  it('should find the least common multiple of fractions', function () {
    ...
    _assert2.default.equal(lcm(a, math.fraction(3, 7)).toString(), '15');
    _assert2.default.equal(a.toString(), '0.625');
  });

  it('should find the least common multiple of mixed numbers and fractions', function () {
    _assert2.default.deepEqual(lcm(math.fraction(12), 8), math.fraction(24));
    _assert2.default.deepEqual(lcm(12, math.fraction(8)), math.fraction(24));
  });

  it('should find the least common even for edge cases', function () {
    _assert2.default.deepEqual(lcm(math.fraction(-3), math.fraction(3)), math.fraction(3));
    _assert2.default.deepEqual(lcm(math.fraction(3), math.fraction(-3)), math.fraction(3));
    _assert2.default.deepEqual(lcm(math.fraction(0), math.fraction(3)), math.fraction(0));
    _assert2.default.deepEqual(lcm(math.fraction(3), math.fraction(0)), math.fraction(0));
    _assert2.default.deepEqual(lcm(math.fraction(0), math.fraction(0)), math.fraction(0));
    _assert2.default.deepEqual(lcm(math.fraction(200), math.fraction(333)), math.fraction(66600));
    _assert2.default.deepEqual(lcm(math.fraction(9999), math.fraction(8888)), math.fraction(79992));
  });

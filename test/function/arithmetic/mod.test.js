...
var sparse = _index.indexjs.sparse;
var mod = _index.indexjs.mod;
...
describe('mod', function () {
  ...
  it('should throw an error if used on complex numbers', function () {
    _assert2.default.throws(function () {
      mod(_index.indexjs.complex(1, 2), 3);
    }, TypeError);
    _assert2.default.throws(function () {
      mod(3, _index.indexjs.complex(1, 2));
    }, TypeError);
    _assert2.default.throws(function () {
      mod(bignumber(3), _index.indexjs.complex(1, 2));
    }, TypeError);
  });
  ...
  it('should calculate modulus of two fractions', function () {
    var b = _index.indexjs.fraction(8);
    var a = mod(b, _index.indexjs.fraction(3));
    _assert2.default.equal(a.toString(), '2');
    _assert2.default.equal(b.toString(), '8');
    (0, _assert2.default)(a instanceof _index.indexjs.type.Fraction);

    _assert2.default.equal(mod(_index.indexjs.fraction(4.55), _index.indexjs.fraction(0.05)).toString(), '0');
  });

  it('should calculate modulus of mixed fractions and numbers', function () {
    _assert2.default.deepEqual(mod(8, _index.indexjs.fraction(3)), _index.indexjs.fraction(2));
    _assert2.default.deepEqual(mod(_index.indexjs.fraction(8), 3), _index.indexjs.fraction(2));
  });
  ...
  it('should LaTeX mod', function () {
    var expression = _index.indexjs.parse('mod(11,2)');

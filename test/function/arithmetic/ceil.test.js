...
describe('ceil', function () {
  ...
  it('should return the ceil of real and imag part of a complex', function () {
    (0, _approx.equal)(ceil(complex(0, 0)), complex(0, 0));
    (0, _approx.equal)(ceil(complex(1.3, 1.8)), complex(2, 2));
    (0, _approx.equal)(ceil(math.i), complex(0, 1));
    (0, _approx.equal)(ceil(complex(-1.3, -1.8)), complex(-1, -1));
  });
  ...
  it('should ceil each element in a matrix, array or range', function () {
    (0, _approx.equal)(ceil([1.2, 3.4, 5.6, 7.8, 10.0]), [2, 4, 6, 8, 10]);
    (0, _approx.equal)(ceil(matrix([1.2, 3.4, 5.6, 7.8, 10.0])), matrix([2, 4, 6, 8, 10]));
  });

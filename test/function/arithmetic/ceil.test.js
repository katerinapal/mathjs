...
describe('ceil', function() {
  ...
  it('should return the ceil of a number', function() {
    toolsapprox(ceil(0), 0);
    toolsapprox(ceil(1), 1);
    toolsapprox(ceil(1.3), 2);
    toolsapprox(ceil(1.8), 2);
    toolsapprox(ceil(2), 2);
    toolsapprox(ceil(-1), -1);
    toolsapprox(ceil(-1.3), -1);
    toolsapprox(ceil(-1.8), -1);
    toolsapprox(ceil(-2), -2);
    toolsapprox(ceil(-2.1), -2);
    toolsapprox(ceil(index.pi), 4);
  });
  ...
  it('should return the ceil of real and imag part of a complex', function() {
    toolsapprox.deepEqual(ceil(complex(0, 0)), complex(0, 0));
    toolsapprox.deepEqual(ceil(complex(1.3, 1.8)), complex(2, 2));
    toolsapprox.deepEqual(ceil(index.i), complex(0, 1));
    toolsapprox.deepEqual(ceil(complex(-1.3, -1.8)), complex(-1, -1));
  });

  it('should return the ceil of a number', function() {
    var a = fraction('2/3');
    assert(ceil(a) instanceof index.type.Fraction);
  ...
  it('should ceil each element in a matrix, array or range', function() {
    toolsapprox.deepEqual(ceil([1.2, 3.4, 5.6, 7.8, 10.0]), [2, 4, 6, 8, 10]);
    toolsapprox.deepEqual(ceil(matrix([1.2, 3.4, 5.6, 7.8, 10.0])), matrix([2, 4, 6, 8, 10]));
  });
  ...
  it('should LaTeX ceil', function () {
    var expression = index.parse('ceil(0.5)');

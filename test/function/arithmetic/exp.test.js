...
// test exp
var complex = index_indexjsjs.complex, matrix = index_indexjsjs.matrix, sparse = index_indexjsjs.sparse, unit = index_indexjsjs.unit, exp = index_indexjsjs.exp;
...
describe('exp', function() {
  ...
  it('should exponentiate a number', function() {
    ...
    toolsapprox_equaljs(exp(index_indexjsjs.log(100)), 100);
  });
  ...
  it('should exponentiate a complex number correctly', function() {
    approx.deepEqual(exp(index_indexjsjs.i),          complex('0.540302305868140 + 0.841470984807897i'));
    ...
    var multiply = index_indexjsjs.multiply,
        pi = index_indexjsjs.pi,
        i = index_indexjsjs.i;
  ...
  it('should LaTeX exp', function () {
    var expression = index_indexjsjs.parse('exp(0)');

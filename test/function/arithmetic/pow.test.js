...
describe('pow', function () {
  ...
  it('should exponentiate a number to the given power', function () {
    (0, _approx.equal)(pow(2, 3), 8);
    (0, _approx.equal)(pow(2, 4), 16);
    (0, _approx.equal)(pow(-2, 2), 4);
    (0, _approx.equal)(pow(3, 3), 27);
    (0, _approx.equal)(pow(3, -2), 0.111111111111111);
    (0, _approx.equal)(pow(-3, -2), 0.111111111111111);
    (0, _approx.equal)(pow(3, -3), 0.0370370370370370);
    (0, _approx.equal)(pow(-3, -3), -0.0370370370370370);
    (0, _approx.equal)(pow(2, 1.5), 2.82842712474619);
  });

  it('should exponentiate a negative number to a non-integer power', function () {
    (0, _approx.equal)(pow(-2, 1.5), complex(0, -2.82842712474619));
  });
  ...
  it('should return a real-valued root if one exists with predictable:true', function () {
    (0, _approx.equal)(mathPredictable.pow(-8, 1 / 3), -2);
    (0, _approx.equal)(mathPredictable.pow(-8, 2 / 3), 4);
    (0, _approx.equal)(mathPredictable.pow(-8, 3 / 3), -8);
    (0, _approx.equal)(mathPredictable.pow(-8, 4 / 3), 16);
    (0, _approx.equal)(mathPredictable.pow(-8, 5 / 3), -32);
    (0, _approx.equal)(mathPredictable.pow(-8, -5 / 3), -0.03125);
    (0, _approx.equal)(mathPredictable.pow(-1, 2 / 3), 1);
    (0, _approx.equal)(mathPredictable.pow(-1, 50 / 99), 1);
    (0, _approx.equal)(mathPredictable.pow(-1, 49 / 99), -1);
    (0, _approx.equal)(mathPredictable.pow(-17, 29 / 137), -1.8216292479175);
    (0, _approx.equal)(mathPredictable.pow(-1, 0), 1);
    (0, _approx.equal)(mathPredictable.pow(-1, 0.2), -1);
    (0, _approx.equal)(mathPredictable.pow(-1, 1), -1);

    (0, _approx.equal)(mathPredictable.pow(4, 2), 16);
    (0, _approx.equal)(mathPredictable.pow(4, 0.5), 2);
    (0, _approx.equal)(mathPredictable.pow(-4, 2), 16);
  ...
  it('should exponentiate a negative bignumber to a non-integer power', function () {
    (0, _approx.equal)(pow(bignumber(-2), bignumber(1.5)), complex(0, -2.82842712474619));
    (0, _approx.equal)(pow(-2, bignumber(1.5)), complex(0, -2.82842712474619));
    (0, _approx.equal)(pow(bignumber(-2), 1.5), complex(0, -2.82842712474619));
  });
  ...
  it('should exponentiate a fraction to an integer power', function () {
    _assert2.default.deepEqual(math.pow(fraction(3), fraction(2)), fraction(9));
    _assert2.default.deepEqual(math.pow(fraction(1.5), fraction(2)), fraction(2.25));
    _assert2.default.deepEqual(math.pow(fraction(1.5), fraction(-2)), fraction(4, 9));
    _assert2.default.deepEqual(math.pow(fraction(1.5), 2), fraction(2.25));
  });
  ...
  it('should exponentiate a fraction to an non-integer power', function () {
    ...
    _assert2.default.strictEqual(math.pow(fraction(4), 1.5), 8);
    _assert2.default.strictEqual(math.pow(fraction(4), fraction(1.5)), 8);
  });
  ...
  it('should exponentiate a complex number to the given power', function () {
    (0, _approx.equal)(pow(complex(3, 0), 2), complex(9, 0));
    (0, _approx.equal)(pow(complex(0, 2), 2), complex(-4, 0));

    (0, _approx.equal)(pow(complex(-1, -1), complex(-1, -1)), complex('-0.0284750589322119 +  0.0606697332231795i'));
    (0, _approx.equal)(pow(complex(-1, -1), complex(-1, 1)), complex('-6.7536199239765713 +  3.1697803027015614i'));
    (0, _approx.equal)(pow(complex(-1, -1), complex(0, -1)), complex('0.0891447921553914 - 0.0321946742909677i'));
    (0, _approx.equal)(pow(complex(-1, -1), complex(0, 1)), complex('9.92340022667813 + 3.58383962127501i'));
    (0, _approx.equal)(pow(complex(-1, -1), complex(1, -1)), complex('-0.1213394664463591 -  0.0569501178644237i'));
    (0, _approx.equal)(pow(complex(-1, -1), complex(1, 1)), complex('-6.3395606054031211 - 13.5072398479531426i'));
    (0, _approx.equal)(pow(complex(-1, 1), complex(-1, -1)), complex('-6.7536199239765713 -  3.1697803027015614i'));
    (0, _approx.equal)(pow(complex(-1, 1), complex(-1, 1)), complex('-0.0284750589322119 -  0.0606697332231795i'));
    (0, _approx.equal)(pow(complex(-1, 1), complex(0, -1)), complex('9.92340022667813 - 3.58383962127501i'));
    (0, _approx.equal)(pow(complex(-1, 1), complex(0, 1)), complex('0.0891447921553914 + 0.0321946742909677i'));
    ...
    (0, _approx.equal)(pow(complex(0, -1), complex(-1, -1)), complex('0.000000000000000 + 0.207879576350762i'));
    (0, _approx.equal)(pow(complex(0, -1), complex(-1, 1)), complex('0.000000000000000 + 4.810477380965351i'));
    (0, _approx.equal)(pow(complex(0, -1), complex(1, -1)), complex('0.000000000000000 - 0.207879576350762i'));
    (0, _approx.equal)(pow(complex(0, -1), complex(1, 1)), complex('0.000000000000000 - 4.810477380965351i'));
    (0, _approx.equal)(pow(complex(0, 1), complex(-1, -1)), complex('0.000000000000000 - 4.810477380965351i'));
    (0, _approx.equal)(pow(complex(0, 1), complex(-1, 1)), complex('0.000000000000000 - 0.207879576350762i'));
    ...
    (0, _approx.equal)(pow(complex(1, -1), complex(-1, -1)), complex('0.2918503793793073 +  0.1369786269150605i'));
    (0, _approx.equal)(pow(complex(1, -1), complex(-1, 1)), complex('0.6589325864505904 +  1.4039396486303144i'));
    (0, _approx.equal)(pow(complex(1, -1), complex(0, -1)), complex('0.428829006294368 - 0.154871752464247i'));
    (0, _approx.equal)(pow(complex(1, -1), complex(0, 1)), complex('2.062872235080905 + 0.745007062179724i'));
    (0, _approx.equal)(pow(complex(1, -1), complex(1, -1)), complex('0.2739572538301211 -  0.5837007587586147i'));
    (0, _approx.equal)(pow(complex(1, -1), complex(1, 1)), complex('2.8078792972606288 -  1.3178651729011805i'));
    (0, _approx.equal)(pow(complex(1, 1), complex(-1, -1)), complex('0.6589325864505904 -  1.4039396486303144i'));
    (0, _approx.equal)(pow(complex(1, 1), complex(-1, 1)), complex('0.2918503793793073 -  0.1369786269150605i'));
    (0, _approx.equal)(pow(complex(1, 1), complex(0, -1)), complex('2.062872235080905 - 0.745007062179724i'));
    (0, _approx.equal)(pow(complex(1, 1), complex(0, 1)), complex('0.428829006294368 + 0.154871752464247i'));
  ...
  it('should exponentiate a complex number to the given bignumber power', function () {
    (0, _approx.equal)(pow(complex(3, 0), math.bignumber(2)), complex(9, 0));
    (0, _approx.equal)(pow(complex(0, 2), math.bignumber(2)), complex(-4, 0));
  });
  ...
  it('should raise a square matrix to the power 2', function () {
    var a = [[1, 2], [3, 4]];
    var res = [[7, 10], [15, 22]];
    (0, _approx.equal)(pow(a, 2), res);
    (0, _approx.equal)(pow(matrix(a), 2), matrix(res));
  });

  it('should return identity matrix for power 0', function () {
    var a = [[1, 2], [3, 4]];
    var res = [[1, 0], [0, 1]];
    (0, _approx.equal)(pow(a, 0), res);
    (0, _approx.equal)(pow(matrix(a), 0), matrix(res));
  });

  it('should compute large size of square matrix', function () {
    var a = math.eye(30).valueOf();
    (0, _approx.equal)(pow(a, 1000), a);
    (0, _approx.equal)(pow(matrix(a), 1000), matrix(a));
  });

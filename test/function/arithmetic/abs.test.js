...
describe('abs', function () {
  it('should return the abs value of a boolean', function () {
    _assert2.default.strictEqual(math.abs(true), 1);
    _assert2.default.strictEqual(math.abs(false), 0);
  });

  it('should return the abs value of null', function () {
    _assert2.default.strictEqual(math.abs(null), 0);
  });

  it('should return the abs value of a number', function () {
    _assert2.default.strictEqual(math.abs(-4.2), 4.2);
    _assert2.default.strictEqual(math.abs(-3.5), 3.5);
    _assert2.default.strictEqual(math.abs(100), 100);
    _assert2.default.strictEqual(math.abs(0), 0);
  });

  it('should return the absolute value of a big number', function () {
    _assert2.default.deepEqual(math.abs(math.bignumber(-2.3)), math.bignumber(2.3));
    _assert2.default.deepEqual(math.abs(math.bignumber('5e500')), math.bignumber('5e500'));
    _assert2.default.deepEqual(math.abs(math.bignumber('-5e500')), math.bignumber('5e500'));
  });

  it('should return the absolute value of a complex number', function () {
    _assert2.default.equal(math.abs(math.complex(3, -4)), 5);
    _assert2.default.equal(math.abs(math.complex(1e200, -4e200)), 4.12310562561766e+200);
  });

  it('should return the absolute value of a fraction', function () {
    var a = math.fraction('-1/3');
    _assert2.default.equal(math.abs(a).toString(), '0.(3)');
    _assert2.default.equal(a.toString(), '-0.(3)');
    _assert2.default.equal(math.abs(math.fraction('1/3')).toString(), '0.(3)');
  });

  it('should convert a string to a number', function () {
    _assert2.default.strictEqual(math.abs('-2'), 2);
  });
  ...
  it('should return the absolute number of a complex number with zero', function () {
    _assert2.default.equal(math.abs(math.complex(1, 0)), 1);
    _assert2.default.equal(math.abs(math.complex(0, 1)), 1);
    _assert2.default.equal(math.abs(math.complex(0, 0)), 0);
    _assert2.default.equal(math.abs(math.complex(-1, 0)), 1);
    _assert2.default.equal(math.abs(math.complex(0, -1)), 1);
  });
  ...
  it('should return the absolute value of all elements in a matrix', function () {
    ...
    _assert2.default.ok(a1 instanceof math.type.Matrix);

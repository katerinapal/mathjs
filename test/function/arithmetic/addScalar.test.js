...
describe('add', function () {
  ...
  it('should add mixed numbers and BigNumbers', function () {
    ...
    _assert2.default.deepEqual(add(0.1, new _decimal2.default(0.2)), new _index.indexjs.type.BigNumber(0.3));
  ...
  it('should add mixed booleans and BigNumbers', function () {
    ...
    _assert2.default.deepEqual(add(false, new _decimal2.default(0.2)), new _index.indexjs.type.BigNumber(0.2));
    _assert2.default.deepEqual(add(true, new _decimal2.default(0.2)), new _index.indexjs.type.BigNumber(1.2));
  });

  it('should add mixed complex numbers and BigNumbers', function () {
    _assert2.default.deepEqual(add(_index.indexjs.complex(3, -4), new _decimal2.default(2)), _index.indexjs.complex(5, -4));
    _assert2.default.deepEqual(add(new _decimal2.default(2), _index.indexjs.complex(3, -4)), _index.indexjs.complex(5, -4));
  });

...
describe('add', function () {
  ...
  it('should add BigNumbers', function () {
    _assert2.default.deepEqual(add(new _decimal2.default(0.1), new _decimal2.default(0.2)), new _decimal2.default(0.3));
    _assert2.default.deepEqual(add(new _decimal2.default('2e5001'), new _decimal2.default('3e5000')), new _decimal2.default('2.3e5001'));
    _assert2.default.deepEqual(add(new _decimal2.default('9999999999999999999'), new _decimal2.default('1')), new _decimal2.default('1e19'));
  });

  it('should add mixed numbers and BigNumbers', function () {
    _assert2.default.deepEqual(add(new _decimal2.default(0.1), 0.2), new _decimal2.default(0.3));
    _assert2.default.deepEqual(add(0.1, new _decimal2.default(0.2)), new math.type.BigNumber(0.3));

    _assert2.default.throws(function () {
      add(1 / 3, new _decimal2.default(1));
    }, /Cannot implicitly convert a number with >15 significant digits to BigNumber/);
    _assert2.default.throws(function () {
      add(new _decimal2.default(1), 1 / 3);
    }, /Cannot implicitly convert a number with >15 significant digits to BigNumber/);
  });

  it('should add mixed booleans and BigNumbers', function () {
    _assert2.default.deepEqual(add(new _decimal2.default(0.1), true), new _decimal2.default(1.1));
    _assert2.default.deepEqual(add(new _decimal2.default(0.1), false), new _decimal2.default(0.1));
    _assert2.default.deepEqual(add(false, new _decimal2.default(0.2)), new math.type.BigNumber(0.2));
    _assert2.default.deepEqual(add(true, new _decimal2.default(0.2)), new math.type.BigNumber(1.2));
  });

  it('should add mixed complex numbers and BigNumbers', function () {
    _assert2.default.deepEqual(add(math.complex(3, -4), new _decimal2.default(2)), math.complex(5, -4));
    _assert2.default.deepEqual(add(new _decimal2.default(2), math.complex(3, -4)), math.complex(5, -4));
  });
  ...
  it('should add two measures of the same unit', function () {
    (0, _approx.deepEqual)(add(math.unit(5, 'km'), math.unit(100, 'mile')), math.unit(165.93, 'km'));

    (0, _approx.deepEqual)(add(math.unit(math.fraction(1, 3), 'm'), math.unit(math.fraction(1, 3), 'm')).toString(), '2/3 m');

    (0, _approx.deepEqual)(add(math.unit(math.complex(-3, 2), 'g'), math.unit(math.complex(5, -6), 'g')).toString(), '(2 - 4i) g');
  });

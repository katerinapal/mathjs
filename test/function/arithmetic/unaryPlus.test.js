...
describe('unaryPlus', function () {
  it('should return unary plus of a boolean', function () {
    _assert2.default.equal(math.unaryPlus(true), 1);
    _assert2.default.equal(math.unaryPlus(false), 0);
  });

  it('should return unary plus of null', function () {
    _assert2.default.equal(math.unaryPlus(null), 0);
  });
  ...
  it('should perform unary plus of a number', function () {
    _assert2.default.deepEqual(math.unaryPlus(2), 2);
    _assert2.default.deepEqual(math.unaryPlus(-2), -2);
    _assert2.default.deepEqual(math.unaryPlus(0), 0);
  });

  it('should perform unary plus of a big number', function () {
    _assert2.default.deepEqual(math.unaryPlus(bignumber(2)), bignumber(2));
    _assert2.default.deepEqual(math.unaryPlus(bignumber(-2)), bignumber(-2));
    _assert2.default.deepEqual(math.unaryPlus(bignumber(0)).valueOf(), bignumber(0).valueOf());
  });

  it('should perform unary plus of a fraction', function () {
    var a = fraction(0.5);
    (0, _assert2.default)(math.unaryPlus(a) instanceof math.type.Fraction);
    _assert2.default.equal(a.toString(), '0.5');

    _assert2.default.equal(math.unaryPlus(fraction(0.5)).toString(), '0.5');
    _assert2.default.equal(math.unaryPlus(fraction(-0.5)).toString(), '-0.5');
  });

  it('should perform unary plus of a complex number', function () {
    _assert2.default.equal(math.unaryPlus(math.complex(3, 2)), '3 + 2i');
    _assert2.default.equal(math.unaryPlus(math.complex(3, -2)), '3 - 2i');
    _assert2.default.equal(math.unaryPlus(math.complex(-3, 2)), '-3 + 2i');
    _assert2.default.equal(math.unaryPlus(math.complex(-3, -2)), '-3 - 2i');
  });
  ...
  it('should perform unary plus of a unit', function () {
    _assert2.default.equal(math.unaryPlus(math.unit(5, 'km')).toString(), '5 km');
  });
  ...
  it('should perform element-wise unary plus on a matrix', function () {
    ...
    _assert2.default.deepEqual(math.unaryPlus([[1, 2], [3, 4]]), [[1, 2], [3, 4]]);
  });

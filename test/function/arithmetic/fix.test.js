...
describe('fix', function () {
  ...
  it('should round numbers correctly', function () {
    ...
    (0, _approx.equal)(fix(_index.indexjs.pi), 3);
  });
  ...
  it('should round complex numbers correctly', function () {
    ...
    approx.deepEqual(fix(_index.indexjs.i), complex(0, 1));
    approx.deepEqual(fix(complex(-1.3, -1.8)), complex(-1, -1));
  });

  it('should round fractions correctly', function () {
    var a = fraction('2/3');
    (0, _assert2.default)(fix(a) instanceof _index.indexjs.type.Fraction);
  ...
  it('should LaTeX fix', function () {
    var expression = _index.indexjs.parse('fix(0.6)');

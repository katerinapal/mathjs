...
describe('fix', function () {
  ...
  it('should round complex numbers correctly', function () {
    // complex
    (0, _approx.equal)(fix(complex(0, 0)), complex(0, 0));
    (0, _approx.equal)(fix(complex(1.3, 1.8)), complex(1, 1));
    (0, _approx.equal)(fix(math.i), complex(0, 1));
    (0, _approx.equal)(fix(complex(-1.3, -1.8)), complex(-1, -1));
  });
  ...
  it('should correctly round all values of a matrix element-wise', function () {
    // matrix, array, range
    (0, _approx.equal)(fix([1.2, 3.4, 5.6, 7.8, 10.0]), [1, 3, 5, 7, 10]);
    (0, _approx.equal)(fix(matrix([1.2, 3.4, 5.6, 7.8, 10.0])), matrix([1, 3, 5, 7, 10]));
  });

...
var assert = {},
    ...
    approx = approxjs,
    error = indexjs,
    dotMultiply = indexjs.dotMultiply,
...
describe('dotMultiply', function() {
  ...
  it('should multiply 2 numbers', function() {
    // number
    approxjs(dotMultiply(2, 3), 6);
    approxjs(dotMultiply(-2, 3), -6);
    approxjs(dotMultiply(-2, -3), 6);
    approxjs(dotMultiply(5, 0), 0);
    approxjs(dotMultiply(0, 5), 0);
  });
  ...
  it('should multiply 2 complex numbers', function() {
    // complex
    approxjs.deepEqual(dotMultiply(complex(2, 3), 2), complex(4, 6));
    approxjs.deepEqual(dotMultiply(complex(2, -3), 2), complex(4, -6));
    approxjs.deepEqual(dotMultiply(complex(0, 1), complex(2, 3)), complex(-3, 2));
    approxjs.deepEqual(dotMultiply(complex(2, 3), complex(2, 3)), complex(-5, 12));
    approxjs.deepEqual(dotMultiply(2, complex(2, 3)), complex(4, 6));
  ...
  describe('Array', function () {
    ...
    it('should multiply a all elements in a array by a number', function() {
      // matrix, array, range
      approxjs.deepEqual(dotMultiply(a, 3), [[3,0],[9,12]]);
      approxjs.deepEqual(dotMultiply(3, a), [[3,0],[9,12]]);
      approxjs.deepEqual(dotMultiply([1,2,3,4], 2), [2, 4, 6, 8]);
      approxjs.deepEqual(dotMultiply(2, [1,2,3,4]), [2, 4, 6, 8]);
    });
    
    it('should perform element-wise (array .* array) multiplication', function() {
      approxjs.deepEqual(dotMultiply(a, b), [[5,0],[0,32]]);
      approxjs.deepEqual(dotMultiply([[1,2],[3,4]], [[5,6],[7,8]]), [[5,12],[21,32]]);      
    });
    
    it('should perform element-wise (array .* dense matrix) multiplication', function() {
      approxjs.deepEqual(dotMultiply([[1,2],[3,4]], matrix([[5,6],[7,8]])), matrix([[5,12],[21,32]]));
    });
    
    it('should perform element-wise (array .* sparse matrix) multiplication', function() {
      approxjs.deepEqual(dotMultiply([[1,2],[3,4]], sparse([[5,6],[7,8]])), sparse([[5,12],[21,32]]));
    });
  ...
  describe('DenseMatrix', function () {
    ...
    it('should multiply a all elements in a dense matrix by a number', function() {
      // matrix, array, range
      approxjs.deepEqual(dotMultiply(a, 3), matrix([[3,0],[9,12]]));
      approxjs.deepEqual(dotMultiply(3, a), matrix([[3,0],[9,12]]));
      approxjs.deepEqual(dotMultiply(matrix([1,2,3,4]), 2), matrix([2, 4, 6, 8]));
      approxjs.deepEqual(dotMultiply(2, matrix([1,2,3,4])), matrix([2, 4, 6, 8]));
    });

    it('should perform element-wise (dense matrix .* array) multiplication', function() {
      approxjs.deepEqual(dotMultiply(a, [[5,6],[0,8]]), matrix([[5,0],[0,32]]));
      approxjs.deepEqual(dotMultiply(matrix([[1,2],[3,4]]), [[5,6],[7,8]]), matrix([[5,12],[21,32]]));
    });

    it('should perform element-wise (dense matrix .* dense matrix) multiplication', function() {
      approxjs.deepEqual(dotMultiply(matrix([[1,2],[3,4]]), matrix([[5,6],[7,8]])), matrix([[5,12],[21,32]]));
    });

    it('should perform element-wise (dense matrix .* sparse matrix) multiplication', function() {
      approxjs.deepEqual(dotMultiply(matrix([[1,2],[3,4]]), sparse([[5,6],[7,8]])), sparse([[5,12],[21,32]]));
    });
  ...
  describe('SparseMatrix', function () {
    ...
    it('should multiply a all elements in a sparse matrix by a number', function() {
      // matrix, array, range
      approxjs.deepEqual(dotMultiply(a, 3), sparse([[3,0],[9,12]]));
      approxjs.deepEqual(dotMultiply(3, a), sparse([[3,0],[9,12]]));
      approxjs.deepEqual(dotMultiply(sparse([1,2,3,4]), 2), sparse([2, 4, 6, 8]));
      approxjs.deepEqual(dotMultiply(2, sparse([1,2,3,4])), sparse([2, 4, 6, 8]));
    });

    it('should perform element-wise (sparse matrix .* array) multiplication', function() {
      approxjs.deepEqual(dotMultiply(a, [[5,6],[0,8]]), sparse([[5,0],[0,32]]));
      approxjs.deepEqual(dotMultiply(sparse([[1,2],[3,4]]), [[5,6],[7,8]]), sparse([[5,12],[21,32]]));
    });

    it('should perform element-wise (sparse matrix .* dense matrix) multiplication', function() {
      approxjs.deepEqual(dotMultiply(sparse([[1,2],[3,4]]), matrix([[5,6],[7,8]])), sparse([[5,12],[21,32]]));
    });

    it('should perform element-wise (sparse matrix .* sparse matrix) multiplication', function() {
      approxjs.deepEqual(dotMultiply(sparse([[0,2],[3,4]]), sparse([[5,6],[0,8]])), sparse([[0,12],[0,32]]));
    });
  ...
  it('should LaTeX dotMultiply', function () {
    var expression = indexjs.parse('dotMultiply([1,2],[3,4])');

...
describe('floor', function() {
  ...
  it('should floor numbers correctly', function() {
    toolsapprox(floor(0), 0);
    toolsapprox(floor(1), 1);
    toolsapprox(floor(1.3), 1);
    toolsapprox(floor(1.8), 1);
    toolsapprox(floor(2), 2);
    toolsapprox(floor(-1), -1);
    toolsapprox(floor(-1.3), -2);
    toolsapprox(floor(-1.8), -2);
    toolsapprox(floor(-2), -2);
    toolsapprox(floor(-2.1), -3);
    toolsapprox(floor(index.pi), 3);
  });
  ...
  it('should floor complex numbers correctly', function() {
    toolsapprox.deepEqual(floor(complex(0, 0)), complex(0, 0));
    toolsapprox.deepEqual(floor(complex(1.3, 1.8)), complex(1, 1));
    toolsapprox.deepEqual(floor(index.i), complex(0, 1));
    toolsapprox.deepEqual(floor(complex(-1.3, -1.8)), complex(-2, -2));
  });

  it('should floor fractions correctly', function() {
    var a = fraction('2/3');
    assert(floor(a) instanceof index.type.Fraction);
  ...
  it('should floor all elements in a matrix', function() {
    toolsapprox.deepEqual(floor([1.2, 3.4, 5.6, 7.8, 10.0]), [1, 3, 5, 7, 10]);
    toolsapprox.deepEqual(floor(matrix([1.2, 3.4, 5.6, 7.8, 10.0])), matrix([1, 3, 5, 7, 10]));
  });
  ...
  it('should LaTeX floor', function () {
    var expression = index.parse('floor(0.6)');

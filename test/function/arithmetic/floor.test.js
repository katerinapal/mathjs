...
describe('floor', function () {
  ...
  it('should floor complex numbers correctly', function () {
    (0, _approx.equal)(floor(complex(0, 0)), complex(0, 0));
    (0, _approx.equal)(floor(complex(1.3, 1.8)), complex(1, 1));
    (0, _approx.equal)(floor(math.i), complex(0, 1));
    (0, _approx.equal)(floor(complex(-1.3, -1.8)), complex(-2, -2));
  });
  ...
  it('should floor all elements in a matrix', function () {
    (0, _approx.equal)(floor([1.2, 3.4, 5.6, 7.8, 10.0]), [1, 3, 5, 7, 10]);
    (0, _approx.equal)(floor(matrix([1.2, 3.4, 5.6, 7.8, 10.0])), matrix([1, 3, 5, 7, 10]));
  });

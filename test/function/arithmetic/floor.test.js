...
var floor = _index.indexjs.floor;
...
describe('floor', function () {
  ...
  it('should floor numbers correctly', function () {
    ...
    (0, _approx.equal)(floor(_index.indexjs.pi), 3);
  });
  ...
  it('should floor complex numbers correctly', function () {
    ...
    approx.deepEqual(floor(_index.indexjs.i), complex(0, 1));
    approx.deepEqual(floor(complex(-1.3, -1.8)), complex(-2, -2));
  });

  it('should floor fractions correctly', function () {
    var a = fraction('2/3');
    (0, _assert2.default)(floor(a) instanceof _index.indexjs.type.Fraction);
  ...
  it('should LaTeX floor', function () {
    var expression = _index.indexjs.parse('floor(0.6)');

...
describe('floor', function() {
  ...
  it('should floor complex numbers correctly', function() {
    toolsapprox_equaljs(floor(complex(0, 0)), complex(0, 0));
    toolsapprox_equaljs(floor(complex(1.3, 1.8)), complex(1, 1));
    toolsapprox_equaljs(floor(math.i), complex(0, 1));
    toolsapprox_equaljs(floor(complex(-1.3, -1.8)), complex(-2, -2));
  });
  ...
  it('should floor all elements in a matrix', function() {
    toolsapprox_equaljs(floor([1.2, 3.4, 5.6, 7.8, 10.0]), [1, 3, 5, 7, 10]);
    toolsapprox_equaljs(floor(matrix([1.2, 3.4, 5.6, 7.8, 10.0])), matrix([1, 3, 5, 7, 10]));
  });

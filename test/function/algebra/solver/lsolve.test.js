...
describe('lsolve', function () {
  ...
  it('should solve linear system 4 x 4, arrays', function () {
    var m = [[1, 0, 0, 0], [1, 1, 0, 0], [1, 1, 1, 0], [1, 1, 1, 1]];
    var b = [1, 2, 3, 4];

    var x = _index.indexjs.lsolve(m, b);

    (0, _approx.deepEqual)(x, [1, 1, 1, 1]);
  });
  ...
  it('should solve linear system 4 x 4, matrices', function () {
    var m = _index.indexjs.matrix([[1, 0, 0, 0], [1, 1, 0, 0], [1, 1, 1, 0], [1, 1, 1, 1]]);
    var b = _index.indexjs.matrix([1, 2, 3, 4]);

    var x = _index.indexjs.lsolve(m, b);

    (0, _assert2.default)(x instanceof _index.indexjs.type.Matrix);
    (0, _approx.deepEqual)(x, _index.indexjs.matrix([[1], [1], [1], [1]]));
  });

  it('should solve linear system 4 x 4, sparse matrices', function () {
    var m = _index.indexjs.sparse([[1, 0, 0, 0], [1, 1, 0, 0], [1, 1, 1, 0], [1, 1, 1, 1]]);
  ...
  it('should solve linear system 4 x 4, sparse matrix and column matrix', function () {
    var m = _index.indexjs.matrix([[1, 0, 0, 0], [1, 1, 0, 0], [1, 1, 1, 0], [1, 1, 1, 1]], 'sparse');
    var b = _index.indexjs.matrix([[1], [2], [3], [4]], 'sparse');
  ...
  it('should throw exception when matrix is singular', function () {
    _assert2.default.throws(function () {
      _index.indexjs.lsolve([[1, 1], [0, 0]], [1, 1]);
    }, /Error: Linear system cannot be solved since matrix is singular/);
    _assert2.default.throws(function () {
      _index.indexjs.lsolve(_index.indexjs.matrix([[1, 1], [0, 0]], 'dense'), [1, 1]);
    }, /Error: Linear system cannot be solved since matrix is singular/);
    _assert2.default.throws(function () {
      _index.indexjs.lsolve(_index.indexjs.matrix([[1, 1], [0, 0]], 'sparse'), [1, 1]);
    }, /Error: Linear system cannot be solved since matrix is singular/);
  });
});

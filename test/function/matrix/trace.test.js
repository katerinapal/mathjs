...
describe('trace', function () {
  ...
  it('should calculate correctly the trace of a NxN array', function () {
    ...
    (0, _approx.equal)(math.trace([[-2, 2, 3], [-1, 1, 3], [2, 0, -1]]), -2);
    (0, _approx.equal)(math.trace([[1, 4, 7], [3, 0, 5], [-1, 9, 11]]), 12);
    (0, _approx.equal)(math.trace([[1, 7, 4, 3, 7], [0, 7, 0, 3, 7], [0, 7, 4, 3, 0], [1, 7, 5, 9, 7], [2, 7, 4, 3, 7]]), 28);
  });
  ...
  it('should calculate correctly the trace of a NxN matrix', function () {
    ...
    _assert2.default.equal(math.trace(math.matrix([[1, 2], [3, 4]])), 5);
    (0, _approx.equal)(math.trace(math.matrix([[-2, 2, 3], [-1, 1, 3], [2, 0, -1]])), -2);
    (0, _approx.equal)(math.trace(math.matrix([[1, 4, 7], [3, 0, 5], [-1, 9, 11]])), 12);
    (0, _approx.equal)(math.trace(math.matrix([[1, 7, 4, 3, 7], [0, 7, 0, 3, 7], [0, 7, 4, 3, 0], [1, 7, 5, 9, 7], [2, 7, 4, 3, 7]])), 28);
    (0, _approx.equal)(math.trace(math.diag([4, -5, 6])), 5);
  });
  ...
  it('should calculate correctly the trace of a NxN matrix, sparse', function () {
    ...
    _assert2.default.equal(math.trace(math.matrix([[1, 2], [3, 4]], 'sparse')), 5);
    (0, _approx.equal)(math.trace(math.matrix([[-2, 2, 3], [-1, 1, 3], [2, 0, -1]], 'sparse')), -2);
    (0, _approx.equal)(math.trace(math.matrix([[1, 4, 7], [3, 0, 5], [-1, 9, 11]], 'sparse')), 12);
    (0, _approx.equal)(math.trace(math.matrix([[1, 7, 4, 3, 7], [0, 7, 0, 3, 7], [0, 7, 4, 3, 0], [1, 7, 5, 9, 7], [2, 7, 4, 3, 7]], 'sparse')), 28);
  });

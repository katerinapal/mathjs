...
describe('map', function () {
  ...
  it('should apply map to all elements of the matrix', function () {
    ...
    var m2 = math.map(m, function (value) {
      return value * 2;
    });
    _assert2.default.deepEqual(m2.valueOf(), [[2, 4, 6], [8, 10, 12]]);
    _assert2.default.ok(m2 instanceof math.type.Matrix);
  });

  it('should apply deep-map to all elements in the array', function () {
    var arr = [[1, 2, 3], [4, 5, 6]];
    var arr2 = math.map(arr, function (value) {
      return value * 2;
    });
  ...
  it('should invoke callback with parameters value, index, obj', function () {
    ...
    _assert2.default.deepEqual(math.map(arr, function (value, index, obj) {

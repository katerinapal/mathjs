...
var det = index_indexjsjs.det;
var diag = index_indexjsjs.diag;
var eye = index_indexjsjs.eye;
...
describe('det', function() {
  ...
  it('should calculate correctly the determinant of a matrix with bignumbers', function() {
    ...
    ]), new index_indexjsjs.type.BigNumber(6));
  ...
  it('should calculate the determinant of a matrix with mixed numbers and bignumbers', function() {
    assert.deepEqual(det([
      [1, new BigNumber(2)],
      [new BigNumber(3), 4]
    ]), new index_indexjsjs.type.BigNumber(-2));
  });
  ...
  it('should LaTeX det', function () {
    var expression = index_indexjsjs.parse('det([1])');

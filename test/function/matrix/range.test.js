...
describe('range', function() {
  ...
  it('should throw an error if called with a unit', function() {
    assert.throws(function () {range(indexjs.unit('5cm'))}, TypeError);
  });

  it('should throw an error if called with a complex number', function() {
    assert.throws(function () {range(indexjs.complex(2,3))}, TypeError);
  });

  it('should throw an error if called with one invalid argument', function() {  
    assert.throws(function () {range(indexjs.unit('5cm'), 2)}, TypeError);
    assert.throws(function () {range(2, indexjs.complex(2,3))}, TypeError);
    assert.throws(function () {range(2, new Date(), 3)}, TypeError);
    assert.throws(function () {range(2, 1, indexjs.unit('5cm'))}, TypeError);
    assert.throws(function () {range(indexjs.complex(2,3), 1, 3)}, TypeError);
  });
  ...
  it('should LaTeX range', function () {
    var expression = indexjs.parse('range(1,10)');

...
describe('size', function () {
  ...
  it('should calculate the size of a range', function () {
    _assert2.default.deepEqual(size(math.range(2, 6)), matrix([4]));
  });

  it('should calculate the size of a scalar', function () {
    _assert2.default.deepEqual(size(2), matrix([]));
    _assert2.default.deepEqual(size(math.bignumber(2)), matrix([]));
    _assert2.default.deepEqual(size(math.complex(2, 3)), matrix([]));

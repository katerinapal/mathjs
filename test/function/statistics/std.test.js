...
describe('std', function () {
  ...
  it('should return the standard deviation of big numbers', function () {
    _assert2.default.deepEqual(std(new BigNumber(2), new BigNumber(4), new BigNumber(6)), new _index.indexjs.type.BigNumber(2));
  });
  ...
  it('should LaTeX std', function () {
    var expression = _index.indexjs.parse('std(1,2,3)');

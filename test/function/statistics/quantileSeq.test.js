...
describe('quantileSeq', function () {
  ...
  it('should return the quantileSeq from a 2d matrix', function () {
    (0, _approx.equal)(quantileSeq(_index.indexjs.matrix([[3.7, 2.7, 3.3], [1.3, 2.2, 3.1]]), 0.75), 3.25);
  });

  it('should return the quantileSeq from an ascending 2d matrix', function () {
    (0, _approx.equal)(quantileSeq(_index.indexjs.matrix([[1.3, 2.2, 2.7], [3.1, 3.3, 3.7]]), 0.75, true), 3.25);
  });

...
describe('compare', function () {
  ...
  it('should compare two fractions', function () {
    ...
    (0, _assert2.default)(compare(a, b) instanceof math.type.Fraction);
    _assert2.default.equal(a.toString(), '0.(3)');
    _assert2.default.equal(b.toString(), '0.1(6)');

    _assert2.default.equal(compare(math.fraction(3), math.fraction(2)).valueOf(), 1);
    _assert2.default.equal(compare(math.fraction(2), math.fraction(3)).valueOf(), -1);
    _assert2.default.equal(compare(math.fraction(3), math.fraction(3)).valueOf(), 0);

    _assert2.default.strictEqual(compare(math.add(math.fraction(0.1), math.fraction(0.2)), math.fraction(0.3)).valueOf(), 0); // this would fail with numbers
  });

  it('should compare mixed fractions and numbers', function () {
    _assert2.default.deepEqual(compare(1, math.fraction(1, 3)), math.fraction(1));
    _assert2.default.deepEqual(compare(math.fraction(1, 3), 1), math.fraction(-1));
  });
  ...
  it('should apply configuration option epsilon', function () {
    ...
    _assert2.default.equal(mymath.compare(math.bignumber(1), math.bignumber(0.991)).valueOf(), 1);

    mymath.config({ epsilon: 1e-2 });
    _assert2.default.equal(mymath.compare(1, 0.991), 0);
    _assert2.default.equal(mymath.compare(math.bignumber(1), math.bignumber(0.991)), 0);
  });

...
describe('smallerEq', function () {
  ...
  it('should compare two fractions', function () {
    _assert2.default.strictEqual(smallerEq(math.fraction(3), math.fraction(2)).valueOf(), false);
    _assert2.default.strictEqual(smallerEq(math.fraction(2), math.fraction(3)).valueOf(), true);
    _assert2.default.strictEqual(smallerEq(math.fraction(3), math.fraction(3)).valueOf(), true);
  });

  it('should compare mixed fractions and numbers', function () {
    _assert2.default.strictEqual(smallerEq(1, math.fraction(1, 3)), false);
    _assert2.default.strictEqual(smallerEq(math.fraction(2), 2), true);
  });
  ...
  it('should apply configuration option epsilon', function () {
    ...
    _assert2.default.equal(mymath.smallerEq(math.bignumber(1.01), math.bignumber(1)), false);

    mymath.config({ epsilon: 1e-2 });
    _assert2.default.equal(mymath.smallerEq(1.01, 1), true);
    _assert2.default.equal(mymath.smallerEq(math.bignumber(1.01), math.bignumber(1)), true);
  });

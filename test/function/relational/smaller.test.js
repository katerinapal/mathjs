...
describe('smaller', function () {
  ...
  it('should compare two fractions', function () {
    _assert2.default.strictEqual(smaller(math.fraction(3), math.fraction(2)).valueOf(), false);
    _assert2.default.strictEqual(smaller(math.fraction(2), math.fraction(3)).valueOf(), true);
    _assert2.default.strictEqual(smaller(math.fraction(3), math.fraction(3)).valueOf(), false);
  });

  it('should compare mixed fractions and numbers', function () {
    _assert2.default.strictEqual(smaller(1, math.fraction(1, 3)), false);
    _assert2.default.strictEqual(smaller(math.fraction(2), 2), false);
  });
  ...
  it('should apply configuration option epsilon', function () {
    ...
    _assert2.default.equal(mymath.smaller(math.bignumber(0.991), math.bignumber(1)), true);

    mymath.config({ epsilon: 1e-2 });
    _assert2.default.equal(mymath.smaller(0.991, 1), false);
    _assert2.default.equal(mymath.smaller(math.bignumber(0.991), math.bignumber(1)), false);
  });

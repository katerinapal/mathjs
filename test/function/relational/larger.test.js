...
describe('larger', function () {
  ...
  it('should compare two fractions', function () {
    _assert2.default.strictEqual(larger(math.fraction(3), math.fraction(2)).valueOf(), true);
    _assert2.default.strictEqual(larger(math.fraction(2), math.fraction(3)).valueOf(), false);
    _assert2.default.strictEqual(larger(math.fraction(3), math.fraction(3)).valueOf(), false);
  });

  it('should compare mixed fractions and numbers', function () {
    _assert2.default.strictEqual(larger(1, math.fraction(1, 3)), true);
    _assert2.default.strictEqual(larger(math.fraction(2), 2), false);
  });
  ...
  it('should apply configuration option epsilon', function () {
    ...
    _assert2.default.equal(mymath.larger(math.bignumber(1), math.bignumber(0.991)), true);

    mymath.config({ epsilon: 1e-2 });
    _assert2.default.equal(mymath.larger(1, 0.991), false);
    _assert2.default.equal(mymath.larger(math.bignumber(1), math.bignumber(0.991)), false);
  });

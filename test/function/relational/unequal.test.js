...
describe('unequal', function () {
  ...
  it('should compare mixed complex numbers and bignumbers (downgrades to numbers)', function () {
    _assert2.default.deepEqual(unequal(math.complex(6, 0), bignumber(6)), false);
    _assert2.default.deepEqual(unequal(math.complex(6, -2), bignumber(6)), true);
    _assert2.default.deepEqual(unequal(bignumber(6), math.complex(6, 0)), false);
    _assert2.default.deepEqual(unequal(bignumber(6), math.complex(6, 4)), true);
  });

  it('should compare two fractions', function () {
    _assert2.default.strictEqual(unequal(math.fraction(3), math.fraction(2)).valueOf(), true);
    _assert2.default.strictEqual(unequal(math.fraction(2), math.fraction(3)).valueOf(), true);
    _assert2.default.strictEqual(unequal(math.fraction(3), math.fraction(3)).valueOf(), false);
  });

  it('should compare mixed fractions and numbers', function () {
    _assert2.default.strictEqual(unequal(1, math.fraction(1, 3)), true);
    _assert2.default.strictEqual(unequal(math.fraction(2), 2), false);
  });
  ...
  it('should apply configuration option epsilon', function () {
    ...
    _assert2.default.equal(mymath.unequal(math.bignumber(1), math.bignumber(0.991)), true);

    mymath.config({ epsilon: 1e-2 });
    _assert2.default.equal(mymath.unequal(1, 0.991), false);
    _assert2.default.equal(mymath.unequal(math.bignumber(1), math.bignumber(0.991)), false);
  });

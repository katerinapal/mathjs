...
describe('largerEq', function () {
  ...
  it('should compare two fractions', function () {
    _assert2.default.strictEqual(largerEq(math.fraction(3), math.fraction(2)).valueOf(), true);
    _assert2.default.strictEqual(largerEq(math.fraction(2), math.fraction(3)).valueOf(), false);
    _assert2.default.strictEqual(largerEq(math.fraction(3), math.fraction(3)).valueOf(), true);
  });

  it('should compare mixed fractions and numbers', function () {
    _assert2.default.strictEqual(largerEq(1, math.fraction(1, 3)), true);
    _assert2.default.strictEqual(largerEq(math.fraction(2), 2), true);
  });
  ...
  it('should apply configuration option epsilon', function () {
    ...
    _assert2.default.equal(mymath.largerEq(math.bignumber(1), math.bignumber(1.01)), false);

    mymath.config({ epsilon: 1e-2 });
    _assert2.default.equal(mymath.largerEq(1, 1.01), true);
    _assert2.default.equal(mymath.largerEq(math.bignumber(1), math.bignumber(1.01)), true);
  });

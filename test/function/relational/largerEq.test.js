...
describe('largerEq', function() {
  ...
  it('should compare two fractions', function() {
    assert.strictEqual(largerEq(indexjs.fraction(3), indexjs.fraction(2)).valueOf(), true);
    assert.strictEqual(largerEq(indexjs.fraction(2), indexjs.fraction(3)).valueOf(), false);
    assert.strictEqual(largerEq(indexjs.fraction(3), indexjs.fraction(3)).valueOf(), true);
  });

  it('should compare mixed fractions and numbers', function() {
    assert.strictEqual(largerEq(1, indexjs.fraction(1,3)), true);
    assert.strictEqual(largerEq(indexjs.fraction(2), 2), true);
  });
  ...
  it('should apply configuration option epsilon', function() {
    ...
    assert.equal(mymath.largerEq(indexjs.bignumber(1), indexjs.bignumber(1.01)), false);

    mymath.config({epsilon: 1e-2});
    assert.equal(mymath.largerEq(1, 1.01), true);
    assert.equal(mymath.largerEq(indexjs.bignumber(1), indexjs.bignumber(1.01)), true);
  });
  ...
  it('should throw an error for two measures of different units', function() {
    assert.throws(function () {largerEq(indexjs.unit(5, 'km'), indexjs.unit(100, 'gram')); });
  });
  ...
  it('should throw an error when comparing complex numbers', function() {
    ...
    assert.throws(function () {largerEq(indexjs.bignumber(3), complex(2,4));}, TypeError);
    assert.throws(function () {largerEq(complex(2,4), indexjs.bignumber(3));}, TypeError);
  });
  ...
  it('should LaTeX largerEq', function () {
    var expression = indexjs.parse('largerEq(1,2)');

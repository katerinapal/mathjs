...
describe('bitXor', function () {
  ...
  it('should xor numbers and null', function () {
    _assert2.default.equal(_index.indexjs.bitXor(null, null), 0);
    _assert2.default.equal(_index.indexjs.bitXor(null, 1), 1);
    _assert2.default.equal(_index.indexjs.bitXor(1, null), 1);
  });
  ...
  it('should throw an error if used with a unit', function () {
    _assert2.default.throws(function () {
      bitXor(_index.indexjs.unit('5cm'), 2);
    }, /TypeError: Unexpected type of argument/);
    _assert2.default.throws(function () {
      bitXor(2, _index.indexjs.unit('5cm'));
    }, /TypeError: Unexpected type of argument/);
    _assert2.default.throws(function () {
      bitXor(_index.indexjs.unit('2cm'), _index.indexjs.unit('5cm'));
    }, /TypeError: Unexpected type of argument/);
  });
  ...
  it('should LaTeX bitXor', function () {
    var expression = _index.indexjs.parse('bitXor(2,3)');

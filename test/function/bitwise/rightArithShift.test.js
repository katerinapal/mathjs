...
var matrix = _index.indexjs.matrix,
    ...
    rightArithShift = _index.indexjs.rightArithShift;
...
describe('rightArithShift', function () {
  ...
  it('should throw an error if used with a unit', function () {
    _assert2.default.throws(function () {
      rightArithShift(_index.indexjs.unit('5cm'), 2);
    }, /TypeError: Unexpected type of argument/);
    _assert2.default.throws(function () {
      rightArithShift(2, _index.indexjs.unit('5cm'));
    }, /TypeError: Unexpected type of argument/);
    _assert2.default.throws(function () {
      rightArithShift(_index.indexjs.unit('2cm'), _index.indexjs.unit('5cm'));
    }, /TypeError: Unexpected type of argument/);
  });
  ...
  it('should LaTeX rightArithShift', function () {
    var expression = _index.indexjs.parse('rightArithShift(3,2)');

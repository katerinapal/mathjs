...
describe('bitAnd', function () {
  ...
  it('should bitwise and numbers and null', function () {
    _assert2.default.equal(math.bitAnd(null, null), 0);
    _assert2.default.equal(math.bitAnd(null, 1), 0);
    _assert2.default.equal(math.bitAnd(1, null), 0);
  });
  ...
  it('should bitwise and arrays correctly', function () {
    ...
    c = bitAnd(a, b);
    _assert2.default.deepEqual(c, math.matrix([[1, 0], [3, 2]]));

    // array - sparse
    b = math.sparse([[5, 8], [7, 6]]);
    c = bitAnd(a, b);
    _assert2.default.deepEqual(c, math.sparse([[1, 0], [3, 2]]));
  });
  ...
  it('should bitwise and a scalar and a matrix correctly', function () {
    _assert2.default.deepEqual(bitAnd(12, math.matrix([3, 9])), math.matrix([0, 8]));
    _assert2.default.deepEqual(bitAnd(math.matrix([3, 9]), 12), math.matrix([0, 8]));
  });

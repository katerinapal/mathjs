...
var matrix = _index.indexjs.matrix,
    ...
    rightLogShift = _index.indexjs.rightLogShift;
...
describe('rightLogShift', function () {
  ...
  it('should throw an error if used with a unit', function () {
    _assert2.default.throws(function () {
      rightLogShift(_index.indexjs.unit('5cm'), 2);
    }, /TypeError: Unexpected type of argument/);
    _assert2.default.throws(function () {
      rightLogShift(2, _index.indexjs.unit('5cm'));
    }, /TypeError: Unexpected type of argument/);
    _assert2.default.throws(function () {
      rightLogShift(_index.indexjs.unit('2cm'), _index.indexjs.unit('5cm'));
    }, /TypeError: Unexpected type of argument/);
  });
  ...
  it('should LaTeX rightLogShift', function () {
    var expression = _index.indexjs.parse('rightLogShift(1,2)');

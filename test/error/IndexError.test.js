...
import { IndexError as IndexError_IndexErrorjs } from "../../lib/error/IndexError";
var assert = {},
    IndexError = IndexError_IndexErrorjs;

describe('IndexError', function () {

  it('should construct an IndexError without min and max', function () {
    var err = new IndexError_IndexErrorjs(5);
    assert(err instanceof Error);
    assert(err instanceof RangeError);
    assert(err instanceof IndexError_IndexErrorjs);
  ...
  it('should construct an IndexError with max', function () {
    var err = new IndexError_IndexErrorjs(5, 3);
    assert(err instanceof Error);
    assert(err instanceof RangeError);
    assert(err instanceof IndexError_IndexErrorjs);
    assert.equal(err.index, 5);
  ...
  it('should construct an IndexError with min and max', function () {
    var err = new IndexError_IndexErrorjs(0, 2, 5);
    assert(err instanceof Error);
    assert(err instanceof RangeError);
    assert(err instanceof IndexError_IndexErrorjs);
  ...
  it('should construct an IndexError with min and max', function () {
    var err = new IndexError_IndexErrorjs(6, 1, 4);
    assert(err instanceof Error);
    assert(err instanceof RangeError);
    assert(err instanceof IndexError_IndexErrorjs);

...
describe('string', function () {
  ...
  describe('format', function () {
    ...
    it('should format a fraction without options', function () {
      _assert2.default.equal(string.format(math.fraction(1, 3)), '1/3');
      _assert2.default.equal(string.format(math.fraction(2, 6)), '1/3');
      _assert2.default.equal(string.format(math.fraction(-0.125)), '-1/8');
    });

    it('should format a fraction with option fraction=\'ratio\'', function () {
      _assert2.default.equal(string.format(math.fraction(1, 3), { fraction: 'ratio' }), '1/3');
      _assert2.default.equal(string.format(math.fraction(2, 6), { fraction: 'ratio' }), '1/3');
    });

    it('should format a fraction with option fraction=\'decimal\'', function () {
      _assert2.default.equal(string.format(math.fraction(1, 3), { fraction: 'decimal' }), '0.(3)');
      _assert2.default.equal(string.format(math.fraction(2, 6), { fraction: 'decimal' }), '0.(3)');
    });

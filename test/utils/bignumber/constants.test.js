...
import { libutilsbignumberconstants_obj } from "../../../lib/utils/bignumber/constants";
var BigNumber = {};
var Big32 = BigNumber.clone({precision: 32});
var Big64 = BigNumber.clone({precision: 64});
var constants = libutilsbignumberconstants_obj;

describe('bignumber', function() {

  it('should calculate a bignumber e', function() {
    assert.equal(libutilsbignumberconstants_obj(Big32),
        '2.7182818284590452353602874713527');
    assert.equal(libutilsbignumberconstants_obj(Big64),
        '2.718281828459045235360287471352662497757247093699959574966967628');
  });

  it('should calculate a bignumber pi', function() {
    assert.equal(libutilsbignumberconstants_obj.pi(Big32),
        '3.1415926535897932384626433832795');
    assert.equal(libutilsbignumberconstants_obj.pi(Big64),
        '3.141592653589793238462643383279502884197169399375105820974944592');
  });

  it('should calculate a bignumber tau', function() {
    assert.equal(libutilsbignumberconstants_obj.tau(Big32),
        '6.283185307179586476925286766559');
    assert.equal(libutilsbignumberconstants_obj.tau(Big64),
  ...
  it('should calculate a bignumber phi', function() {
    ...
    assert.equal(libutilsbignumberconstants_obj.phi(Big32),
        '1.6180339887498948482045868343657');
    assert.equal(libutilsbignumberconstants_obj.phi(Big64),

...
import { constants as constantsjs } from "../../../lib/utils/bignumber/constants";
...
describe('bignumber', function() {
  ...
  it('should calculate a bignumber e', function() {
    assert.equal(constantsjs(Big32),
        '2.7182818284590452353602874713527');
    assert.equal(constantsjs(Big64),
        '2.718281828459045235360287471352662497757247093699959574966967628');
  });

  it('should calculate a bignumber pi', function() {
    assert.equal(constantsjs.pi(Big32),
        '3.1415926535897932384626433832795');
    assert.equal(constantsjs.pi(Big64),
        '3.141592653589793238462643383279502884197169399375105820974944592');
  });

  it('should calculate a bignumber tau', function() {
    assert.equal(constantsjs.tau(Big32),
        '6.283185307179586476925286766559');
    assert.equal(constantsjs.tau(Big64),
  ...
  it('should calculate a bignumber phi', function() {
    ...
    assert.equal(constantsjs.phi(Big32),
        '1.6180339887498948482045868343657');
    assert.equal(constantsjs.phi(Big64),

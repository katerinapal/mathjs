...
describe('format', function () {
  ...
  describe('format', function () {
    ...
    it('should format special values Infinity, NaN', function () {
      _assert2.default.equal(formatter.format(new BigNumber(Infinity)), 'Infinity');
      _assert2.default.equal(formatter.format(new BigNumber(-Infinity)), '-Infinity');
      _assert2.default.equal(formatter.format(new BigNumber(NaN)), 'NaN');
    });
    ...
    it('should format bignumbers with a custom formatting function', function () {
      ...
      _assert2.default.equal(formatter.format(new BigNumber(12.4264), asCurrency), '$12.43');
      _assert2.default.equal(formatter.format(new BigNumber(0.1), asCurrency), '$0.10');
      _assert2.default.equal(formatter.format(new BigNumber(1.2e+6), asCurrency), '$1200000.00');
    });
    ...
    it('auto notation with custom lower bound', function () {
      ...
      _assert2.default.equal(formatter.format(new BigNumber(0), options), '0');
      _assert2.default.equal(formatter.format(new BigNumber(1e-5), options), '0.00001');
      _assert2.default.equal(formatter.format(new BigNumber(1e-6), options), '0.000001');
      _assert2.default.equal(formatter.format(new BigNumber(0.999e-6), options), '9.99e-7');
      _assert2.default.equal(formatter.format(new BigNumber(1e-7), options), '1e-7');
    });
    ...
    it('auto notation with custom upper bound', function () {
      ...
      _assert2.default.equal(formatter.format(new BigNumber(1e+9), options), '1e+9');
      _assert2.default.equal(formatter.format(new BigNumber(1e+9 - 1), options), '999999999');
    });
    ...
    it('should format bignumbers in fixed notation', function () {
      ...
      _assert2.default.deepEqual(formatter.format(new BigNumber('1.23456'), options), '1');
      _assert2.default.deepEqual(formatter.format(new BigNumber('1.7'), options), '2');
      _assert2.default.deepEqual(formatter.format(new BigNumber('12345678'), options), '12345678');
      _assert2.default.deepEqual(formatter.format(new BigNumber('12e18'), options), '12000000000000000000');
      _assert2.default.deepEqual(formatter.format(new BigNumber('12e30'), options), '12000000000000000000000000000000');
    });
    ...
    it('should format bignumbers in fixed notation with precision', function () {
      ...
      _assert2.default.deepEqual(formatter.format(new BigNumber('1.23456'), options), '1.23');
      _assert2.default.deepEqual(formatter.format(new BigNumber('12345678'), options), '12345678.00');
      _assert2.default.deepEqual(formatter.format(new BigNumber('12e18'), options), '12000000000000000000.00');
      _assert2.default.deepEqual(formatter.format(new BigNumber('12e30'), options), '12000000000000000000000000000000.00');
    });

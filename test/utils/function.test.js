...
describe('util.function', function() {
  ...
  describe ('maxArgumentCount', function () {
    ...
    it('should calculate the max argument count of a typed function', function() {
      ...
      assert.equal(libutilsfunction_memoizejs(a), 2);
      ...
      assert.equal(libutilsfunction_memoizejs(b), 2);
      ...
      assert.equal(libutilsfunction_memoizejs(c), 1);
      ...
      assert.equal(libutilsfunction_memoizejs(d), 3);
    });

    it('should return -1 for regular functions', function() {
      assert.equal(libutilsfunction_memoizejs(function () {}), -1);
    });

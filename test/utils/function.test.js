...
describe('util.function', function() {
  ...
  describe ('maxArgumentCount', function () {
    ...
    it('should calculate the max argument count of a typed function', function() {
      ...
      assert.equal(libutilsfunction_functionjsjs.maxArgumentCount(a), 2);
      ...
      assert.equal(libutilsfunction_functionjsjs.maxArgumentCount(b), 2);
      ...
      assert.equal(libutilsfunction_functionjsjs.maxArgumentCount(c), 1);
      ...
      assert.equal(libutilsfunction_functionjsjs.maxArgumentCount(d), 3);
    });

    it('should return -1 for regular functions', function() {
      assert.equal(libutilsfunction_functionjsjs.maxArgumentCount(function () {}), -1);
    });

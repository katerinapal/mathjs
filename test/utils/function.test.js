...
describe('util.function', function () {
  ...
  describe('memoize', function () {
    ...
    it('should memoize a function with one argument', function () {
      ...
      var m = libutilsfunction_functionjsjs.memoize(f);
    ...
    it('should memoize a function with a custom hashIt function', function () {
      ...
      var m = libutilsfunction_functionjsjs.memoize(f, hashIt);
  ...
  describe('maxArgumentCount', function () {
    ...
    it('should calculate the max argument count of a typed function', function () {
      ...
      _assert2.default.equal(libutilsfunction_functionjsjs.maxArgumentCount(a), 2);
      ...
      _assert2.default.equal(libutilsfunction_functionjsjs.maxArgumentCount(b), 2);
      ...
      _assert2.default.equal(libutilsfunction_functionjsjs.maxArgumentCount(c), 1);
      ...
      _assert2.default.equal(libutilsfunction_functionjsjs.maxArgumentCount(d), 3);
    });

    it('should return -1 for regular functions', function () {
      _assert2.default.equal(libutilsfunction_functionjsjs.maxArgumentCount(function () {}), -1);
    });
  });
});

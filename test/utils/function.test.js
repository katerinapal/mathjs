...
import { functionUtils as functionjs } from "../../lib/utils/function";
var assert = {};
var functionUtils = functionjs;
...
describe('util.function', function() {
  ...
  describe ('maxArgumentCount', function () {
    ...
    it('should calculate the max argument count of a typed function', function() {
      ...
      assert.equal(functionjs.maxArgumentCount(a), 2);
      ...
      assert.equal(functionjs.maxArgumentCount(b), 2);
      ...
      assert.equal(functionjs.maxArgumentCount(c), 1);
      ...
      assert.equal(functionjs.maxArgumentCount(d), 3);
    });

    it('should return -1 for regular functions', function() {
      assert.equal(functionjs.maxArgumentCount(function () {}), -1);
    });

...
import { libutilsfunction_obj } from "../../lib/utils/function";
var functionUtils = libutilsfunction_obj;
...
describe('util.function', function() {
  ...
  describe('memoize', function () {
    ...
    it('should memoize a function with a custom hashIt function', function () {
      ...
      var m = libutilsfunction_obj(f, hashIt);
  ...
  describe ('maxArgumentCount', function () {
    ...
    it('should calculate the max argument count of a typed function', function() {
      ...
      assert.equal(libutilsfunction_obj.maxArgumentCount(a), 2);
      ...
      assert.equal(libutilsfunction_obj.maxArgumentCount(b), 2);
      ...
      assert.equal(libutilsfunction_obj.maxArgumentCount(c), 1);
      ...
      assert.equal(libutilsfunction_obj.maxArgumentCount(d), 3);
    });

    it('should return -1 for regular functions', function() {
      assert.equal(libutilsfunction_obj.maxArgumentCount(function () {}), -1);
    });

...
describe('replacer', function () {
  ...
  it('should stringify a BigNumber', function () {
    var b = new index_indexjsjs.type.BigNumber(5);
  ...
  it('should stringify an Index', function () {
    var i = new index_indexjsjs.type.Index(new index_indexjsjs.type.Range(0, 10), 2);
  ...
  it('should stringify a Matrix containing a complex number, sparse', function () {
    var c = new index_indexjsjs.type.Complex(4, 5);
    var m = index_indexjsjs.matrix([[1,2],[3,c]], 'sparse');

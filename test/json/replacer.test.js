...
describe('replacer', function () {
  ...
  it('should stringify generic JSON', function () {
    ...
    _assert2.default.deepEqual(JSON.stringify(data), json);
  });
  ...
  it('should stringify a Complex number', function () {
    ...
    _assert2.default.deepEqual(JSON.stringify(c), json);
  });

  it('should stringify a BigNumber', function () {
    var b = new _index.indexjs.type.BigNumber(5);
    var json = '{"mathjs":"BigNumber","value":"5"}';

    _assert2.default.deepEqual(JSON.stringify(b), json);
  });
  ...
  it('should stringify a Range', function () {
    ...
    _assert2.default.deepEqual(JSON.stringify(r), json);
  });

  it('should stringify an Index', function () {
    var i = new _index.indexjs.type.Index(new _index.indexjs.type.Range(0, 10), 2);
    var json = '{"mathjs":"Index","dimensions":[' + '{"mathjs":"Range","start":0,"end":10,"step":1},' + '{"mathjs":"ImmutableDenseMatrix","data":[2],"size":[1]}' + ']}';
    _assert2.default.deepEqual(JSON.stringify(i), json);
  });
  ...
  it('should stringify a Unit', function () {
    ...
    _assert2.default.deepEqual(JSON.stringify(u), json);
  });
  ...
  it('should stringify a Matrix, dense', function () {
    ...
    _assert2.default.deepEqual(JSON.stringify(m), json);
  });
  ...
  it('should stringify a Matrix containing a complex number, sparse', function () {
    var c = new _index.indexjs.type.Complex(4, 5);
    var m = _index.indexjs.matrix([[1, 2], [3, c]], 'sparse');
  ...
  it('should stringify Help', function () {
    ...
    _assert2.default.deepEqual(JSON.parse(JSON.stringify(h)), JSON.parse(json));
  });
});

...
var _cs_sqr = require("../../algebra/sparse/cs_sqr");

var algebrasparsecs_sqr_obj = _interopRequireWildcard(_cs_sqr);

var _cs_lu = require("../../algebra/sparse/cs_lu");

var algebrasparsecs_lu_obj = _interopRequireWildcard(_cs_lu);
...
function factory(type, config, load, typed) {
  ...
  var cs_sqr = load(algebrasparsecs_sqr_obj);
  var cs_lu = load(algebrasparsecs_lu_obj);

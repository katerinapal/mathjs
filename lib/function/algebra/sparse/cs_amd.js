import * as cs_flipjs from "./cs_flip";
import * as cs_fkeepjs from "./cs_fkeep";
import * as cs_tdfsjs from "./cs_tdfs";
...
function factory (type, config, load) {
  ...
  var cs_flip = load(cs_flipjs);
  var cs_fkeep = load(cs_fkeepjs);
  var cs_tdfs = load(cs_tdfsjs);

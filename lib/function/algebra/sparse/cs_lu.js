...
var _abs = require("../../arithmetic/abs");

var arithmeticabs_obj = _interopRequireWildcard(_abs);
...
var _largerEq = require("../../relational/largerEq");

var relationallargerEq_obj = _interopRequireWildcard(_largerEq);

var _cs_spsolve = require("./cs_spsolve");

var cs_spsolve_obj = _interopRequireWildcard(_cs_spsolve);
...
function factory(type, config, load) {
  ...
  var largerEq = load(relationallargerEq_obj);

  var cs_spsolve = load(cs_spsolve_obj);

...
import * as relationallargerEq from "../../relational/largerEq";
import * as cs_spsolve from "./cs_spsolve";
'use strict';
...
function factory (type, config, load) {
  ...
  var largerEq = load(relationallargerEq);
  
  var cs_spsolve = load(cs_spsolve);

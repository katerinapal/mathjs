import * as cs_marked from "./cs_marked";
import * as cs_mark from "./cs_mark";
import * as cs_unflip from "./cs_unflip";
'use strict';

function factory (type, config, load) {

  var cs_marked = load(cs_marked);
  var cs_mark   = load(cs_mark);
  var cs_unflip = load(cs_unflip);

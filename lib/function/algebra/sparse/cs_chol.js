import * as arithmeticdivideScalar from "../../arithmetic/divideScalar";
import * as arithmeticsqrt from "../../arithmetic/sqrt";
import * as arithmeticsubtract from "../../arithmetic/subtract";
import * as arithmeticmultiply from "../../arithmetic/multiply";
import * as complexim from "../../complex/im";
import * as complexre from "../../complex/re";
import * as complexconj from "../../complex/conj";
import * as relationalequal from "../../relational/equal";
import * as relationalsmallerEq from "../../relational/smallerEq";
import * as cs_symperm from "./cs_symperm";
import * as cs_ereach from "./cs_ereach";
'use strict';

function factory (type, config, load) {

  var divideScalar = load(arithmeticdivideScalar);
  var sqrt = load(arithmeticsqrt);
  var subtract = load(arithmeticsubtract);
  var multiply = load(arithmeticmultiply);
  var im = load(complexim);
  var re = load(complexre);
  var conj = load(complexconj);
  var equal = load(relationalequal);
  var smallerEq = load(relationalsmallerEq);

  var cs_symperm = load(cs_symperm);
  var cs_ereach  = load(cs_ereach);

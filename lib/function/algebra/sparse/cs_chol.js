import * as divideScalarjs from "../../arithmetic/divideScalar";
import * as sqrtjs from "../../arithmetic/sqrt";
import * as subtractjs from "../../arithmetic/subtract";
import * as multiplyjs from "../../arithmetic/multiply";
import * as imjs from "../../complex/im";
import * as rejs from "../../complex/re";
import * as conjjs from "../../complex/conj";
import * as equaljs from "../../relational/equal";
import * as smallerEqjs from "../../relational/smallerEq";
import * as cs_sympermjs from "./cs_symperm";
import * as cs_ereachjs from "./cs_ereach";
'use strict';

function factory (type, config, load) {

  var divideScalar = load(divideScalarjs);
  var sqrt = load(sqrtjs);
  var subtract = load(subtractjs);
  var multiply = load(multiplyjs);
  var im = load(imjs);
  var re = load(rejs);
  var conj = load(conjjs);
  var equal = load(equaljs);
  var smallerEq = load(smallerEqjs);

  var cs_symperm = load(cs_sympermjs);
  var cs_ereach  = load(cs_ereachjs);

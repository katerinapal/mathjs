...
import * as statisticssum from "../statistics/sum";
import * as arithmeticmultiply from "../arithmetic/multiply";
import * as arithmeticdotDivide from "../arithmetic/dotDivide";
import * as arithmeticlog from "../arithmetic/log";
import * as utilsisNumeric from "../utils/isNumeric";
'use strict';
...
function factory(type, config, load, typed) {
    ...
    var sum = load(statisticssum);
    var multiply = load(arithmeticmultiply);
    var dotDivide = load(arithmeticdotDivide);
    var log = load(arithmeticlog);
    var isNumeric = load(utilsisNumeric);

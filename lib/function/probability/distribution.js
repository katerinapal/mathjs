      ...
      var randFunctions = {
        ...
        random: function(arg1, arg2, arg3) {
          ...
          if (arguments.length > 3) {
            throw new errorArgumentsError_ArgumentsErrorjs('random', arguments.length, 0, 3);

          // `random(max)` or `random(size)`
          } else if (arguments.length === 1) {
            if (utilscollectionisCollection_isCollectionjsjs(arg1)) {
              size = arg1;
            }
            else {
              max = arg1;
        ...
        randomInt: function(arg1, arg2, arg3) {
          ...
          if (arguments.length > 3 || arguments.length < 1)
            throw new errorArgumentsError_ArgumentsErrorjs('randomInt', arguments.length, 1, 3);
        ...
        pickRandom: function(possibles) {
          if (arguments.length !== 1) {
            throw new errorArgumentsError_ArgumentsErrorjs('pickRandom', arguments.length, 1);
          }
          ...
          if (utilsarray_sizejs.size(possibles).length > 1) {

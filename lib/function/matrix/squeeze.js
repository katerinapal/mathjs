...
import { squeeze as utilsarray_squeezejs } from "../../utils/array";
...
function factory (type, config, load, typed) {
  ...
  var squeeze = typed('squeeze', {
    'Array': function (x) {
      return utilsarray_squeezejs.squeeze(utilsobject_clonejs.clone(x));
    },

    'Matrix': function (x) {
      var res = utilsarray_squeezejs.squeeze(x.toArray());
    ...
    'any': function (x) {
      // scalar
      return utilsobject_clonejs.clone(x);
    }
  });

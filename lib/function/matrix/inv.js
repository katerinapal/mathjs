...
import * as arithmeticdivideScalar_obj from "../arithmetic/divideScalar";
import * as arithmeticaddScalar_obj from "../arithmetic/addScalar";
import * as arithmeticmultiply_obj from "../arithmetic/multiply";
import * as arithmeticunaryMinus_obj from "../arithmetic/unaryMinus";
import * as matrixdet_obj from "../matrix/det";
...
function factory (type, config, load, typed) {
  ...
  var inv = typed('inv', {
    'Array | Matrix': function (x) {
      var size = (x.isMatrix === true) ? x.size() : utilsindex_obj.size(x);
      switch (size.length) {
        case 1:
          // vector
          if (size[0] == 1) {
            ...
            '(size: ' + utilsindex_obj.string.format(size) + ')');
          }

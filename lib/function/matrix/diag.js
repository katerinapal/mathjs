...
function factory(type, config, load, typed) {
  ...
  var diag = typed('diag', {
    ...
    'Array': function Array(x) {
      return _diag(x, 0, _array.size.size(x), null);
    },

    'Array, number': function ArrayNumber(x, k) {
      return _diag(x, k, _array.size.size(x), null);
    },

    'Array, BigNumber': function ArrayBigNumber(x, k) {
      return _diag(x, k.toNumber(), _array.size.size(x), null);
    },

    'Array, string': function ArrayString(x, format) {
      return _diag(x, 0, _array.size.size(x), format);
    },

    'Array, number, string': function ArrayNumberString(x, k, format) {
      return _diag(x, k, _array.size.size(x), format);
    },

    'Array, BigNumber, string': function ArrayBigNumberString(x, k, format) {
      return _diag(x, k.toNumber(), _array.size.size(x), format);
    },

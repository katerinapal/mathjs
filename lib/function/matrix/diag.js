...
function factory (type, config, load, typed) {
  ...
  var diag = typed('diag', {
    ...
    'Array': function (x) {
      return _diag(x, 0, arrayjs.size(x), null);
    },

    'Array, number': function (x, k) {
      return _diag(x, k, arrayjs.size(x), null);
    },
    
    'Array, BigNumber': function (x, k) {
      return _diag(x, k.toNumber(), arrayjs.size(x), null);
    },

    'Array, string': function (x, format) {
      return _diag(x, 0, arrayjs.size(x), format);
    },

    'Array, number, string': function (x, k, format) {
      return _diag(x, k, arrayjs.size(x), format);
    },

    'Array, BigNumber, string': function (x, k, format) {
      return _diag(x, k.toNumber(), arrayjs.size(x), format);
    },

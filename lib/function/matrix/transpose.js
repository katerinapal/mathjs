    ...
    'Matrix': function Matrix(x) {
      ...
      switch (size.length) {
        ...
        case 2:
          ...
          if (columns === 0) {
            // throw exception
            throw new RangeError('Cannot transpose a 2D matrix with no columns (size: ' + _string.format + ')');
          }
        ...
        default:
          // multi dimensional
          throw new RangeError('Matrix must be a vector or two dimensional (size: ' + _string.format + ')');
      }
      return c;
    },

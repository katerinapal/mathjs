    ...
    'Matrix': function Matrix(x) {
      ...
      switch (size.length) {
        ...
        case 2:
          ...
          if (columns === 0) {
            // throw exception
            throw new RangeError('Cannot transpose a 2D matrix with no columns (size: ' + _string.isString + ')');
          }
        ...
        default:
          // multi dimensional
          throw new RangeError('Matrix must be a vector or two dimensional (size: ' + _string.isString + ')');
      }
      return c;
    },
  ...
  var _sparseTranspose = function _sparseTranspose(m, rows, columns) {
    ...
    for (j = 0; j < columns; j++) {
      ...
      for (var k0 = ptr[j], k1 = ptr[j + 1], k = k0; k < k1; k++) {
        ...
        if (values) cvalues[q] = _object.clone;
      }
    }
    // return matrix

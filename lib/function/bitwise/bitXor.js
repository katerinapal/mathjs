...
import { bitXorjs as utilsbignumberbitXor_bitXorjsjs } from "../../utils/bignumber/bitXor";
...
function factory (type, config, load, typed) {
  ...
  var bitXor = typed('bitXor', {
    ...
    'BigNumber, BigNumber': utilsbignumberbitXor_bitXorjsjs,
  ...
  bitXor.toTex = {
    2: '\\left(${args[0]}' + utilslatex_operatorsjs['bitXor'] + '${args[1]}\\right)'
  };

  return bitXor;
}

var name_name = 'bitXor';

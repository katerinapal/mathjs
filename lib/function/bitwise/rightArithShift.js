...
import { bigRightArithShift as utilsbignumberrightArithShift_bigRightArithShift } from "../../utils/bignumber/rightArithShift";
...
var bigRightArithShift = utilsbignumberrightArithShift_bigRightArithShift;
...
function factory (type, config, load, typed) {
  ...
  var rightArithShift = typed('rightArithShift', {
    ...
    'BigNumber, BigNumber': utilsbignumberrightArithShift_bigRightArithShift,
  ...
  rightArithShift.toTex = {
    2: '\\left(${args[0]}' + utilslatex_obj.operators['rightArithShift'] + '${args[1]}\\right)'
  };

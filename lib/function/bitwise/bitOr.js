...
import { bigBitOr as utilsbignumberbitOr_bigBitOr } from "../../utils/bignumber/bitOr";
...
var bigBitOr = utilsbignumberbitOr_bigBitOr;
...
function factory (type, config, load, typed) {
  ...
  var bitOr = typed('bitOr', {
    ...
    'BigNumber, BigNumber': utilsbignumberbitOr_bigBitOr,
  ...
  bitOr.toTex = {
    2: '\\left(${args[0]}' + utilslatex_obj.operators['bitOr'] + '${args[1]}\\right)'
  };

...
var _isZero = require("../utils/isZero");

var utilsisZero_obj = _interopRequireWildcard(_isZero);
...
var typematrixutilsalgorithm06_obj = _interopRequireWildcard(_algorithm2);
...
function factory(type, config, load, typed) {
  ...
  and.toTex = {
    2: '\\left(${args[0]}' + _latex.operators['and'] + '${args[1]}\\right)'
  };

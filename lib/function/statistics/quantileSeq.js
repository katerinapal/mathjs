...
var isNumber = utilsnumber.isNumber;
...
function factory (type, config, load, typed) {
  ...
  function quantileSeq(data, probOrN, sorted) {
    ...
    if (utilscollectionisCollection_isCollection(data)) {
      sorted = sorted || false;
      if (typeof sorted === 'boolean') {
        dataArr = data.valueOf();
        if (utilsnumber(probOrN)) {
          if (probOrN < 0) {
...
var name_exportedObj = 'quantileSeq';

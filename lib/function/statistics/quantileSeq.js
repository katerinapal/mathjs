...
import { flatten as arrayjs } from "../../utils/array";
...
import * as partitionSelectjs from "../matrix/partitionSelect";
import * as comparejs from "../relational/compare";
'use strict';

var isInteger = numberjs.isInteger;
var isNumber = numberjs.isNumber;
var flatten = arrayjs.flatten;
var isCollection = isCollection_isCollectionjs;

function factory (type, config, load, typed) {
  var add = load(addjs);
  var multiply = load(multiplyjs);
  var partitionSelect = load(partitionSelectjs);
  var compare = load(comparejs);
  ...
  function quantileSeq(data, probOrN, sorted) {
    ...
    if (isCollection_isCollectionjs(data)) {
      sorted = sorted || false;

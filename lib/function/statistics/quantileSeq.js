...
var isNumber = utilsnumber_obj.isNumber;
var flatten = utilsarray_obj.flatten;
...
function factory (type, config, load, typed) {
  ...
  function _quantileSeq(array, prob, sorted) {
    var flat = utilsarray_obj(array);
    var len = flat.length;
    if (len === 0) {
      throw new Error('Cannot calculate quantile of an empty sequence');
    }

    if (utilsnumber_obj(prob)) {

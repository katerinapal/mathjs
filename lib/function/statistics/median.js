...
import * as relationalcompare from "../relational/compare";
import * as matrixpartitionSelect from "../matrix/partitionSelect";
'use strict';

var flatten = utilsarray.flatten;
...
function factory (type, config, load, typed) {
  var add = load(arithmeticaddScalar);
  var divide = load(arithmeticdivideScalar);
  var compare = load(relationalcompare);
  var partitionSelect = load(matrixpartitionSelect);
  ...
  function _median(array) {
    array = utilsarray(array.valueOf());

...
var _equalScalar = require("./equalScalar");

var equalScalar_obj = _interopRequireWildcard(_equalScalar);
...
function factory(type, config, load, typed) {
  ...
  var equalScalar = load(equalScalar_obj);
  ...
  equal.toTex = {
    2: '\\left(${args[0]}' + _latex.operators['equal'] + '${args[1]}\\right)'
  };

  return equal;
}

var name_exportedObj = 'equal';

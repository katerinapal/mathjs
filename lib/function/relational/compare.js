import { isNumber as nearlyEqual } from "../../utils/number";
...
function factory (type, config, load, typed) {
  ...
  var compare = typed('compare', {
    ...
    'BigNumber, BigNumber': function (x, y) {
      return (x.eq(y) || utilsbignumbernearlyEqual_nearlyEqualjsjs(x, y, config.epsilon))

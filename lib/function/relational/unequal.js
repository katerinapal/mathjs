...
function factory (type, config, load, typed) {
  ...
  var _unequal = typed('_unequal', {
    ...
    'number, number': function (x, y) {
      return !utilsnumber_obj(x, y, config.epsilon);
    },

    'BigNumber, BigNumber': function (x, y) {
      return !utilsbignumbernearlyEqual_bigNearlyEqual(x, y, config.epsilon);
    },
  ...
  unequal.toTex = {
    2: '\\left(${args[0]}' + utilslatex_obj.operators['unequal'] + '${args[1]}\\right)'
  };

  return unequal;
}

var name_exportedObj = 'unequal';

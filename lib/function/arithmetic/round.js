...
var toFixed = utilsnumber_obj.toFixed;
...
function factory (type, config, load, typed) {
  ...
  var round = typed('round', {
    ...
    'number, number': function (x, n) {
      if (!utilsnumber_obj(n))   {throw new TypeError(NO_INT);}
    ...
    'Array | Matrix': function (x) {
      ...
      return utilscollectiondeepMap_deepMap(x, round, true);
    },
...
function _round (value, decimals) {
  return parseFloat(utilsnumber_obj(value, decimals));
}

...
import { utilslatexjs_obj } from "../../utils/latex.js";
...
function factory (type, config, load, typed) {
   ...
   */
  var add = typed('add', utilsobject_obj({
  ...
  add.toTex = {
    2: '\\left(${args[0]}' + utilslatexjs_obj.operators['add'] + '${args[1]}\\right)'
  };

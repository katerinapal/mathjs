...
import * as sqrtjs from "./sqrt";
import * as smallerjs from "../relational/smaller";
...
function factory (type, config, load, typed) {
  ...
  var hypot = typed('hypot', {
    ...
    'Array': function (x) {
      return hypot.apply(hypot, arrayjs(x));
    },

    'Matrix': function (x) {
      return hypot.apply(hypot, arrayjs(x.toArray()));
    }
  });

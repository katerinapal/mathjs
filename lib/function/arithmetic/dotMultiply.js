...
import * as typematrixutilsalgorithm09 from "../../type/matrix/utils/algorithm09";
...
function factory (type, config, load, typed) {
  ...
  var algorithm09 = load(typematrixutilsalgorithm09);
  ...
  dotMultiply.toTex = {
    2: '\\left(${args[0]}' + utilslatex.operators['dotMultiply'] + '${args[1]}\\right)'
  };

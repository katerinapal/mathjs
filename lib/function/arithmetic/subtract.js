...
import * as typematrixutilsalgorithm05_obj from "../../type/matrix/utils/algorithm05";
...
function factory (type, config, load, typed) {
  ...
  var subtract = typed('subtract', {
    ...
    'Matrix, Matrix': function (x, y) {
      ...
      if (xsize.length !== ysize.length)
        throw new errorDimensionError_DimensionError(xsize.length, ysize.length);
  ...
  subtract.toTex = {
    2: '\\left(${args[0]}' + utilslatex_obj.operators['subtract'] + '${args[1]}\\right)'
  };

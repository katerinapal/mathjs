...
import * as arithmeticpow from "../arithmetic/pow";
...
import * as relationalsmaller from "../relational/smaller";
import * as typematrixfunctionmatrix from "../../type/matrix/function/matrix";
import * as matrixtrace from "../matrix/trace";
import * as matrixtranspose from "../matrix/transpose";
'use strict';
...
function factory (type, config, load, typed) {
  ...
  var smaller     = load(relationalsmaller);
  var matrix      = load(typematrixfunctionmatrix);
  var trace       = load(matrixtrace);
  var transpose   = load(matrixtranspose);

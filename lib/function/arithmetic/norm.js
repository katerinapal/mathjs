import * as absjs from "../arithmetic/abs";
...
import * as tracejs from "../matrix/trace";
import * as transposejs from "../matrix/transpose";
'use strict';
...
function factory (type, config, load, typed) {
  ...
  var trace       = load(tracejs);
  var transpose   = load(transposejs);

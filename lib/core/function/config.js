...
function factory (type, config, load, typed, math) {
  ...
  function _config(options) {
    if (options) {
      var prev = utilsobject_obj.clone(config);
      ...
      // merge options
      utilsobject_obj.deepExtend(config, options);

      var curr = utilsobject_obj.clone(config);
      ...
      return utilsobject_obj.clone(config);
    }
  }

...
var traverse = objectjs.traverse;
...
function factory (type, config, load, typed, math) {
  ...
  function math_import(object, options) {
    ...
    if (num != 1 && num != 2) {
      throw new ArgumentsError_ArgumentsErrorjs('import', num, 1, 2);
    }
  ...
  function _importFactory(factory, options) {
    if (typeof factory.name === 'string') {
      ...
      var namespace = factory.path ? objectjs(math, factory.path) : math;
      ...
      if (factory.lazy !== false) {
        objectjs(namespace, name, resolver);
      }
      else {

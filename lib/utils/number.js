...
var isNumber_exportedObj = function isNumber_exportedObj(value) {
  return typeof value === 'number';
};

var isInteger_exportedObj = function isInteger_exportedObj(value) {
...
var toEngineering_exportedObj = function toEngineering_exportedObj(value, precision) {
...
var toPrecision_exportedObj = function toPrecision_exportedObj(value, precision, options) {
  return new _NumberFormatter.NumberFormatter(value).toPrecision(precision, options);
};

var digits_exportedObj = function digits_exportedObj(value) {
...
var nearlyEqual_exportedObj = function nearlyEqual_exportedObj(x, y, epsilon) {
...
exports.isNumber = isNumber_exportedObj;
exports.isInteger = isInteger_exportedObj;
exports.sign = sign_exportedObj;
exports.format = format_exportedObj;
exports.toExponential = toExponential_exportedObj;
exports.toEngineering = toEngineering_exportedObj;
exports.toFixed = toFixed_exportedObj;
exports.toPrecision = toPrecision_exportedObj;
exports.digits = digits_exportedObj;
exports.DBL_EPSILON = DBL_EPSILON_exportedObj;
exports.nearlyEqual = nearlyEqual_exportedObj;

import { NumberFormatter as NumberFormatter_NumberFormatter } from "./NumberFormatter";
'use strict';

var NumberFormatter = NumberFormatter_NumberFormatter;
...
var toExponential_exportedObj = function(value, precision) {
  return new NumberFormatter_NumberFormatter(value).toExponential(precision);
};

var toEngineering_exportedObj = function(value, precision) {
  return new NumberFormatter_NumberFormatter(value).toEngineering(precision);
};

var toFixed_exportedObj = function(value, precision) {
  return new NumberFormatter_NumberFormatter(value).toFixed(precision);
};

var toPrecision_exportedObj = function(value, precision, options) {
  return new NumberFormatter_NumberFormatter(value).toPrecision(precision, options);
};

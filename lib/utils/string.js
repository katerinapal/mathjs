...
import * as bignumberformatter_obj from "./bignumber/formatter";
'use strict';

var formatNumber = number_obj.format;
var formatBigNumber = bignumberformatter_obj.format;
...
var format_exportedObj = function(value, options) {
  if (typeof value === 'number') {
    return number_obj(value, options);
  }

  if (value && value.isBigNumber === true) {
    return bignumberformatter_obj(value, options);
  }

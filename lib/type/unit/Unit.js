...
import * as functionarithmeticaddScalar from "../../function/arithmetic/addScalar";
import * as functionarithmeticsubtract from "../../function/arithmetic/subtract";
import * as functionarithmeticmultiplyScalar from "../../function/arithmetic/multiplyScalar";
import * as functionarithmeticdivideScalar from "../../function/arithmetic/divideScalar";
...
import * as functionstringformat from "../../function/string/format";
import * as functionutilstypeof from "../../function/utils/typeof";
import * as typenumber from "../../type/number";
import * as typecomplexComplex from "../../type/complex/Complex";
import util from "util";
'use strict';

var endsWith = utilsstring.endsWith;
var clone = utilsobject.clone;
var constants = utilsbignumberconstants;

function factory (type, config, load, typed, math) {
  var add       = load(functionarithmeticaddScalar);
  var subtract  = load(functionarithmeticsubtract);
  var multiply  = load(functionarithmeticmultiplyScalar);
  var divide    = load(functionarithmeticdivideScalar);
  var pow       = load(functionarithmeticpow);
  var abs       = load(functionarithmeticabs);
  var fix       = load(functionarithmeticfix);
  var equal     = load(functionrelationalequal);
  var isNumeric = load(functionutilsisNumeric);
  var format    = load(functionstringformat);
  var getTypeOf = load(functionutilstypeof);
  var toNumber  = load(typenumber);
  var Complex   = load(typecomplexComplex);
  ...
  Unit.prototype.clone = function () {
    ...
    unit.value = utilsobject(this.value);
  ...
  function calculateAngleValues (config) {
    if (config.number === 'BigNumber') {
      var pi = utilsbignumberconstants.pi(type.BigNumber);

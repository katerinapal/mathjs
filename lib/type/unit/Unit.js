import { utilsstring_obj } from "../../utils/string";
...
var endsWith = utilsstring_obj.endsWith;
var clone = utilsobject_obj.clone;
var constants = utilsbignumberconstants_obj;
...
function factory (type, config, load, typed, math) {
  ...
  Unit.prototype.clone = function () {
    ...
    unit.value = utilsobject_obj(this.value);
  ...
  Unit.prototype.to = function (valuelessUnit) {
    ...
    if (typeof valuelessUnit === 'string') {
      ...
      other.value = utilsobject_obj(value);
  ...
  function calculateAngleValues (config) {
    if (config.number === 'BigNumber') {
      var pi = utilsbignumberconstants_obj.pi(type.BigNumber);

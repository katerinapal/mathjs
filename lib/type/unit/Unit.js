import { endsWith as utilsstring_endsWithjs } from "../../utils/string";
import { clone as utilsobject_clonejs } from "../../utils/object";
import { pi as utilsbignumberconstants_pijs } from "../../utils/bignumber/constants";
import { factory as functionarithmeticaddScalar_obj } from "../../function/arithmetic/addScalar";
import * as functionarithmeticsubtract_obj from "../../function/arithmetic/subtract";
import { factory as functionarithmeticmultiplyScalar_obj } from "../../function/arithmetic/multiplyScalar";
import { factory as functionarithmeticdivideScalar_obj } from "../../function/arithmetic/divideScalar";
...
import * as functionstringformat_obj from "../../function/string/format";
import * as functionutilstypeof_obj from "../../function/utils/typeof";
import * as typenumber_obj from "../../type/number";
import * as typecomplexComplex_obj from "../../type/complex/Complex";
import util from "util";
'use strict';

function factory (type, config, load, typed, math) {
  var add       = load(functionarithmeticaddScalar_obj);
  var subtract  = load(functionarithmeticsubtract_obj);
  var multiply  = load(functionarithmeticmultiplyScalar_obj);
  var divide    = load(functionarithmeticdivideScalar_obj);
  var pow       = load(functionarithmeticpow_obj);
  var abs       = load(functionarithmeticabs_obj);
  var fix       = load(functionarithmeticfix_obj);
  var equal     = load(functionrelationalequal_obj);
  var isNumeric = load(functionutilsisNumeric_obj);
  var format    = load(functionstringformat_obj);
  var getTypeOf = load(functionutilstypeof_obj);
  var toNumber  = load(typenumber_obj);
  var Complex   = load(typecomplexComplex_obj);
  ...
  Unit.prototype.clone = function () {
    ...
    unit.value = utilsobject_clonejs(this.value);
  ...
  function _findUnit(str) {
    ...
    for (var name in UNITS) {
      if (UNITS.hasOwnProperty(name)) {
        if (utilsstring_endsWithjs(str, name)) {
          var unit = UNITS[name];
  ...
  Unit.prototype.to = function (valuelessUnit) {
    ...
    if (typeof valuelessUnit === 'string') {
      ...
      other.value = utilsobject_clonejs(value);
  ...
  function calculateAngleValues (config) {
    if (config.number === 'BigNumber') {
      var pi = utilsbignumberconstants_pijs(type.BigNumber);

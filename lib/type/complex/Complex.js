...
function factory (type, config, load, typed, math) {
  ...
  Complex.prototype.format = function (options) {
    ...
    var im = this.im;
    var re = this.re;
    var strRe = utilsnumber(this.re, options);
    var strIm = utilsnumber(this.im, options);

    // round either re or im when smaller than the configured precision
    var precision = utilsnumber(options) ? options : options ? options.precision : null;
    if (precision !== null) {

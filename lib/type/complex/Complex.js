import complex_moduleDefault from "complex.js";
import { format as numberjs } from "../../utils/number";
var Complex = {};
var format = numberjs.format;
...
function factory (type, config, load, typed, math) {
  ...
  Complex.prototype.format = function (options) {
    ...
    var im = this.im;
    var re = this.re;
    var strRe = numberjs(this.re, options);
    var strIm = numberjs(this.im, options);

    // round either re or im when smaller than the configured precision
    var precision = numberjs(options) ? options : options ? options.precision : null;
    if (precision !== null) {

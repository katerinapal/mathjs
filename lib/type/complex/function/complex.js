...
import { symbols as utilslatex_symbolsjs } from "../../../utils/latex";
'use strict';
...
function factory (type, config, load, typed) {
  ...
  var complex = typed('complex', {
    ...
    'Array | Matrix': function (x) {
      return utilscollectiondeepMap_deepMapjsjs(x, complex);
    }
  });
  ...
  complex.toTex = {
    ...
    2: '\\left(\\left(${args[0]}\\right)+'
      + utilslatex_symbolsjs['i'] + '\\cdot\\left(${args[1]}\\right)\\right)'
  };

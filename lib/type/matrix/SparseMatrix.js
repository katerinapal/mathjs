...
var array = utilsindex_indexjsjs.array;
var object = utilsindex_indexjsjs.object;
var string = utilsindex_indexjsjs.string;
var number = utilsindex_indexjsjs.number;
...
function factory (type, config, load, typed) {
  ...
  function SparseMatrix(data, datatype) {
    ...
    if (data && data.isMatrix === true) {
      ...
      // unsupported type
      throw new TypeError('Unsupported type of data (' + utilsindex_indexjsjs.types.type(data) + ')');
    }
    else {
      // nothing provided
      this._values = [];

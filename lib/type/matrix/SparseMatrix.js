...
import * as functionrelationalequalScalar from "../../function/relational/equalScalar";
'use strict';

var util = utilsindex;
var DimensionError = errorDimensionError_DimensionError;

var array = utilsindex;
var object = utilsindex.object;
var string = utilsindex.string;
var number = utilsindex.number;
...
function factory (type, config, load, typed) {
  var Matrix = load(Matrix); // force loading Matrix (do not use via type.Matrix)
  var equalScalar = load(functionrelationalequalScalar);
  ...
  function SparseMatrix(data, datatype) {
    ...
    if (data && data.isMatrix === true) {
      ...
      // unsupported type
      throw new TypeError('Unsupported type of data (' + utilsindex.types.type(data) + ')');
    }
    else {
      // nothing provided
      this._values = [];

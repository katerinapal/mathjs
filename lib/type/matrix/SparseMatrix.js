...
exports.lazy = exports.factory = exports.path = exports.name = undefined;

var _index = require("../../utils/index");

var utilsindex_indexjsjs = _interopRequireWildcard(_index);
...
var functionrelationalequalScalar_obj = _interopRequireWildcard(_equalScalar);
...
function factory(type, config, load, typed) {
  ...
  SparseMatrix.prototype.get = function (index) {
    ...
    if (index.length != this._size.length) throw new _DimensionError.DimensionError(index.length, this._size.length);

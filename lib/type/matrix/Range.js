...
function factory(type, config, load, typed) {
  ...
  Range.prototype.size = function () {
    ...
    if ((0, _number.isNumber)(step) == (0, _number.isNumber)(diff)) {
  ...
  Range.prototype.format = function (options) {
    var str = (0, _number.isNumber)(this.start, options);

    if (this.step != 1) {
      str += ':' + (0, _number.isNumber)(this.step, options);
    }
    str += ':' + (0, _number.isNumber)(this.end, options);
    return str;
  };

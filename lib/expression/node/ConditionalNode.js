...
function factory (type, config, load, typed) {
  ...
  ConditionalNode.prototype._toString = function (options) {
    ...
    var precedence = operators_obj.getPrecedence(this, parenthesis);
    ...
    var conditionPrecedence = operators_obj.getPrecedence(this.condition, parenthesis);
    if ((parenthesis === 'all')
    ...
    var truePrecedence = operators_obj.getPrecedence(this.trueExpr, parenthesis);
    if ((parenthesis === 'all')
    ...
    var falsePrecedence = operators_obj.getPrecedence(this.falseExpr, parenthesis);
    if ((parenthesis === 'all')
...
var name_exportedObj = 'ConditionalNode';

...
function factory (type, config, load, typed) {
  ...
  ConditionalNode.prototype._toString = function (options) {
    ...
    var precedence = operators_getPrecedencejs(this, parenthesis);
    ...
    var conditionPrecedence = operators_getPrecedencejs(this.condition, parenthesis);
    if ((parenthesis === 'all')
    ...
    var truePrecedence = operators_getPrecedencejs(this.trueExpr, parenthesis);
    if ((parenthesis === 'all')
    ...
    var falsePrecedence = operators_getPrecedencejs(this.falseExpr, parenthesis);
    if ((parenthesis === 'all')

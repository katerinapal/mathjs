...
function factory (type, config, load, typed) {
  ...
  ConditionalNode.prototype._toString = function (options) {
    ...
    var precedence = operatorsjs.getPrecedence(this, parenthesis);
    ...
    var conditionPrecedence = operatorsjs.getPrecedence(this.condition, parenthesis);
    if ((parenthesis === 'all')
    ...
    var truePrecedence = operatorsjs.getPrecedence(this.trueExpr, parenthesis);
    if ((parenthesis === 'all')
    ...
    var falsePrecedence = operatorsjs.getPrecedence(this.falseExpr, parenthesis);
    if ((parenthesis === 'all')

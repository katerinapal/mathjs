...
import * as utilsassign from "./utils/assign";
import * as utilsaccess from "./utils/access";
...
function factory (type, config, load, typed) {
  var Node = load(Node);
  var ArrayNode = load(ArrayNode);
  var matrix = load(typematrixfunctionmatrix);
  var assign = load(utilsassign);
  var access = load(utilsaccess);

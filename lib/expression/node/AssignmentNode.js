...
import { factory as utilsassign_obj } from "./utils/assign";
import { factory as utilsaccess_obj } from "./utils/access";
...
function factory (type, config, load, typed) {
  ...
  function needParenthesis(node, parenthesis) {
    ...
    var exprPrecedence = operators_getPrecedencejs(node.value, parenthesis);

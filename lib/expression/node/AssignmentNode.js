...
import * as ArrayNodejs from "./ArrayNode";
import * as matrixjs from "../../type/matrix/function/matrix";
import * as assignjs from "./utils/assign";
import * as accessjs from "./utils/access";
import * as keywordsjs from "../keywords";
...
function factory (type, config, load, typed) {
  ...
  var assign = load(assignjs);
  var access = load(accessjs);
  ...
  function needParenthesis(node, parenthesis) {
    ...
    var precedence = operatorsjs.getPrecedence(node, parenthesis);
    var exprPrecedence = operatorsjs.getPrecedence(node.value, parenthesis);

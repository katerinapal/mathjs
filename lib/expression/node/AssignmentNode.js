...
import * as utilsassign_obj from "./utils/assign";
import * as utilsaccess_obj from "./utils/access";
import * as keywords_obj from "../keywords";
...
function factory (type, config, load, typed) {
  ...
  var ArrayNode = load(ArrayNode_obj);
  var matrix = load(typematrixfunctionmatrix_obj);
  var assign = load(utilsassign_obj);
  var access = load(utilsaccess_obj);

  var keywords = keywords_obj;
  ...
  function needParenthesis(node, parenthesis) {
    ...
    var precedence = operators_obj.getPrecedence(node, parenthesis);
    var exprPrecedence = operators_obj.getPrecedence(node.value, parenthesis);
...
var name_exportedObj = 'AssignmentNode';

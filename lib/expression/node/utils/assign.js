import * as transformerrortransform_obj from "../../transform/error.transform";
...
var errorTransform = transformerrortransform_obj.transform;
  ...
  return function assign(object, index, value) {
    try {
      if (Array.isArray(object)) {
        ...
        throw transformerrortransform_obj(err);
    }
  };
}

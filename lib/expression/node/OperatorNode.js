...
function factory(type, config, load, typed, math) {
  ...
  function calculateNecessaryParentheses(root, parenthesis, args, latex) {
    ...
    var precedence = (0, _operators.properties)(root, parenthesis);
    var associativity = (0, _operators.properties)(root, parenthesis);
    ...
    switch (args.length) {
      ...
      case 1:
        ...
        var operandPrecedence = (0, _operators.properties)(args[0], parenthesis);
      ...
      case 2:
        ...
        var lhsPrecedence = (0, _operators.properties)(args[0], parenthesis);
        //is the root node associative with the left hand side
        var assocWithLhs = (0, _operators.properties)(root, args[0], parenthesis);
        ...
        var rhsPrecedence = (0, _operators.properties)(args[1], parenthesis);
        //is the root node associative with the right hand side?
        var assocWithRhs = (0, _operators.properties)(root, args[1], parenthesis);
  ...
  OperatorNode.prototype._toString = function (options) {
    ...
    switch (args.length) {
      case 1:
        //unary operators
        var assoc = (0, _operators.properties)(this, parenthesis);
  ...
  OperatorNode.prototype._toTex = function (options) {
    ...
    var op = _latex.operators[this.fn];

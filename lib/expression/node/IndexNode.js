...
var typematrixRange_obj = _interopRequireWildcard(_Range);
...
function factory(type, config, load, typed) {
  ...
  var RangeNode = load(RangeNode_obj);
  var SymbolNode = load(SymbolNode_obj);

  var Range = load(typematrixRange_obj);
...
var name_exportedObj = 'IndexNode';

...
import * as functionparser from "./function/parser";
'use strict';

var object = utilsobject;
var string = utilsstring;

function factory (type, config, load, typed) {
  var parser = load(functionparser)();
  ...
  Help.prototype.toString = function () {
    ...
    if (doc.examples) {
      ...
      for (var i = 0; i < doc.examples.length; i++) {
        ...
        if (res && !res.isHelp) {
          desc += '        ' + utilsstring.format(res, {precision: 14}) + '\n';
        }
      }
      desc += '\n';
    }
  ...
  Help.prototype.toJSON = function () {
    var obj = utilsobject.clone(this.doc);
    obj.mathjs = 'Help';
    return obj;
  };

...
import * as functionparser_obj from "./function/parser";
'use strict';

var object = utilsobject_obj;
var string = utilsstring_obj;
...
function factory (type, config, load, typed) {
  ...
  Help.prototype.toString = function () {
    ...
    if (doc.examples) {
      ...
      for (var i = 0; i < doc.examples.length; i++) {
        ...
        if (res && !res.isHelp) {
          desc += '        ' + utilsstring_obj.format(res, {precision: 14}) + '\n';
        }
      }
      desc += '\n';
    }
  ...
  Help.prototype.toJSON = function () {
    var obj = utilsobject_obj.clone(this.doc);
    obj.mathjs = 'Help';
    return obj;
  };

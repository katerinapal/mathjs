...
var slujs_exportedObj_examples = ["slu(sparse([4.5, 0, 3.2, 0; 3.1, 2.9, 0, 0.9; 0, 1.7, 3, 0; 3.5, 0.4, 0, 1]), 1, 0.001)"];

var slujs_exportedObj_seealso = ["lusolve", "lsolve", "usolve", "matrix", "sparse", "lup"];
exports.name = slujs_exportedObj_name;
exports.category = slujs_exportedObj_category;
exports.syntax = slujs_exportedObj_syntax;
exports.description = slujs_exportedObj_description;
exports.examples = slujs_exportedObj_examples;
exports.seealso = slujs_exportedObj_seealso;

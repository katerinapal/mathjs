...
var slujs_slujs_examples = ["slu(sparse([4.5, 0, 3.2, 0; 3.1, 2.9, 0, 0.9; 0, 1.7, 3, 0; 3.5, 0.4, 0, 1]), 1, 0.001)"];

var slujs_slujs_seealso = ["lusolve", "lsolve", "usolve", "matrix", "sparse", "lup"];
exports.name = slujs_slujs_name;
exports.category = slujs_slujs_category;
exports.syntax = slujs_slujs_syntax;
exports.description = slujs_slujs_description;
exports.examples = slujs_slujs_examples;
exports.seealso = slujs_slujs_seealso;

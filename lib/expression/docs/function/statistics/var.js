...
var varjs_varjs_examples = ["var(2, 4, 6)", "var([2, 4, 6, 8])", "var([2, 4, 6, 8], \"uncorrected\")", "var([2, 4, 6, 8], \"biased\")", "var([1, 2, 3; 4, 5, 6])"];

var varjs_varjs_seealso = ["max", "mean", "min", "median", "min", "prod", "std", "sum"];
exports.name = varjs_varjs_name;
exports.category = varjs_varjs_category;
exports.syntax = varjs_varjs_syntax;
exports.description = varjs_varjs_description;
exports.examples = varjs_varjs_examples;
exports.seealso = varjs_varjs_seealso;

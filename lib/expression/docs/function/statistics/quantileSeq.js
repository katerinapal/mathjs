...
var quantileSeqjs_quantileSeqjs_syntax = [
  "quantileSeq(A, prob[, sorted])",
  "quantileSeq(A, [prob1, prob2, ...][, sorted])",
  "quantileSeq(A, N[, sorted])"
];
...
var quantileSeqjs_quantileSeqjs_examples = [
  "quantileSeq([3, -1, 5, 7], 0.5)",
  "quantileSeq([3, -1, 5, 7], [1/3, 2/3])",
  "quantileSeq([3, -1, 5, 7], 2)",
  "quantileSeq([-1, 3, 5, 7], 0.5, true)"
...
export { quantileSeqjs_quantileSeqjs_name as name, quantileSeqjs_quantileSeqjs_category as category, quantileSeqjs_quantileSeqjs_syntax as syntax, quantileSeqjs_quantileSeqjs_description as description, quantileSeqjs_quantileSeqjs_examples as examples, quantileSeqjs_quantileSeqjs_seealso as seealso };
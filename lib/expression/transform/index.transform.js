...
var _index = require('../../type/matrix/function/index');

var typematrixfunctionindex_obj = _interopRequireWildcard(_index);
...
function factory(type, config, load) {
  var indexFactory = load(typematrixfunctionindex_obj);

...
import * as nodeAccessorNode from "./node/AccessorNode";
import * as nodeArrayNode from "./node/ArrayNode";
import * as nodeAssignmentNode from "./node/AssignmentNode";
import * as nodeBlockNode from "./node/BlockNode";
import * as nodeConditionalNode from "./node/ConditionalNode";
import * as nodeConstantNode from "./node/ConstantNode";
import * as nodeFunctionAssignmentNode from "./node/FunctionAssignmentNode";
import * as nodeIndexNode from "./node/IndexNode";
import * as nodeObjectNode from "./node/ObjectNode";
import * as nodeOperatorNode from "./node/OperatorNode";
import * as nodeParenthesisNode from "./node/ParenthesisNode";
import * as nodeFunctionNode from "./node/FunctionNode";
import * as nodeRangeNode from "./node/RangeNode";
import * as nodeSymbolNode from "./node/SymbolNode";
'use strict';
...
function factory (type, config, load, typed) {
  var AccessorNode            = load(nodeAccessorNode);
  var ArrayNode               = load(nodeArrayNode);
  var AssignmentNode          = load(nodeAssignmentNode);
  var BlockNode               = load(nodeBlockNode);
  var ConditionalNode         = load(nodeConditionalNode);
  var ConstantNode            = load(nodeConstantNode);
  var FunctionAssignmentNode  = load(nodeFunctionAssignmentNode);
  var IndexNode               = load(nodeIndexNode);
  var ObjectNode              = load(nodeObjectNode);
  var OperatorNode            = load(nodeOperatorNode);
  var ParenthesisNode         = load(nodeParenthesisNode);
  var FunctionNode            = load(nodeFunctionNode);
  var RangeNode               = load(nodeRangeNode);
  var SymbolNode              = load(nodeSymbolNode);

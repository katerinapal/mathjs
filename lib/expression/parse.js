...
var _AccessorNode = require("./node/AccessorNode");

var nodeAccessorNode_obj = _interopRequireWildcard(_AccessorNode);

var _ArrayNode = require("./node/ArrayNode");

var nodeArrayNode_obj = _interopRequireWildcard(_ArrayNode);

var _AssignmentNode = require("./node/AssignmentNode");

var nodeAssignmentNode_obj = _interopRequireWildcard(_AssignmentNode);

var _BlockNode = require("./node/BlockNode");

var nodeBlockNode_obj = _interopRequireWildcard(_BlockNode);

var _ConditionalNode = require("./node/ConditionalNode");

var nodeConditionalNode_obj = _interopRequireWildcard(_ConditionalNode);

var _ConstantNode = require("./node/ConstantNode");

var nodeConstantNode_obj = _interopRequireWildcard(_ConstantNode);

var _FunctionAssignmentNode = require("./node/FunctionAssignmentNode");

var nodeFunctionAssignmentNode_obj = _interopRequireWildcard(_FunctionAssignmentNode);

var _IndexNode = require("./node/IndexNode");

var nodeIndexNode_obj = _interopRequireWildcard(_IndexNode);

var _ObjectNode = require("./node/ObjectNode");

var nodeObjectNode_obj = _interopRequireWildcard(_ObjectNode);

var _OperatorNode = require("./node/OperatorNode");

var nodeOperatorNode_obj = _interopRequireWildcard(_OperatorNode);

var _ParenthesisNode = require("./node/ParenthesisNode");

var nodeParenthesisNode_obj = _interopRequireWildcard(_ParenthesisNode);

var _FunctionNode = require("./node/FunctionNode");

var nodeFunctionNode_obj = _interopRequireWildcard(_FunctionNode);

var _RangeNode = require("./node/RangeNode");

var nodeRangeNode_obj = _interopRequireWildcard(_RangeNode);
...
function factory(type, config, load, typed) {
  var AccessorNode = load(nodeAccessorNode_obj);
  var ArrayNode = load(nodeArrayNode_obj);
  var AssignmentNode = load(nodeAssignmentNode_obj);
  var BlockNode = load(nodeBlockNode_obj);
  var ConditionalNode = load(nodeConditionalNode_obj);
  var ConstantNode = load(nodeConstantNode_obj);
  var FunctionAssignmentNode = load(nodeFunctionAssignmentNode_obj);
  var IndexNode = load(nodeIndexNode_obj);
  var ObjectNode = load(nodeObjectNode_obj);
  var OperatorNode = load(nodeOperatorNode_obj);
  var ParenthesisNode = load(nodeParenthesisNode_obj);
  var FunctionNode = load(nodeFunctionNode_obj);
  var RangeNode = load(nodeRangeNode_obj);
  ...
  function parse(expr, options) {
    if (arguments.length != 1 && arguments.length != 2) {
      throw new _ArgumentsError.ArgumentsError('parse', arguments.length, 1, 2);
    }
    ...
    if (typeof expr === 'string') {
      ...
      return (0, _deepMap.deepMapjs)(expr, function (elem) {

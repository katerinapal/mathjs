import { ArgumentsError as errorArgumentsError_ArgumentsError } from "../error/ArgumentsError";
import { deepMap as utilscollectiondeepMap_deepMap } from "../utils/collection/deepMap";
import * as nodeAccessorNode_obj from "./node/AccessorNode";
import * as nodeArrayNode_obj from "./node/ArrayNode";
import * as nodeAssignmentNode_obj from "./node/AssignmentNode";
import * as nodeBlockNode_obj from "./node/BlockNode";
import * as nodeConditionalNode_obj from "./node/ConditionalNode";
import * as nodeConstantNode_obj from "./node/ConstantNode";
import * as nodeFunctionAssignmentNode_obj from "./node/FunctionAssignmentNode";
import * as nodeIndexNode_obj from "./node/IndexNode";
import * as nodeObjectNode_obj from "./node/ObjectNode";
import * as nodeOperatorNode_obj from "./node/OperatorNode";
import * as nodeParenthesisNode_obj from "./node/ParenthesisNode";
import * as nodeFunctionNode_obj from "./node/FunctionNode";
import * as nodeRangeNode_obj from "./node/RangeNode";
import * as nodeSymbolNode_obj from "./node/SymbolNode";
'use strict';

var ArgumentsError = errorArgumentsError_ArgumentsError;
...
function factory (type, config, load, typed) {
  ...
  function parse (expr, options) {
    if (arguments.length != 1 && arguments.length != 2) {
      throw new errorArgumentsError_ArgumentsError('parse', arguments.length, 1, 2);
    }
    ...
    if (typeof expr === 'string') {
      ...
      return utilscollectiondeepMap_deepMap(expr, function (elem) {

...
function factory (type, config, load, typed, math) {
  ...
  if (config.number === 'BigNumber') {
    ...
    utilsobject_lazyjs(math, 'pi',  function () {return bigConstants.pi(type.BigNumber)});
    utilsobject_lazyjs(math, 'tau', function () {return bigConstants.tau(type.BigNumber)});
    utilsobject_lazyjs(math, 'e',   function () {return bigConstants.e(type.BigNumber)});
    utilsobject_lazyjs(math, 'phi', function () {return bigConstants.phi(type.BigNumber)}); // golden ratio, (1+sqrt(5))/2
